 ...
 */
@JsonPropertyOrder({
  FindingDescription.JSON_PROPERTY_GENERAL_DESCRIPTION,
  FindingDescription.JSON_PROPERTY_INSTANCE_DESCRIPTION,
  FindingDescription.JSON_PROPERTY_BY_RESULT
})
...
public class FindingDescription {
  public static final String JSON_PROPERTY_GENERAL_DESCRIPTION = "generalDescription";
  @jakarta.annotation.Nullable
  private Description generalDescription;

  public static final String JSON_PROPERTY_INSTANCE_DESCRIPTION = "instanceDescription";
  @jakarta.annotation.Nullable
  private Description instanceDescription;

  public static final String JSON_PROPERTY_BY_RESULT = "byResult";
  @jakarta.annotation.Nullable
  private Map<String, ResultDescription> byResult = new HashMap<>();

  public FindingDescription() { 
  }

  public FindingDescription generalDescription(@jakarta.annotation.Nullable Description generalDescription) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_GENERAL_DESCRIPTION, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_GENERAL_DESCRIPTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGeneralDescription(@jakarta.annotation.Nullable Description generalDescription) {
    this.generalDescription = generalDescription;
  }


  public FindingDescription instanceDescription(@jakarta.annotation.Nullable Description instanceDescription) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INSTANCE_DESCRIPTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_INSTANCE_DESCRIPTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInstanceDescription(@jakarta.annotation.Nullable Description instanceDescription) {
    this.instanceDescription = instanceDescription;
  }


  public FindingDescription byResult(@jakarta.annotation.Nullable Map<String, ResultDescription> byResult) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_BY_RESULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_BY_RESULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setByResult(@jakarta.annotation.Nullable Map<String, ResultDescription> byResult) {
    this.byResult = byResult;
  }


  /**
   * Return true if this FindingDescription object is equal to o.
   */
  @Override
