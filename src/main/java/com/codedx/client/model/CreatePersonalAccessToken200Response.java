...
/**
 * CreatePersonalAccessToken200Response
 */
@JsonPropertyOrder({
  CreatePersonalAccessToken200Response.JSON_PROPERTY_TOKEN,
  CreatePersonalAccessToken200Response.JSON_PROPERTY_USER
})
@JsonTypeName("createPersonalAccessToken_200_response")
...
public class CreatePersonalAccessToken200Response {
  ...
  public CreatePersonalAccessToken200Response() { 
  }

  public CreatePersonalAccessToken200Response token(@jakarta.annotation.Nullable String token) {
    this.token = token;
    return this;
  }

  /**
   * The raw &#39;token&#39; that can be used as a credential for Bearer-Token authentication with the Software Risk Manager REST API
   * @return token
   */
  @jakarta.annotation.Nullable
  ...
  public CreatePersonalAccessToken200Response user(@jakarta.annotation.Nullable User user) {
    this.user = user;
    return this;
  }
  ...
  /**
   * Return true if this createPersonalAccessToken_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreatePersonalAccessToken200Response createPersonalAccessToken200Response = (CreatePersonalAccessToken200Response) o;
    return Objects.equals(this.token, createPersonalAccessToken200Response.token) &&
        Objects.equals(this.user, createPersonalAccessToken200Response.user);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePersonalAccessToken200Response {\n");
