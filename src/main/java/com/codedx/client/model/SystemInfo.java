...
public class SystemInfo {
  ...
  public SystemInfo version(@jakarta.annotation.Nullable String version) {
  ...
  public SystemInfo date(@jakarta.annotation.Nullable String date) {
    this.date = date;
    return this;
  }
