 ...
 */
@JsonPropertyOrder({
  Issue.JSON_PROPERTY_TRACKER_TYPE,
  Issue.JSON_PROPERTY_KEY,
  Issue.JSON_PROPERTY_URL,
  Issue.JSON_PROPERTY_STATUS,
  Issue.JSON_PROPERTY_RESOLUTION
})
...
public class Issue {
  ...
  public Issue trackerType(@jakarta.annotation.Nullable String trackerType) {
  ...
  public Issue key(@jakarta.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public Issue url(@jakarta.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public Issue status(@jakarta.annotation.Nullable IssueStatus status) {
    this.status = status;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_STATUS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatus(@jakarta.annotation.Nullable IssueStatus status) {
    this.status = status;
  }


  public Issue resolution(@jakarta.annotation.Nullable String resolution) {
