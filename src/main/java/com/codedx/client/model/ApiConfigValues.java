 ...
 */
@JsonPropertyOrder({
  ApiConfigValues.JSON_PROPERTY_VALUES,
  ApiConfigValues.JSON_PROPERTY_ENTITY_ID,
  ApiConfigValues.JSON_PROPERTY_CONNECTION_ENTITY_ID,
  ApiConfigValues.JSON_PROPERTY_CONNECTION_VALUES,
  ApiConfigValues.JSON_PROPERTY_PROJECT_ENTITY_ID,
  ApiConfigValues.JSON_PROPERTY_PROJECT_VALUES
})
...
public class ApiConfigValues {
  ...
  public static final String JSON_PROPERTY_CONNECTION_VALUES = "connectionValues";
  @jakarta.annotation.Nullable
  private Map<String, Object> connectionValues = new HashMap<>();

  public static final String JSON_PROPERTY_PROJECT_ENTITY_ID = "projectEntityId";
  @jakarta.annotation.Nullable
  private Integer projectEntityId;

  public static final String JSON_PROPERTY_PROJECT_VALUES = "projectValues";
  @jakarta.annotation.Nullable
  private Map<String, Object> projectValues = new HashMap<>();

  public ApiConfigValues() { 
  }

  public ApiConfigValues values(@jakarta.annotation.Nullable Map<String, Object> values) {
    this.values = values;
    return this;
  }

  public ApiConfigValues putValuesItem(String key, Object valuesItem) {
    if (this.values == null) {
  ...
  public ApiConfigValues entityId(@jakarta.annotation.Nullable Integer entityId) {
  ...
  public ApiConfigValues connectionEntityId(@jakarta.annotation.Nullable Integer connectionEntityId) {
  ...
  public ApiConfigValues connectionValues(@jakarta.annotation.Nullable Map<String, Object> connectionValues) {
    this.connectionValues = connectionValues;
    return this;
  }

  public ApiConfigValues putConnectionValuesItem(String key, Object connectionValuesItem) {
    if (this.connectionValues == null) {
      this.connectionValues = new HashMap<>();
    }
    this.connectionValues.put(key, connectionValuesItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONNECTION_VALUES, required = false)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)

  public Map<String, Object> getConnectionValues() {
    return connectionValues;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONNECTION_VALUES, required = false)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)
  public void setConnectionValues(@jakarta.annotation.Nullable Map<String, Object> connectionValues) {
    this.connectionValues = connectionValues;
  }


  public ApiConfigValues projectEntityId(@jakarta.annotation.Nullable Integer projectEntityId) {
  ...
  public ApiConfigValues projectValues(@jakarta.annotation.Nullable Map<String, Object> projectValues) {
    this.projectValues = projectValues;
    return this;
  }

  public ApiConfigValues putProjectValuesItem(String key, Object projectValuesItem) {
    if (this.projectValues == null) {
      this.projectValues = new HashMap<>();
    }
    this.projectValues.put(key, projectValuesItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PROJECT_VALUES, required = false)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)

  public Map<String, Object> getProjectValues() {
    return projectValues;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT_VALUES, required = false)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjectValues(@jakarta.annotation.Nullable Map<String, Object> projectValues) {
    this.projectValues = projectValues;
  }


  /**
   * Return true if this ApiConfigValues object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiConfigValues apiConfigValues = (ApiConfigValues) o;
    return Objects.equals(this.values, apiConfigValues.values) &&
        Objects.equals(this.entityId, apiConfigValues.entityId) &&
        Objects.equals(this.connectionEntityId, apiConfigValues.connectionEntityId) &&
        Objects.equals(this.connectionValues, apiConfigValues.connectionValues) &&
        Objects.equals(this.projectEntityId, apiConfigValues.projectEntityId) &&
        Objects.equals(this.projectValues, apiConfigValues.projectValues);
  }

  @Override
  public int hashCode() {
    return Objects.hash(values, entityId, connectionEntityId, connectionValues, projectEntityId, projectValues);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiConfigValues {\n");
    sb.append("    values: ").append(toIndentedString(values)).append("\n");
    sb.append("    entityId: ").append(toIndentedString(entityId)).append("\n");
    sb.append("    connectionEntityId: ").append(toIndentedString(connectionEntityId)).append("\n");
    sb.append("    connectionValues: ").append(toIndentedString(connectionValues)).append("\n");
    sb.append("    projectEntityId: ").append(toIndentedString(projectEntityId)).append("\n");
    sb.append("    projectValues: ").append(toIndentedString(projectValues)).append("\n");
    sb.append("}");
    return sb.toString();
  }
