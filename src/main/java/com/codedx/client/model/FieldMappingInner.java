 ...
 */
@JsonPropertyOrder({
  FieldMappingInner.JSON_PROPERTY_ID,
  FieldMappingInner.JSON_PROPERTY_VALUE,
  FieldMappingInner.JSON_PROPERTY_KEEP_SYNCED
})
@JsonTypeName("FieldMapping_inner")
...
public class FieldMappingInner {
  ...
  public static final String JSON_PROPERTY_KEEP_SYNCED = "keepSynced";
  @jakarta.annotation.Nullable
  private Boolean keepSynced;

  public FieldMappingInner() { 
  }

  public FieldMappingInner id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FieldMappingInner value(@jakarta.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public FieldMappingInner keepSynced(@jakarta.annotation.Nullable Boolean keepSynced) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_KEEP_SYNCED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getKeepSynced() {
    return keepSynced;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_KEEP_SYNCED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setKeepSynced(@jakarta.annotation.Nullable Boolean keepSynced) {
    this.keepSynced = keepSynced;
  }


  /**
   * Return true if this FieldMapping_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FieldMappingInner fieldMappingInner = (FieldMappingInner) o;
    return Objects.equals(this.id, fieldMappingInner.id) &&
        Objects.equals(this.value, fieldMappingInner.value) &&
        Objects.equals(this.keepSynced, fieldMappingInner.keepSynced);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, value, keepSynced);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FieldMappingInner {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    value: ").append(toIndentedString(value)).append("\n");
    sb.append("    keepSynced: ").append(toIndentedString(keepSynced)).append("\n");
    sb.append("}");
    return sb.toString();
  }
