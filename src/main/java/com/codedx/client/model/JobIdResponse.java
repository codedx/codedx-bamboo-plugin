 ...
 */
@JsonPropertyOrder({
  JobIdResponse.JSON_PROPERTY_JOB_ID
})
...
public class JobIdResponse {
  ...
  public JobIdResponse jobId(@jakarta.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  /**
   * Return true if this JobIdResponse object is equal to o.
   */
  @Override
