...
import com.codedx.client.model.NewImportedBindingProject;
 ...
 */
@JsonPropertyOrder({
  NewImportedBinding.JSON_PROPERTY_PROJECT,
  NewImportedBinding.JSON_PROPERTY_PROJECT_ENTITY_ID,
  NewImportedBinding.JSON_PROPERTY_VERSION_ENTITY_ID,
  NewImportedBinding.JSON_PROPERTY_CONNECTOR_BINDING_ID
})
...
public class NewImportedBinding {
  public static final String JSON_PROPERTY_PROJECT = "project";
  @jakarta.annotation.Nullable
  private NewImportedBindingProject project;
  ...
  public static final String JSON_PROPERTY_CONNECTOR_BINDING_ID = "connectorBindingId";
  @jakarta.annotation.Nullable
  private Integer connectorBindingId;

  public NewImportedBinding() { 
  }

  public NewImportedBinding project(@jakarta.annotation.Nullable NewImportedBindingProject project) {
  ...
  public NewImportedBindingProject getProject() {
    return project;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProject(@jakarta.annotation.Nullable NewImportedBindingProject project) {
    this.project = project;
  }


  public NewImportedBinding projectEntityId(@jakarta.annotation.Nullable Integer projectEntityId) {
  ...
  public NewImportedBinding versionEntityId(@jakarta.annotation.Nullable Integer versionEntityId) {
  ...
  public NewImportedBinding connectorBindingId(@jakarta.annotation.Nullable Integer connectorBindingId) {
    this.connectorBindingId = connectorBindingId;
    return this;
  }

  /**
   * Get connectorBindingId
   * @return connectorBindingId
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONNECTOR_BINDING_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getConnectorBindingId() {
    return connectorBindingId;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONNECTOR_BINDING_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConnectorBindingId(@jakarta.annotation.Nullable Integer connectorBindingId) {
    this.connectorBindingId = connectorBindingId;
  }


  /**
   * Return true if this NewImportedBinding object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NewImportedBinding newImportedBinding = (NewImportedBinding) o;
    return Objects.equals(this.project, newImportedBinding.project) &&
        Objects.equals(this.projectEntityId, newImportedBinding.projectEntityId) &&
        Objects.equals(this.versionEntityId, newImportedBinding.versionEntityId) &&
        Objects.equals(this.connectorBindingId, newImportedBinding.connectorBindingId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(project, projectEntityId, versionEntityId, connectorBindingId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NewImportedBinding {\n");
    ...
    sb.append("    connectorBindingId: ").append(toIndentedString(connectorBindingId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
