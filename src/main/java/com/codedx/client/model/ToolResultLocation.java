 ...
 */
@JsonPropertyOrder({
  ToolResultLocation.JSON_PROPERTY_RAW_DISPLAY_PATH,
  ToolResultLocation.JSON_PROPERTY_PATH_OBJECT,
  ToolResultLocation.JSON_PROPERTY_RAW_PATH_OBJECT,
  ToolResultLocation.JSON_PROPERTY_LINES,
  ToolResultLocation.JSON_PROPERTY_COLUMNS
})
...
public class ToolResultLocation {
  public static final String JSON_PROPERTY_RAW_DISPLAY_PATH = "rawDisplayPath";
  @jakarta.annotation.Nullable
  private String rawDisplayPath;

  public static final String JSON_PROPERTY_PATH_OBJECT = "pathObject";
  @jakarta.annotation.Nullable
  private ToolResultPath pathObject;

  public static final String JSON_PROPERTY_RAW_PATH_OBJECT = "rawPathObject";
  @jakarta.annotation.Nullable
  private ToolResultPath rawPathObject;

  public static final String JSON_PROPERTY_LINES = "lines";
  @jakarta.annotation.Nullable
  private LocationRange lines;

  public static final String JSON_PROPERTY_COLUMNS = "columns";
  @jakarta.annotation.Nullable
  private LocationRange columns;

  public ToolResultLocation() { 
  }

  public ToolResultLocation rawDisplayPath(@jakarta.annotation.Nullable String rawDisplayPath) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RAW_DISPLAY_PATH, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_RAW_DISPLAY_PATH, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRawDisplayPath(@jakarta.annotation.Nullable String rawDisplayPath) {
    this.rawDisplayPath = rawDisplayPath;
  }


  public ToolResultLocation pathObject(@jakarta.annotation.Nullable ToolResultPath pathObject) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PATH_OBJECT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PATH_OBJECT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPathObject(@jakarta.annotation.Nullable ToolResultPath pathObject) {
    this.pathObject = pathObject;
  }


  public ToolResultLocation rawPathObject(@jakarta.annotation.Nullable ToolResultPath rawPathObject) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RAW_PATH_OBJECT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_RAW_PATH_OBJECT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRawPathObject(@jakarta.annotation.Nullable ToolResultPath rawPathObject) {
    this.rawPathObject = rawPathObject;
  }


  public ToolResultLocation lines(@jakarta.annotation.Nullable LocationRange lines) {
    this.lines = lines;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_LINES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLines(@jakarta.annotation.Nullable LocationRange lines) {
    this.lines = lines;
  }


  public ToolResultLocation columns(@jakarta.annotation.Nullable LocationRange columns) {
  ...
  @JsonProperty(value = JSON_PROPERTY_COLUMNS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setColumns(@jakarta.annotation.Nullable LocationRange columns) {
    this.columns = columns;
  }


  /**
   * Return true if this ToolResultLocation object is equal to o.
   */
  @Override
