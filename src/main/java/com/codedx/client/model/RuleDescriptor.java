 ...
 */
@JsonPropertyOrder({
  RuleDescriptor.JSON_PROPERTY_ID,
  RuleDescriptor.JSON_PROPERTY_NAME,
  RuleDescriptor.JSON_PROPERTY_CWE,
  RuleDescriptor.JSON_PROPERTY_DESCRIPTION
})
...
public class RuleDescriptor {
  ...
  public RuleDescriptor id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RuleDescriptor name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RuleDescriptor cwe(@jakarta.annotation.Nullable Cwe cwe) {
    this.cwe = cwe;
    return this;
  }
  ...
  public RuleDescriptor description(@jakarta.annotation.Nullable Description description) {
  ...
  /**
   * Return true if this RuleDescriptor object is equal to o.
   */
  @Override
