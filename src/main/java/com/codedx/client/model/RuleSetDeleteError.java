 ...
 */
@JsonPropertyOrder({
  RuleSetDeleteError.JSON_PROPERTY_ERROR,
  RuleSetDeleteError.JSON_PROPERTY_PROJECT_IDS
})
...
public class RuleSetDeleteError {
  ...
  public RuleSetDeleteError() { 
  }

  public RuleSetDeleteError error(@jakarta.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public RuleSetDeleteError projectIds(@jakarta.annotation.Nullable List<Integer> projectIds) {
  ...
  /**
   * Return true if this RuleSetDeleteError object is equal to o.
   */
  @Override
