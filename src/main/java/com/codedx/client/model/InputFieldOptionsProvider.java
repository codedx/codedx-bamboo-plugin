...
import com.codedx.client.model.InputFieldOptionsProviderOneOf;
import com.codedx.client.model.InputFieldOptionsProviderOneOf1;
import com.codedx.client.model.RequiredFields;
...
@JsonDeserialize(using = InputFieldOptionsProvider.InputFieldOptionsProviderDeserializer.class)
@JsonSerialize(using = InputFieldOptionsProvider.InputFieldOptionsProviderSerializer.class)
public class InputFieldOptionsProvider extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(InputFieldOptionsProvider.class.getName());

    public static class InputFieldOptionsProviderSerializer extends StdSerializer<InputFieldOptionsProvider> {
        public InputFieldOptionsProviderSerializer(Class<InputFieldOptionsProvider> t) {
            super(t);
        }

        public InputFieldOptionsProviderSerializer() {
            this(null);
        }

        @Override
        public void serialize(InputFieldOptionsProvider value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class InputFieldOptionsProviderDeserializer extends StdDeserializer<InputFieldOptionsProvider> {
        public InputFieldOptionsProviderDeserializer() {
            this(InputFieldOptionsProvider.class);
        }

        public InputFieldOptionsProviderDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public InputFieldOptionsProvider deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize InputFieldOptionsProviderOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(InputFieldOptionsProviderOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'InputFieldOptionsProviderOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'InputFieldOptionsProviderOneOf'", e);
            }

            // deserialize InputFieldOptionsProviderOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(InputFieldOptionsProviderOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'InputFieldOptionsProviderOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'InputFieldOptionsProviderOneOf1'", e);
            }

            if (match == 1) {
                InputFieldOptionsProvider ret = new InputFieldOptionsProvider();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for InputFieldOptionsProvider: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public InputFieldOptionsProvider getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "InputFieldOptionsProvider cannot be null");
        }
    }
    ...
    public InputFieldOptionsProvider() {
        super("oneOf", Boolean.FALSE);
    }

    public InputFieldOptionsProvider(InputFieldOptionsProviderOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public InputFieldOptionsProvider(InputFieldOptionsProviderOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("InputFieldOptionsProviderOneOf", new GenericType<InputFieldOptionsProviderOneOf>() {
        });
        schemas.put("InputFieldOptionsProviderOneOf1", new GenericType<InputFieldOptionsProviderOneOf1>() {
        });
        JSON.registerDescendants(InputFieldOptionsProvider.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return InputFieldOptionsProvider.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * InputFieldOptionsProviderOneOf, InputFieldOptionsProviderOneOf1
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(InputFieldOptionsProviderOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(InputFieldOptionsProviderOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be InputFieldOptionsProviderOneOf, InputFieldOptionsProviderOneOf1");
    }
     ...
     * InputFieldOptionsProviderOneOf, InputFieldOptionsProviderOneOf1
     *
     * @return The actual instance (InputFieldOptionsProviderOneOf, InputFieldOptionsProviderOneOf1)
     */
    @Override
    ...
    /**
     * Get the actual instance of `InputFieldOptionsProviderOneOf`. If the actual instance is not `InputFieldOptionsProviderOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `InputFieldOptionsProviderOneOf`
     * @throws ClassCastException if the instance is not `InputFieldOptionsProviderOneOf`
     */
    public InputFieldOptionsProviderOneOf getInputFieldOptionsProviderOneOf() throws ClassCastException {
        return (InputFieldOptionsProviderOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `InputFieldOptionsProviderOneOf1`. If the actual instance is not `InputFieldOptionsProviderOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `InputFieldOptionsProviderOneOf1`
     * @throws ClassCastException if the instance is not `InputFieldOptionsProviderOneOf1`
     */
    public InputFieldOptionsProviderOneOf1 getInputFieldOptionsProviderOneOf1() throws ClassCastException {
        return (InputFieldOptionsProviderOneOf1)super.getActualInstance();
    }
