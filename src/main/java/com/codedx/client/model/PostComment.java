 ...
 */
@JsonPropertyOrder({
  PostComment.JSON_PROPERTY_CONTENT
})
...
public class PostComment {
  ...
  public PostComment content(@jakarta.annotation.Nullable String content) {
  ...
  /**
   * Return true if this PostComment object is equal to o.
   */
  @Override
