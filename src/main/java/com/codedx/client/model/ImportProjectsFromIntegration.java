...
import com.codedx.client.model.ImportProjectsFromIntegrationProject;
import com.codedx.client.model.ImportProjectsFromIntegrationProjectEntity;
...
/**
 * ImportProjectsFromIntegration
 */
@JsonPropertyOrder({
  ImportProjectsFromIntegration.JSON_PROPERTY_CONNECTION_ENTITY_ID,
  ImportProjectsFromIntegration.JSON_PROPERTY_PROJECT,
  ImportProjectsFromIntegration.JSON_PROPERTY_PROJECT_ENTITY,
  ImportProjectsFromIntegration.JSON_PROPERTY_VERSION_ENTITY,
  ImportProjectsFromIntegration.JSON_PROPERTY_SYNC_PROJECT_NAME,
  ImportProjectsFromIntegration.JSON_PROPERTY_SYNC_VERSION_NAME,
  ImportProjectsFromIntegration.JSON_PROPERTY_IGNORE_UNSUPPORTED_SYNC
})
...
public class ImportProjectsFromIntegration {
  ...
  @jakarta.annotation.Nullable
  private ImportProjectsFromIntegrationProject project;

  public static final String JSON_PROPERTY_PROJECT_ENTITY = "projectEntity";
  @jakarta.annotation.Nullable
  private ImportProjectsFromIntegrationProjectEntity projectEntity;

  public static final String JSON_PROPERTY_VERSION_ENTITY = "versionEntity";
  @jakarta.annotation.Nullable
  private ImportProjectsFromIntegrationProjectEntity versionEntity;

  public static final String JSON_PROPERTY_SYNC_PROJECT_NAME = "syncProjectName";
  @jakarta.annotation.Nullable
  private Boolean syncProjectName = false;

  public static final String JSON_PROPERTY_SYNC_VERSION_NAME = "syncVersionName";
  @jakarta.annotation.Nullable
  private Boolean syncVersionName = false;

  public static final String JSON_PROPERTY_IGNORE_UNSUPPORTED_SYNC = "ignoreUnsupportedSync";
  @jakarta.annotation.Nullable
  private Boolean ignoreUnsupportedSync = false;

  public ImportProjectsFromIntegration() { 
  }

  public ImportProjectsFromIntegration connectionEntityId(@jakarta.annotation.Nullable Integer connectionEntityId) {
  ...
  public ImportProjectsFromIntegration project(@jakarta.annotation.Nullable ImportProjectsFromIntegrationProject project) {
  ...
  public ImportProjectsFromIntegrationProject getProject() {
    return project;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProject(@jakarta.annotation.Nullable ImportProjectsFromIntegrationProject project) {
    this.project = project;
  }


  public ImportProjectsFromIntegration projectEntity(@jakarta.annotation.Nullable ImportProjectsFromIntegrationProjectEntity projectEntity) {
  ...
  public ImportProjectsFromIntegrationProjectEntity getProjectEntity() {
    return projectEntity;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT_ENTITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjectEntity(@jakarta.annotation.Nullable ImportProjectsFromIntegrationProjectEntity projectEntity) {
    this.projectEntity = projectEntity;
  }


  public ImportProjectsFromIntegration versionEntity(@jakarta.annotation.Nullable ImportProjectsFromIntegrationProjectEntity versionEntity) {
  ...
  public ImportProjectsFromIntegrationProjectEntity getVersionEntity() {
    return versionEntity;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_VERSION_ENTITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVersionEntity(@jakarta.annotation.Nullable ImportProjectsFromIntegrationProjectEntity versionEntity) {
    this.versionEntity = versionEntity;
  }


  public ImportProjectsFromIntegration syncProjectName(@jakarta.annotation.Nullable Boolean syncProjectName) {
    this.syncProjectName = syncProjectName;
    return this;
  }

  /**
   * Whether project entity names will sync on analysis
  ...
  public ImportProjectsFromIntegration syncVersionName(@jakarta.annotation.Nullable Boolean syncVersionName) {
    this.syncVersionName = syncVersionName;
    return this;
  }

  /**
   * Whether version entity names will sync on analysis
  ...
  public ImportProjectsFromIntegration ignoreUnsupportedSync(@jakarta.annotation.Nullable Boolean ignoreUnsupportedSync) {
    this.ignoreUnsupportedSync = ignoreUnsupportedSync;
    return this;
  }

  /**
   * Ignores syncProjectName/syncVersionName if the connector does not support project/version name syncing
   * @return ignoreUnsupportedSync
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IGNORE_UNSUPPORTED_SYNC, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getIgnoreUnsupportedSync() {
    return ignoreUnsupportedSync;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_IGNORE_UNSUPPORTED_SYNC, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIgnoreUnsupportedSync(@jakarta.annotation.Nullable Boolean ignoreUnsupportedSync) {
    this.ignoreUnsupportedSync = ignoreUnsupportedSync;
  }


  /**
   * Return true if this ImportProjectsFromIntegration object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ImportProjectsFromIntegration importProjectsFromIntegration = (ImportProjectsFromIntegration) o;
    return Objects.equals(this.connectionEntityId, importProjectsFromIntegration.connectionEntityId) &&
        Objects.equals(this.project, importProjectsFromIntegration.project) &&
        Objects.equals(this.projectEntity, importProjectsFromIntegration.projectEntity) &&
        Objects.equals(this.versionEntity, importProjectsFromIntegration.versionEntity) &&
        Objects.equals(this.syncProjectName, importProjectsFromIntegration.syncProjectName) &&
        Objects.equals(this.syncVersionName, importProjectsFromIntegration.syncVersionName) &&
        Objects.equals(this.ignoreUnsupportedSync, importProjectsFromIntegration.ignoreUnsupportedSync);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectionEntityId, project, projectEntity, versionEntity, syncProjectName, syncVersionName, ignoreUnsupportedSync);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportProjectsFromIntegration {\n");
    ...
    sb.append("    ignoreUnsupportedSync: ").append(toIndentedString(ignoreUnsupportedSync)).append("\n");
    sb.append("}");
    return sb.toString();
  }
