...
import com.codedx.client.model.IssueTrackerConfigPasswordOneOf;
import com.codedx.client.model.IssueTrackerConfigPasswordOneOf1;
...
@JsonDeserialize(using = IssueTrackerConfigPassword.IssueTrackerConfigPasswordDeserializer.class)
@JsonSerialize(using = IssueTrackerConfigPassword.IssueTrackerConfigPasswordSerializer.class)
public class IssueTrackerConfigPassword extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(IssueTrackerConfigPassword.class.getName());

    public static class IssueTrackerConfigPasswordSerializer extends StdSerializer<IssueTrackerConfigPassword> {
        public IssueTrackerConfigPasswordSerializer(Class<IssueTrackerConfigPassword> t) {
            super(t);
        }

        public IssueTrackerConfigPasswordSerializer() {
            this(null);
        }

        @Override
        public void serialize(IssueTrackerConfigPassword value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class IssueTrackerConfigPasswordDeserializer extends StdDeserializer<IssueTrackerConfigPassword> {
        public IssueTrackerConfigPasswordDeserializer() {
            this(IssueTrackerConfigPassword.class);
        }

        public IssueTrackerConfigPasswordDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public IssueTrackerConfigPassword deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize IssueTrackerConfigPasswordOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(IssueTrackerConfigPasswordOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'IssueTrackerConfigPasswordOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'IssueTrackerConfigPasswordOneOf'", e);
            }

            // deserialize IssueTrackerConfigPasswordOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(IssueTrackerConfigPasswordOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'IssueTrackerConfigPasswordOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'IssueTrackerConfigPasswordOneOf1'", e);
            }

            if (match == 1) {
                IssueTrackerConfigPassword ret = new IssueTrackerConfigPassword();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for IssueTrackerConfigPassword: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public IssueTrackerConfigPassword getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "IssueTrackerConfigPassword cannot be null");
        }
    }
    ...
    public IssueTrackerConfigPassword() {
        super("oneOf", Boolean.FALSE);
    }

    public IssueTrackerConfigPassword(IssueTrackerConfigPasswordOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public IssueTrackerConfigPassword(IssueTrackerConfigPasswordOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("IssueTrackerConfigPasswordOneOf", new GenericType<IssueTrackerConfigPasswordOneOf>() {
        });
        schemas.put("IssueTrackerConfigPasswordOneOf1", new GenericType<IssueTrackerConfigPasswordOneOf1>() {
        });
        JSON.registerDescendants(IssueTrackerConfigPassword.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return IssueTrackerConfigPassword.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * IssueTrackerConfigPasswordOneOf, IssueTrackerConfigPasswordOneOf1
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(IssueTrackerConfigPasswordOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(IssueTrackerConfigPasswordOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be IssueTrackerConfigPasswordOneOf, IssueTrackerConfigPasswordOneOf1");
    }
     ...
     * IssueTrackerConfigPasswordOneOf, IssueTrackerConfigPasswordOneOf1
     *
     * @return The actual instance (IssueTrackerConfigPasswordOneOf, IssueTrackerConfigPasswordOneOf1)
     */
    @Override
    ...
    /**
     * Get the actual instance of `IssueTrackerConfigPasswordOneOf`. If the actual instance is not `IssueTrackerConfigPasswordOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `IssueTrackerConfigPasswordOneOf`
     * @throws ClassCastException if the instance is not `IssueTrackerConfigPasswordOneOf`
     */
    public IssueTrackerConfigPasswordOneOf getIssueTrackerConfigPasswordOneOf() throws ClassCastException {
        return (IssueTrackerConfigPasswordOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `IssueTrackerConfigPasswordOneOf1`. If the actual instance is not `IssueTrackerConfigPasswordOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `IssueTrackerConfigPasswordOneOf1`
     * @throws ClassCastException if the instance is not `IssueTrackerConfigPasswordOneOf1`
     */
    public IssueTrackerConfigPasswordOneOf1 getIssueTrackerConfigPasswordOneOf1() throws ClassCastException {
        return (IssueTrackerConfigPasswordOneOf1)super.getActualInstance();
    }
