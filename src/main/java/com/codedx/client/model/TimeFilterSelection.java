...
import com.codedx.client.model.DateTimeRangeSelection;
import com.codedx.client.model.Int64RangeSelection;
 ...
 */
@JsonPropertyOrder({
  TimeFilterSelection.JSON_PROPERTY_EFFECTIVE_RANGE,
  TimeFilterSelection.JSON_PROPERTY_DATE_RANGE,
  TimeFilterSelection.JSON_PROPERTY_ORDINAL_RANGE
})
...
public class TimeFilterSelection {
  public static final String JSON_PROPERTY_EFFECTIVE_RANGE = "effectiveRange";
  @jakarta.annotation.Nullable
  private DateTimeRangeSelection effectiveRange;

  public static final String JSON_PROPERTY_DATE_RANGE = "dateRange";
  @jakarta.annotation.Nullable
  private DateTimeRangeSelection dateRange;

  public static final String JSON_PROPERTY_ORDINAL_RANGE = "ordinalRange";
  @jakarta.annotation.Nullable
  private Int64RangeSelection ordinalRange;

  public TimeFilterSelection() { 
  }

  public TimeFilterSelection effectiveRange(@jakarta.annotation.Nullable DateTimeRangeSelection effectiveRange) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_EFFECTIVE_RANGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public DateTimeRangeSelection getEffectiveRange() {
    return effectiveRange;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_EFFECTIVE_RANGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEffectiveRange(@jakarta.annotation.Nullable DateTimeRangeSelection effectiveRange) {
    this.effectiveRange = effectiveRange;
  }


  public TimeFilterSelection dateRange(@jakarta.annotation.Nullable DateTimeRangeSelection dateRange) {
  ...
  public DateTimeRangeSelection getDateRange() {
    return dateRange;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATE_RANGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDateRange(@jakarta.annotation.Nullable DateTimeRangeSelection dateRange) {
    this.dateRange = dateRange;
  }


  public TimeFilterSelection ordinalRange(@jakarta.annotation.Nullable Int64RangeSelection ordinalRange) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ORDINAL_RANGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Int64RangeSelection getOrdinalRange() {
    return ordinalRange;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ORDINAL_RANGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOrdinalRange(@jakarta.annotation.Nullable Int64RangeSelection ordinalRange) {
    this.ordinalRange = ordinalRange;
  }


  /**
   * Return true if this TimeFilterSelection object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeFilterSelection timeFilterSelection = (TimeFilterSelection) o;
    return Objects.equals(this.effectiveRange, timeFilterSelection.effectiveRange) &&
        Objects.equals(this.dateRange, timeFilterSelection.dateRange) &&
        Objects.equals(this.ordinalRange, timeFilterSelection.ordinalRange);
  }

  @Override
  public int hashCode() {
    return Objects.hash(effectiveRange, dateRange, ordinalRange);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TimeFilterSelection {\n");
    sb.append("    effectiveRange: ").append(toIndentedString(effectiveRange)).append("\n");
    sb.append("    dateRange: ").append(toIndentedString(dateRange)).append("\n");
    sb.append("    ordinalRange: ").append(toIndentedString(ordinalRange)).append("\n");
    sb.append("}");
    return sb.toString();
  }
