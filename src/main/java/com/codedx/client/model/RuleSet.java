 ...
 */
@JsonPropertyOrder({
  RuleSet.JSON_PROPERTY_ID,
  RuleSet.JSON_PROPERTY_NAME,
  RuleSet.JSON_PROPERTY_CAN_EDIT
})
...
public class RuleSet {
  ...
  public RuleSet id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RuleSet name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RuleSet canEdit(@jakarta.annotation.Nullable Boolean canEdit) {
