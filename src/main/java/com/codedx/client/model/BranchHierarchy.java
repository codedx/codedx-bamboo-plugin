 ...
 */
@JsonPropertyOrder({
  BranchHierarchy.JSON_PROPERTY_ID,
  BranchHierarchy.JSON_PROPERTY_NAME,
  BranchHierarchy.JSON_PROPERTY_PROJECT_ID,
  BranchHierarchy.JSON_PROPERTY_IS_DEFAULT,
  BranchHierarchy.JSON_PROPERTY_CHILDREN
})
...
public class BranchHierarchy {
  ...
  @jakarta.annotation.Nullable
  private List<BranchHierarchy> children = new ArrayList<>();

  public BranchHierarchy() { 
  }

  public BranchHierarchy id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public BranchHierarchy name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public BranchHierarchy projectId(@jakarta.annotation.Nullable Integer projectId) {
    this.projectId = projectId;
    return this;
  }

  /**
   * The id of the project with which the branch is associated
   * @return projectId
   */
  @jakarta.annotation.Nullable
  ...
  public BranchHierarchy isDefault(@jakarta.annotation.Nullable Boolean isDefault) {
    this.isDefault = isDefault;
    return this;
  }

  /**
   * A flag indicating whether or not the branch is the default branch for the project
   * @return isDefault
   */
  @jakarta.annotation.Nullable
  ...
  public BranchHierarchy children(@jakarta.annotation.Nullable List<BranchHierarchy> children) {
    this.children = children;
    return this;
  }

  public BranchHierarchy addChildrenItem(BranchHierarchy childrenItem) {
  ...
  /**
   * The immediate descendants of the current branch in the hierarchy
   * @return children
   */
  @jakarta.annotation.Nullable
  ...
  public List<BranchHierarchy> getChildren() {
    return children;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CHILDREN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChildren(@jakarta.annotation.Nullable List<BranchHierarchy> children) {
    this.children = children;
  }


  /**
   * Return true if this BranchHierarchy object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BranchHierarchy branchHierarchy = (BranchHierarchy) o;
    return Objects.equals(this.id, branchHierarchy.id) &&
        Objects.equals(this.name, branchHierarchy.name) &&
        Objects.equals(this.projectId, branchHierarchy.projectId) &&
        Objects.equals(this.isDefault, branchHierarchy.isDefault) &&
        Objects.equals(this.children, branchHierarchy.children);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, projectId, isDefault, children);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BranchHierarchy {\n");
