 ...
 */
@JsonPropertyOrder({
  DashboardLatest.JSON_PROPERTY_LATEST
})
...
public class DashboardLatest {
  public static final String JSON_PROPERTY_LATEST = "latest";
  @jakarta.annotation.Nullable
  private Integer latest;

  public DashboardLatest() { 
  }

  public DashboardLatest latest(@jakarta.annotation.Nullable Integer latest) {
    this.latest = latest;
    return this;
  }

  /**
   * Grabs the latest N data points where N&#x3D;1 is the latest
   * minimum: 0
   * @return latest
   */
  @jakarta.annotation.Nullable
  ...
  @JsonProperty(value = JSON_PROPERTY_LATEST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLatest(@jakarta.annotation.Nullable Integer latest) {
    this.latest = latest;
  }


  /**
   * Return true if this DashboardLatest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardLatest dashboardLatest = (DashboardLatest) o;
    return Objects.equals(this.latest, dashboardLatest.latest);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardLatest {\n");
