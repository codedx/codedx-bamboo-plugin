...
/**
 * PDF report form values
 */
@JsonPropertyOrder({
  CreateReportTemplateRequestFormValuesOneOf.JSON_PROPERTY_EXECUTIVE_SUMMARY,
  CreateReportTemplateRequestFormValuesOneOf.JSON_PROPERTY_FINDING_DETAILS,
  CreateReportTemplateRequestFormValuesOneOf.JSON_PROPERTY_HOST_DETAILS,
  CreateReportTemplateRequestFormValuesOneOf.JSON_PROPERTY_RESULT_DETAILS,
  CreateReportTemplateRequestFormValuesOneOf.JSON_PROPERTY_HTTP_DETAILS,
  CreateReportTemplateRequestFormValuesOneOf.JSON_PROPERTY_COMMENTS,
  CreateReportTemplateRequestFormValuesOneOf.JSON_PROPERTY_STANDARDS
})
@JsonTypeName("createReportTemplate_request_formValues_oneOf")
...
public class CreateReportTemplateRequestFormValuesOneOf {
  /**
   * Gets or Sets executiveSummary
   */
  public enum ExecutiveSummaryEnum {
    ...
    ExecutiveSummaryEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static ExecutiveSummaryEnum fromValue(String value) {
      for (ExecutiveSummaryEnum b : ExecutiveSummaryEnum.values()) {
  ...
  public static final String JSON_PROPERTY_EXECUTIVE_SUMMARY = "executive-summary";
  @jakarta.annotation.Nullable
  private ExecutiveSummaryEnum executiveSummary;

  /**
   * Gets or Sets findingDetails
   */
  public enum FindingDetailsEnum {
    NONE(String.valueOf("none")),
    
    SIMPLE(String.valueOf("simple")),
    
    WITH_SOURCE(String.valueOf("with-source"));

    private String value;

    FindingDetailsEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static FindingDetailsEnum fromValue(String value) {
      for (FindingDetailsEnum b : FindingDetailsEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_FINDING_DETAILS = "finding-details";
  @jakarta.annotation.Nullable
  private FindingDetailsEnum findingDetails;

  public static final String JSON_PROPERTY_HOST_DETAILS = "host-details";
  @jakarta.annotation.Nullable
  private Boolean hostDetails;

  public static final String JSON_PROPERTY_RESULT_DETAILS = "result-details";
  @jakarta.annotation.Nullable
  private Boolean resultDetails;

  public static final String JSON_PROPERTY_HTTP_DETAILS = "http-details";
  @jakarta.annotation.Nullable
  private Boolean httpDetails;
  ...
  public CreateReportTemplateRequestFormValuesOneOf() { 
  }

  public CreateReportTemplateRequestFormValuesOneOf executiveSummary(@jakarta.annotation.Nullable ExecutiveSummaryEnum executiveSummary) {
  ...
  public ExecutiveSummaryEnum getExecutiveSummary() {
    return executiveSummary;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_EXECUTIVE_SUMMARY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExecutiveSummary(@jakarta.annotation.Nullable ExecutiveSummaryEnum executiveSummary) {
    this.executiveSummary = executiveSummary;
  }


  public CreateReportTemplateRequestFormValuesOneOf findingDetails(@jakarta.annotation.Nullable FindingDetailsEnum findingDetails) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FINDING_DETAILS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public FindingDetailsEnum getFindingDetails() {
    return findingDetails;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FINDING_DETAILS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFindingDetails(@jakarta.annotation.Nullable FindingDetailsEnum findingDetails) {
    this.findingDetails = findingDetails;
  }


  public CreateReportTemplateRequestFormValuesOneOf hostDetails(@jakarta.annotation.Nullable Boolean hostDetails) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_HOST_DETAILS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getHostDetails() {
    return hostDetails;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_HOST_DETAILS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHostDetails(@jakarta.annotation.Nullable Boolean hostDetails) {
    this.hostDetails = hostDetails;
  }


  public CreateReportTemplateRequestFormValuesOneOf resultDetails(@jakarta.annotation.Nullable Boolean resultDetails) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RESULT_DETAILS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_RESULT_DETAILS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResultDetails(@jakarta.annotation.Nullable Boolean resultDetails) {
    this.resultDetails = resultDetails;
  }


  public CreateReportTemplateRequestFormValuesOneOf httpDetails(@jakarta.annotation.Nullable Boolean httpDetails) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_HTTP_DETAILS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getHttpDetails() {
    return httpDetails;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_HTTP_DETAILS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHttpDetails(@jakarta.annotation.Nullable Boolean httpDetails) {
    this.httpDetails = httpDetails;
  }


  public CreateReportTemplateRequestFormValuesOneOf comments(@jakarta.annotation.Nullable Boolean comments) {
  ...
  public CreateReportTemplateRequestFormValuesOneOf standards(@jakarta.annotation.Nullable Boolean standards) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_STANDARDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getStandards() {
    return standards;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_STANDARDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStandards(@jakarta.annotation.Nullable Boolean standards) {
    this.standards = standards;
  }


  /**
   * Return true if this createReportTemplate_request_formValues_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateReportTemplateRequestFormValuesOneOf createReportTemplateRequestFormValuesOneOf = (CreateReportTemplateRequestFormValuesOneOf) o;
    return Objects.equals(this.executiveSummary, createReportTemplateRequestFormValuesOneOf.executiveSummary) &&
        Objects.equals(this.findingDetails, createReportTemplateRequestFormValuesOneOf.findingDetails) &&
        Objects.equals(this.hostDetails, createReportTemplateRequestFormValuesOneOf.hostDetails) &&
        Objects.equals(this.resultDetails, createReportTemplateRequestFormValuesOneOf.resultDetails) &&
        Objects.equals(this.httpDetails, createReportTemplateRequestFormValuesOneOf.httpDetails) &&
        Objects.equals(this.comments, createReportTemplateRequestFormValuesOneOf.comments) &&
        Objects.equals(this.standards, createReportTemplateRequestFormValuesOneOf.standards);
  }

  @Override
  public int hashCode() {
    return Objects.hash(executiveSummary, findingDetails, hostDetails, resultDetails, httpDetails, comments, standards);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateReportTemplateRequestFormValuesOneOf {\n");
    ...
    sb.append("    httpDetails: ").append(toIndentedString(httpDetails)).append("\n");
