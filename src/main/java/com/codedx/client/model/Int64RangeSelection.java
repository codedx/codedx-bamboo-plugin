...
import com.codedx.client.model.Int64RangeSelectionOneOf;
import com.codedx.client.model.Int64RangeSelectionOneOf1;
import com.codedx.client.model.Int64RangeSelectionOneOf2;
...
@JsonDeserialize(using = Int64RangeSelection.Int64RangeSelectionDeserializer.class)
@JsonSerialize(using = Int64RangeSelection.Int64RangeSelectionSerializer.class)
public class Int64RangeSelection extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Int64RangeSelection.class.getName());

    public static class Int64RangeSelectionSerializer extends StdSerializer<Int64RangeSelection> {
        public Int64RangeSelectionSerializer(Class<Int64RangeSelection> t) {
            super(t);
        }

        public Int64RangeSelectionSerializer() {
            this(null);
        }

        @Override
        public void serialize(Int64RangeSelection value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class Int64RangeSelectionDeserializer extends StdDeserializer<Int64RangeSelection> {
        public Int64RangeSelectionDeserializer() {
            this(Int64RangeSelection.class);
        }

        public Int64RangeSelectionDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public Int64RangeSelection deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize Int64RangeSelectionOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(Int64RangeSelectionOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'Int64RangeSelectionOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'Int64RangeSelectionOneOf'", e);
            }

            // deserialize Int64RangeSelectionOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(Int64RangeSelectionOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'Int64RangeSelectionOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'Int64RangeSelectionOneOf1'", e);
            }

            // deserialize Int64RangeSelectionOneOf2
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(Int64RangeSelectionOneOf2.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'Int64RangeSelectionOneOf2'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'Int64RangeSelectionOneOf2'", e);
            }

            if (match == 1) {
                Int64RangeSelection ret = new Int64RangeSelection();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Int64RangeSelection: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public Int64RangeSelection getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "Int64RangeSelection cannot be null");
        }
    }
    ...
    public Int64RangeSelection() {
        super("oneOf", Boolean.FALSE);
    }

    public Int64RangeSelection(Int64RangeSelectionOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Int64RangeSelection(Int64RangeSelectionOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Int64RangeSelection(Int64RangeSelectionOneOf2 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("Int64RangeSelectionOneOf", new GenericType<Int64RangeSelectionOneOf>() {
        });
        schemas.put("Int64RangeSelectionOneOf1", new GenericType<Int64RangeSelectionOneOf1>() {
        });
        schemas.put("Int64RangeSelectionOneOf2", new GenericType<Int64RangeSelectionOneOf2>() {
        });
        JSON.registerDescendants(Int64RangeSelection.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return Int64RangeSelection.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * Int64RangeSelectionOneOf, Int64RangeSelectionOneOf1, Int64RangeSelectionOneOf2
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(Int64RangeSelectionOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(Int64RangeSelectionOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(Int64RangeSelectionOneOf2.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Int64RangeSelectionOneOf, Int64RangeSelectionOneOf1, Int64RangeSelectionOneOf2");
    }
     ...
     * Int64RangeSelectionOneOf, Int64RangeSelectionOneOf1, Int64RangeSelectionOneOf2
     *
     * @return The actual instance (Int64RangeSelectionOneOf, Int64RangeSelectionOneOf1, Int64RangeSelectionOneOf2)
     */
    @Override
    ...
    /**
     * Get the actual instance of `Int64RangeSelectionOneOf`. If the actual instance is not `Int64RangeSelectionOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Int64RangeSelectionOneOf`
     * @throws ClassCastException if the instance is not `Int64RangeSelectionOneOf`
     */
    public Int64RangeSelectionOneOf getInt64RangeSelectionOneOf() throws ClassCastException {
        return (Int64RangeSelectionOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `Int64RangeSelectionOneOf1`. If the actual instance is not `Int64RangeSelectionOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Int64RangeSelectionOneOf1`
     * @throws ClassCastException if the instance is not `Int64RangeSelectionOneOf1`
     */
    public Int64RangeSelectionOneOf1 getInt64RangeSelectionOneOf1() throws ClassCastException {
        return (Int64RangeSelectionOneOf1)super.getActualInstance();
    }

    /**
     * Get the actual instance of `Int64RangeSelectionOneOf2`. If the actual instance is not `Int64RangeSelectionOneOf2`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Int64RangeSelectionOneOf2`
     * @throws ClassCastException if the instance is not `Int64RangeSelectionOneOf2`
     */
    public Int64RangeSelectionOneOf2 getInt64RangeSelectionOneOf2() throws ClassCastException {
        return (Int64RangeSelectionOneOf2)super.getActualInstance();
    }
