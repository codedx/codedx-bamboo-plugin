 ...
 */
@JsonPropertyOrder({
  LocationRange.JSON_PROPERTY_IS_INDETERMINATE,
  LocationRange.JSON_PROPERTY_IS_POINT,
  LocationRange.JSON_PROPERTY_START,
  LocationRange.JSON_PROPERTY_END
})
...
public class LocationRange {
  public static final String JSON_PROPERTY_IS_INDETERMINATE = "isIndeterminate";
  @jakarta.annotation.Nullable
  private Boolean isIndeterminate;

  public static final String JSON_PROPERTY_IS_POINT = "isPoint";
  @jakarta.annotation.Nullable
  ...
  public LocationRange isIndeterminate(@jakarta.annotation.Nullable Boolean isIndeterminate) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_INDETERMINATE, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_INDETERMINATE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsIndeterminate(@jakarta.annotation.Nullable Boolean isIndeterminate) {
    this.isIndeterminate = isIndeterminate;
  }


  public LocationRange isPoint(@jakarta.annotation.Nullable Boolean isPoint) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_POINT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_POINT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsPoint(@jakarta.annotation.Nullable Boolean isPoint) {
    this.isPoint = isPoint;
  }


  public LocationRange start(@jakarta.annotation.Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public LocationRange end(@jakarta.annotation.Nullable Integer end) {
    this.end = end;
    return this;
  }
  ...
  /**
   * Return true if this LocationRange object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isIndeterminate, locationRange.isIndeterminate) &&
        Objects.equals(this.isPoint, locationRange.isPoint) &&
        Objects.equals(this.start, locationRange.start) &&
        Objects.equals(this.end, locationRange.end);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isIndeterminate, isPoint, start, end);
  }
  ...
  public String toString() {
    ...
    sb.append("    isIndeterminate: ").append(toIndentedString(isIndeterminate)).append("\n");
    sb.append("    isPoint: ").append(toIndentedString(isPoint)).append("\n");
