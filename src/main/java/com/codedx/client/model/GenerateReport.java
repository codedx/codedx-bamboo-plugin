 ...
 */
@JsonPropertyOrder({
  GenerateReport.JSON_PROPERTY_FILTER,
  GenerateReport.JSON_PROPERTY_VALUES,
  GenerateReport.JSON_PROPERTY_VALIDATION_TOKEN
})
...
public class GenerateReport {
  ...
  public static final String JSON_PROPERTY_VALIDATION_TOKEN = "validationToken";
  @jakarta.annotation.Nullable
  ...
  public GenerateReport filter(@jakarta.annotation.Nullable Filter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public GenerateReport values(@jakarta.annotation.Nullable Map<String, Object> values) {
    this.values = values;
    return this;
  }

  public GenerateReport putValuesItem(String key, Object valuesItem) {
    if (this.values == null) {
  ...
  /**
   * This object will be a series of key value pairs. A key value field for each of the form fields described by the Report Type, where the key is the field&#39;s &#x60;key&#x60;, and the value is the configuration value corresponding to that field&#39;s type.
   * @return values
   */
  @jakarta.annotation.Nullable
  ...
  public GenerateReport validationToken(@jakarta.annotation.Nullable String validationToken) {
    this.validationToken = validationToken;
    return this;
  }

  /**
   * A validation token obtained from the &#x60;Validate Report Form&#x60; endpoint using the same &#x60;filter&#x60; and &#x60;values&#x60;.
   * @return validationToken
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_VALIDATION_TOKEN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_VALIDATION_TOKEN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValidationToken(@jakarta.annotation.Nullable String validationToken) {
    this.validationToken = validationToken;
  }


  /**
   * Return true if this GenerateReport object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filter, generateReport.filter) &&
        Objects.equals(this.values, generateReport.values) &&
        Objects.equals(this.validationToken, generateReport.validationToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filter, values, validationToken);
  }
