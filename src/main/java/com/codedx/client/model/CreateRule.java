 ...
 */
@JsonPropertyOrder({
  CreateRule.JSON_PROPERTY_NAME,
  CreateRule.JSON_PROPERTY_SEVERITY,
  CreateRule.JSON_PROPERTY_CWE_ID,
  CreateRule.JSON_PROPERTY_DESCRIPTION,
  CreateRule.JSON_PROPERTY_GROUP_ID
})
...
public class CreateRule {
  ...
  public CreateRule name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateRule severity(@jakarta.annotation.Nullable SeverityKey severity) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SEVERITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSeverity(@jakarta.annotation.Nullable SeverityKey severity) {
    this.severity = severity;
  }


  public CreateRule cweId(@jakarta.annotation.Nullable Integer cweId) {
    this.cweId = cweId;
    return this;
  }
  ...
  public CreateRule description(@jakarta.annotation.Nullable Description description) {
  ...
  public CreateRule groupId(@jakarta.annotation.Nullable Integer groupId) {
  ...
  /**
   * Return true if this CreateRule object is equal to o.
   */
  @Override
