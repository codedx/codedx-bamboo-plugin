 ...
 */
@JsonPropertyOrder({
  UserRole.JSON_PROPERTY_USER,
  UserRole.JSON_PROPERTY_ROLES
})
...
public class UserRole {
  ...
  public UserRole user(@jakarta.annotation.Nullable User user) {
    this.user = user;
    return this;
  }
  ...
  public UserRole roles(@jakarta.annotation.Nullable Roles roles) {
    this.roles = roles;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ROLES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRoles(@jakarta.annotation.Nullable Roles roles) {
    this.roles = roles;
  }


  /**
   * Return true if this UserRole object is equal to o.
   */
  @Override
