...
/**
 * ToolOutputValueInner
 */
@JsonPropertyOrder({
  ToolOutputValueInner.JSON_PROPERTY_ID,
  ToolOutputValueInner.JSON_PROPERTY_NAME
})
@JsonTypeName("ToolOutput_value_inner")
...
public class ToolOutputValueInner {
  ...
  public ToolOutputValueInner() { 
  }

  public ToolOutputValueInner id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ToolOutputValueInner name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Return true if this ToolOutput_value_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ToolOutputValueInner toolOutputValueInner = (ToolOutputValueInner) o;
    return Objects.equals(this.id, toolOutputValueInner.id) &&
        Objects.equals(this.name, toolOutputValueInner.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ToolOutputValueInner {\n");
