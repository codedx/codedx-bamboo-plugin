...
import com.codedx.client.model.UseExistingEntity;
...
@JsonDeserialize(using = ImportProjectsFromIntegrationProjectEntity.ImportProjectsFromIntegrationProjectEntityDeserializer.class)
@JsonSerialize(using = ImportProjectsFromIntegrationProjectEntity.ImportProjectsFromIntegrationProjectEntitySerializer.class)
public class ImportProjectsFromIntegrationProjectEntity extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ImportProjectsFromIntegrationProjectEntity.class.getName());

    public static class ImportProjectsFromIntegrationProjectEntitySerializer extends StdSerializer<ImportProjectsFromIntegrationProjectEntity> {
        public ImportProjectsFromIntegrationProjectEntitySerializer(Class<ImportProjectsFromIntegrationProjectEntity> t) {
            super(t);
        }

        public ImportProjectsFromIntegrationProjectEntitySerializer() {
            this(null);
        }

        @Override
        public void serialize(ImportProjectsFromIntegrationProjectEntity value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ImportProjectsFromIntegrationProjectEntityDeserializer extends StdDeserializer<ImportProjectsFromIntegrationProjectEntity> {
        public ImportProjectsFromIntegrationProjectEntityDeserializer() {
            this(ImportProjectsFromIntegrationProjectEntity.class);
        }

        public ImportProjectsFromIntegrationProjectEntityDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ImportProjectsFromIntegrationProjectEntity deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize UseExistingEntity
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(UseExistingEntity.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'UseExistingEntity'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'UseExistingEntity'", e);
            }

            // deserialize CreateNewEntity
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(CreateNewEntity.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'CreateNewEntity'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'CreateNewEntity'", e);
            }

            if (match == 1) {
                ImportProjectsFromIntegrationProjectEntity ret = new ImportProjectsFromIntegrationProjectEntity();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ImportProjectsFromIntegrationProjectEntity: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ImportProjectsFromIntegrationProjectEntity getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ImportProjectsFromIntegrationProjectEntity cannot be null");
        }
    }
    ...
    public ImportProjectsFromIntegrationProjectEntity() {
        super("oneOf", Boolean.FALSE);
    }

    public ImportProjectsFromIntegrationProjectEntity(UseExistingEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ImportProjectsFromIntegrationProjectEntity(CreateNewEntity o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("CreateNewEntity", new GenericType<CreateNewEntity>() {
        });
        schemas.put("UseExistingEntity", new GenericType<UseExistingEntity>() {
        });
        JSON.registerDescendants(ImportProjectsFromIntegrationProjectEntity.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return ImportProjectsFromIntegrationProjectEntity.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * CreateNewEntity, UseExistingEntity
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(UseExistingEntity.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(CreateNewEntity.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be CreateNewEntity, UseExistingEntity");
    }
     ...
     * CreateNewEntity, UseExistingEntity
     *
     * @return The actual instance (CreateNewEntity, UseExistingEntity)
     */
    @Override
    ...
    /**
     * Get the actual instance of `UseExistingEntity`. If the actual instance is not `UseExistingEntity`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UseExistingEntity`
     * @throws ClassCastException if the instance is not `UseExistingEntity`
     */
    public UseExistingEntity getUseExistingEntity() throws ClassCastException {
        return (UseExistingEntity)super.getActualInstance();
    }

    /**
     * Get the actual instance of `CreateNewEntity`. If the actual instance is not `CreateNewEntity`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `CreateNewEntity`
     * @throws ClassCastException if the instance is not `CreateNewEntity`
     */
    public CreateNewEntity getCreateNewEntity() throws ClassCastException {
        return (CreateNewEntity)super.getActualInstance();
    }
