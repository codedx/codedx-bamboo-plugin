 ...
 */
@JsonPropertyOrder({
  Analysis.JSON_PROPERTY_ANALYSIS_ID,
  Analysis.JSON_PROPERTY_JOB_ID
})
...
public class Analysis {
  ...
  public Analysis analysisId(@jakarta.annotation.Nullable Integer analysisId) {
  ...
  public Analysis jobId(@jakarta.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  /**
   * Return true if this Analysis object is equal to o.
   */
  @Override
