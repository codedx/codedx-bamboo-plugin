 ...
 */
@JsonPropertyOrder({
  PredictedStatus.JSON_PROPERTY_STATUS
})
...
public class PredictedStatus {
  ...
  public PredictedStatus() { 
  }

  public PredictedStatus status(@jakarta.annotation.Nullable String status) {
    this.status = status;
    return this;
  }

  /**
   * The predicted triage status of a finding or set of findings
   * @return status
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this PredictedStatus object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PredictedStatus predictedStatus = (PredictedStatus) o;
    return Objects.equals(this.status, predictedStatus.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PredictedStatus {\n");
