 ...
 */
@JsonPropertyOrder({
  RuleSetDeleteResponse.JSON_PROPERTY_REPLACEMENT,
  RuleSetDeleteResponse.JSON_PROPERTY_AFFECTED_PROJECTS
})
...
public class RuleSetDeleteResponse {
  ...
  private RuleSet replacement;

  public static final String JSON_PROPERTY_AFFECTED_PROJECTS = "affectedProjects";
  @jakarta.annotation.Nullable
  private List<Integer> affectedProjects = new ArrayList<>();

  public RuleSetDeleteResponse() { 
  }

  public RuleSetDeleteResponse replacement(@jakarta.annotation.Nullable RuleSet replacement) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REPLACEMENT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReplacement(@jakarta.annotation.Nullable RuleSet replacement) {
    this.replacement = replacement;
  }


  public RuleSetDeleteResponse affectedProjects(@jakarta.annotation.Nullable List<Integer> affectedProjects) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AFFECTED_PROJECTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_AFFECTED_PROJECTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAffectedProjects(@jakarta.annotation.Nullable List<Integer> affectedProjects) {
    this.affectedProjects = affectedProjects;
  }


  /**
   * Return true if this RuleSetDeleteResponse object is equal to o.
   */
  @Override
