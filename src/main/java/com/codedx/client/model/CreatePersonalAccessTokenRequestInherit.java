...
@JsonDeserialize(using = CreatePersonalAccessTokenRequestInherit.CreatePersonalAccessTokenRequestInheritDeserializer.class)
@JsonSerialize(using = CreatePersonalAccessTokenRequestInherit.CreatePersonalAccessTokenRequestInheritSerializer.class)
public class CreatePersonalAccessTokenRequestInherit extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreatePersonalAccessTokenRequestInherit.class.getName());

    public static class CreatePersonalAccessTokenRequestInheritSerializer extends StdSerializer<CreatePersonalAccessTokenRequestInherit> {
        public CreatePersonalAccessTokenRequestInheritSerializer(Class<CreatePersonalAccessTokenRequestInherit> t) {
            super(t);
        }

        public CreatePersonalAccessTokenRequestInheritSerializer() {
            this(null);
        }

        @Override
        public void serialize(CreatePersonalAccessTokenRequestInherit value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CreatePersonalAccessTokenRequestInheritDeserializer extends StdDeserializer<CreatePersonalAccessTokenRequestInherit> {
        public CreatePersonalAccessTokenRequestInheritDeserializer() {
            this(CreatePersonalAccessTokenRequestInherit.class);
        }

        public CreatePersonalAccessTokenRequestInheritDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CreatePersonalAccessTokenRequestInherit deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                CreatePersonalAccessTokenRequestInherit ret = new CreatePersonalAccessTokenRequestInherit();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreatePersonalAccessTokenRequestInherit: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public CreatePersonalAccessTokenRequestInherit getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "CreatePersonalAccessTokenRequestInherit cannot be null");
        }
    }
    ...
    public CreatePersonalAccessTokenRequestInherit() {
        super("oneOf", Boolean.FALSE);
    }

    public CreatePersonalAccessTokenRequestInherit(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreatePersonalAccessTokenRequestInherit(List o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(CreatePersonalAccessTokenRequestInherit.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return CreatePersonalAccessTokenRequestInherit.schemas;
    }
