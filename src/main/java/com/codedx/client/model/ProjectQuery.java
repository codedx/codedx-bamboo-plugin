 ...
 */
@JsonPropertyOrder({
  ProjectQuery.JSON_PROPERTY_OFFSET,
  ProjectQuery.JSON_PROPERTY_LIMIT,
  ProjectQuery.JSON_PROPERTY_FILTER
})
...
public class ProjectQuery {
  ...
  @jakarta.annotation.Nullable
  private ProjectQueryFilter filter;

  public ProjectQuery() { 
  }

  public ProjectQuery offset(@jakarta.annotation.Nullable Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public ProjectQuery limit(@jakarta.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public ProjectQuery filter(@jakarta.annotation.Nullable ProjectQueryFilter filter) {
    this.filter = filter;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FILTER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilter(@jakarta.annotation.Nullable ProjectQueryFilter filter) {
    this.filter = filter;
  }


  /**
   * Return true if this ProjectQuery object is equal to o.
   */
  @Override
