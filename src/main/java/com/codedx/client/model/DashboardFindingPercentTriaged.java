...
/**
 * DashboardFindingPercentTriaged
 */
@JsonPropertyOrder({
  DashboardFindingPercentTriaged.JSON_PROPERTY_NUM_TRIAGED_FINDINGS,
  DashboardFindingPercentTriaged.JSON_PROPERTY_NUM_TOTAL_FINDINGS
})
...
public class DashboardFindingPercentTriaged {
  public static final String JSON_PROPERTY_NUM_TRIAGED_FINDINGS = "numTriagedFindings";
  @jakarta.annotation.Nullable
  private Integer numTriagedFindings;

  public static final String JSON_PROPERTY_NUM_TOTAL_FINDINGS = "numTotalFindings";
  @jakarta.annotation.Nullable
  private Integer numTotalFindings;

  public DashboardFindingPercentTriaged() { 
  }

  public DashboardFindingPercentTriaged numTriagedFindings(@jakarta.annotation.Nullable Integer numTriagedFindings) {
    this.numTriagedFindings = numTriagedFindings;
    return this;
  }

  /**
   * Get numTriagedFindings
   * minimum: 0
  ...
  public DashboardFindingPercentTriaged numTotalFindings(@jakarta.annotation.Nullable Integer numTotalFindings) {
    this.numTotalFindings = numTotalFindings;
    return this;
  }

  /**
   * Get numTotalFindings
   * minimum: 0
   * @return numTotalFindings
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_TOTAL_FINDINGS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getNumTotalFindings() {
    return numTotalFindings;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_TOTAL_FINDINGS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumTotalFindings(@jakarta.annotation.Nullable Integer numTotalFindings) {
    this.numTotalFindings = numTotalFindings;
  }


  /**
   * Return true if this DashboardFindingPercentTriaged object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardFindingPercentTriaged dashboardFindingPercentTriaged = (DashboardFindingPercentTriaged) o;
    return Objects.equals(this.numTriagedFindings, dashboardFindingPercentTriaged.numTriagedFindings) &&
        Objects.equals(this.numTotalFindings, dashboardFindingPercentTriaged.numTotalFindings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numTriagedFindings, numTotalFindings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardFindingPercentTriaged {\n");
    sb.append("    numTriagedFindings: ").append(toIndentedString(numTriagedFindings)).append("\n");
    sb.append("    numTotalFindings: ").append(toIndentedString(numTotalFindings)).append("\n");
    sb.append("}");
    return sb.toString();
  }
