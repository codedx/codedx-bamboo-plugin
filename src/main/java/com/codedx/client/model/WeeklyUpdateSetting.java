 ...
 */
@JsonPropertyOrder({
  WeeklyUpdateSetting.JSON_PROPERTY_TYPE,
  WeeklyUpdateSetting.JSON_PROPERTY_NUM_WEEKS,
  WeeklyUpdateSetting.JSON_PROPERTY_DAYS,
  WeeklyUpdateSetting.JSON_PROPERTY_TIME
})
...
public class WeeklyUpdateSetting {
  ...
  /**
   * The number corresponds to the day of the week. I.E 1 &#x3D; Monday, 2 &#x3D; Tuesday, ... 7 &#x3D; Sunday
   */
  ...
  public WeeklyUpdateSetting() { 
  }

  public WeeklyUpdateSetting type(@jakarta.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public WeeklyUpdateSetting numWeeks(@jakarta.annotation.Nullable Integer numWeeks) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_WEEKS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_WEEKS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumWeeks(@jakarta.annotation.Nullable Integer numWeeks) {
    this.numWeeks = numWeeks;
  }


  public WeeklyUpdateSetting days(@jakarta.annotation.Nullable List<DaysEnum> days) {
    this.days = days;
    return this;
  }

  public WeeklyUpdateSetting addDaysItem(DaysEnum daysItem) {
    if (this.days == null) {
  ...
  public WeeklyUpdateSetting time(@jakarta.annotation.Nullable String time) {
    this.time = time;
    return this;
  }

  /**
   * Time in String(ISO-8061) format
   * @return time
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this WeeklyUpdateSetting object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WeeklyUpdateSetting weeklyUpdateSetting = (WeeklyUpdateSetting) o;
    return Objects.equals(this.type, weeklyUpdateSetting.type) &&
        Objects.equals(this.numWeeks, weeklyUpdateSetting.numWeeks) &&
        Objects.equals(this.days, weeklyUpdateSetting.days) &&
        Objects.equals(this.time, weeklyUpdateSetting.time);
  }
  ...
  public String toString() {
    ...
    sb.append("class WeeklyUpdateSetting {\n");
