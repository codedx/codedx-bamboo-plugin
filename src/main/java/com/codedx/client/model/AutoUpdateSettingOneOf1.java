...
/**
 * A daily interval, representing &#39;every &lt;n&gt; days at &lt;hh:mm&gt;&#39;
 */
@JsonPropertyOrder({
  AutoUpdateSettingOneOf1.JSON_PROPERTY_TYPE,
  AutoUpdateSettingOneOf1.JSON_PROPERTY_NUM_DAYS,
  AutoUpdateSettingOneOf1.JSON_PROPERTY_TIME
})
@JsonTypeName("AutoUpdateSetting_oneOf_1")
...
public class AutoUpdateSettingOneOf1 {
  /**
   * Gets or Sets type
   */
  ...
  public static final String JSON_PROPERTY_NUM_DAYS = "numDays";
  @jakarta.annotation.Nonnull
  ...
  public AutoUpdateSettingOneOf1() { 
  }

  public AutoUpdateSettingOneOf1 type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AutoUpdateSettingOneOf1 numDays(@jakarta.annotation.Nonnull BigDecimal numDays) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_NUM_DAYS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_DAYS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNumDays(@jakarta.annotation.Nonnull BigDecimal numDays) {
    this.numDays = numDays;
  }


  public AutoUpdateSettingOneOf1 time(@jakarta.annotation.Nonnull String time) {
    this.time = time;
    return this;
  }
  ...
  /**
   * Return true if this AutoUpdateSetting_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AutoUpdateSettingOneOf1 autoUpdateSettingOneOf1 = (AutoUpdateSettingOneOf1) o;
    return Objects.equals(this.type, autoUpdateSettingOneOf1.type) &&
        Objects.equals(this.numDays, autoUpdateSettingOneOf1.numDays) &&
        Objects.equals(this.time, autoUpdateSettingOneOf1.time);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, numDays, time);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AutoUpdateSettingOneOf1 {\n");
