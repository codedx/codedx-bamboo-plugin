...
public class Metadata {
  ...
  public Metadata id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Metadata type(@jakarta.annotation.Nullable MetadataFieldType type) {
    this.type = type;
    return this;
  }
  ...
  public Metadata value(@jakarta.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public Metadata values(@jakarta.annotation.Nullable List<MetadataValue> values) {
    this.values = values;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable List<MetadataValue> values) {
    this.values = values;
  }
