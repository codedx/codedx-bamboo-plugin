...
/**
 * An integration entity&#39;s definition consists of a name and a mapping of keys and values corresponding to fields that are relevant to that entity.
 */
@JsonPropertyOrder({
  IntegrationEntityDefinition.JSON_PROPERTY_NAME,
  IntegrationEntityDefinition.JSON_PROPERTY_VALUES
})
...
public class IntegrationEntityDefinition {
  ...
  public IntegrationEntityDefinition() { 
  }

  public IntegrationEntityDefinition name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public IntegrationEntityDefinition values(@jakarta.annotation.Nonnull Map<String, String> values) {
    this.values = values;
    return this;
  }

  public IntegrationEntityDefinition putValuesItem(String key, String valuesItem) {
    if (this.values == null) {
  ...
  /**
   * Return true if this IntegrationEntityDefinition object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IntegrationEntityDefinition integrationEntityDefinition = (IntegrationEntityDefinition) o;
    return Objects.equals(this.name, integrationEntityDefinition.name) &&
        Objects.equals(this.values, integrationEntityDefinition.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntegrationEntityDefinition {\n");
