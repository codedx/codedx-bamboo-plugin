 ...
 */
@JsonPropertyOrder({
  ReportType.JSON_PROPERTY_NAME,
  ReportType.JSON_PROPERTY_TYPE,
  ReportType.JSON_PROPERTY_CONFIG_OPTIONS
})
...
public class ReportType {
  ...
  public static final String JSON_PROPERTY_CONFIG_OPTIONS = "configOptions";
  @jakarta.annotation.Nullable
  private List<ReportConfigOption> configOptions = new ArrayList<>();

  public ReportType() { 
  }

  public ReportType name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ReportType type(@jakarta.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ReportType configOptions(@jakarta.annotation.Nullable List<ReportConfigOption> configOptions) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONFIG_OPTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONFIG_OPTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConfigOptions(@jakarta.annotation.Nullable List<ReportConfigOption> configOptions) {
    this.configOptions = configOptions;
  }


  /**
   * Return true if this ReportType object is equal to o.
   */
  @Override
