 ...
 */
@JsonPropertyOrder({
  Permission.JSON_PROPERTY_KEY,
  Permission.JSON_PROPERTY_GROUP,
  Permission.JSON_PROPERTY_DESCRIPTION,
  Permission.JSON_PROPERTY_SCOPE,
  Permission.JSON_PROPERTY_IS_BULK_OP
})
...
public class Permission {
  ...
  public enum ScopeEnum {
    ...
    SAVED_FILTER(String.valueOf("saved-filter")),
    
    TOOL_CONFIGURATION_ENTITY(String.valueOf("tool-configuration-entity"));
  ...
  public static final String JSON_PROPERTY_IS_BULK_OP = "isBulkOp";
  ...
  public Permission key(@jakarta.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }

  /**
   * The key of this permission.
   * @return key
   */
  @jakarta.annotation.Nonnull
  ...
  public Permission group(@jakarta.annotation.Nonnull String group) {
    this.group = group;
    return this;
  }

  /**
   * The group that contains this permission.
   * @return group
   */
  @jakarta.annotation.Nonnull
  ...
  public Permission description(@jakarta.annotation.Nonnull String description) {
  ...
  public Permission scope(@jakarta.annotation.Nonnull ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
  ...
  public Permission isBulkOp(@jakarta.annotation.Nullable Boolean isBulkOp) {
    this.isBulkOp = isBulkOp;
    return this;
  }

  /**
   * Whether or not this permission distinguishes betwen single and bulk.
   * @return isBulkOp
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_BULK_OP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getIsBulkOp() {
    return isBulkOp;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_BULK_OP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsBulkOp(@jakarta.annotation.Nullable Boolean isBulkOp) {
    this.isBulkOp = isBulkOp;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, permission.key) &&
        ...
        Objects.equals(this.isBulkOp, permission.isBulkOp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, group, description, scope, isBulkOp);
  }
  ...
  public String toString() {
    ...
    sb.append("    isBulkOp: ").append(toIndentedString(isBulkOp)).append("\n");
    sb.append("}");
    return sb.toString();
  }
