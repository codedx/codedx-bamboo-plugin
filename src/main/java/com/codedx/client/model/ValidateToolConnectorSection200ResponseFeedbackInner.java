...
/**
 * A feedback item; will contain exactly one of: checkmark, info, warning, or error
 */
@JsonPropertyOrder({
  ValidateToolConnectorSection200ResponseFeedbackInner.JSON_PROPERTY_FIELD,
  ValidateToolConnectorSection200ResponseFeedbackInner.JSON_PROPERTY_CHECKMARK,
  ValidateToolConnectorSection200ResponseFeedbackInner.JSON_PROPERTY_INFO,
  ValidateToolConnectorSection200ResponseFeedbackInner.JSON_PROPERTY_WARNING,
  ValidateToolConnectorSection200ResponseFeedbackInner.JSON_PROPERTY_ERROR
})
@JsonTypeName("validateToolConnectorSection_200_response_feedback_inner")
...
public class ValidateToolConnectorSection200ResponseFeedbackInner {
  public static final String JSON_PROPERTY_FIELD = "field";
  @jakarta.annotation.Nonnull
  private String field;

  public static final String JSON_PROPERTY_CHECKMARK = "checkmark";
  ...
  public ValidateToolConnectorSection200ResponseFeedbackInner() { 
  }

  public ValidateToolConnectorSection200ResponseFeedbackInner field(@jakarta.annotation.Nonnull String field) {
    this.field = field;
    return this;
  }

  /**
   * The field to which the feedback applies
   * @return field
   */
  @jakarta.annotation.Nonnull
  ...
  public ValidateToolConnectorSection200ResponseFeedbackInner checkmark(@jakarta.annotation.Nullable Boolean checkmark) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CHECKMARK, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_CHECKMARK, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCheckmark(@jakarta.annotation.Nullable Boolean checkmark) {
    this.checkmark = checkmark;
  }


  public ValidateToolConnectorSection200ResponseFeedbackInner info(@jakarta.annotation.Nullable String info) {
    this.info = info;
    return this;
  }
  ...
  public ValidateToolConnectorSection200ResponseFeedbackInner warning(@jakarta.annotation.Nullable String warning) {
  ...
  public ValidateToolConnectorSection200ResponseFeedbackInner error(@jakarta.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  /**
   * Return true if this validateToolConnectorSection_200_response_feedback_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ValidateToolConnectorSection200ResponseFeedbackInner validateToolConnectorSection200ResponseFeedbackInner = (ValidateToolConnectorSection200ResponseFeedbackInner) o;
    return Objects.equals(this.field, validateToolConnectorSection200ResponseFeedbackInner.field) &&
        Objects.equals(this.checkmark, validateToolConnectorSection200ResponseFeedbackInner.checkmark) &&
        Objects.equals(this.info, validateToolConnectorSection200ResponseFeedbackInner.info) &&
        Objects.equals(this.warning, validateToolConnectorSection200ResponseFeedbackInner.warning) &&
        Objects.equals(this.error, validateToolConnectorSection200ResponseFeedbackInner.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(field, checkmark, info, warning, error);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValidateToolConnectorSection200ResponseFeedbackInner {\n");
    sb.append("    field: ").append(toIndentedString(field)).append("\n");
    sb.append("    checkmark: ").append(toIndentedString(checkmark)).append("\n");
