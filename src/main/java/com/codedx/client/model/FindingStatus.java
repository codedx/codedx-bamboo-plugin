 ...
 */
@JsonPropertyOrder({
  FindingStatus.JSON_PROPERTY_ID,
  FindingStatus.JSON_PROPERTY_NAME
})
...
public class FindingStatus {
  ...
  public FindingStatus id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public FindingStatus name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Return true if this FindingStatus object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FindingStatus findingStatus = (FindingStatus) o;
    return Objects.equals(this.id, findingStatus.id) &&
        Objects.equals(this.name, findingStatus.name);
  }
