 ...
 */
@JsonPropertyOrder({
  AnalysisName.JSON_PROPERTY_NAME
})
...
public class AnalysisName {
  ...
  public AnalysisName name(@jakarta.annotation.Nullable String name) {
  ...
  /**
   * Return true if this AnalysisName object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, analysisName.name);
  }
