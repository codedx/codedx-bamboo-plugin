...
import com.codedx.client.model.DashboardCodeMetricsDetailsComplexity;
...
/**
 * DashboardCodeMetricsDetails
 */
@JsonPropertyOrder({
  DashboardCodeMetricsDetails.JSON_PROPERTY_NUM_TOTAL_LINES,
  DashboardCodeMetricsDetails.JSON_PROPERTY_NUM_COMMENT_LINES,
  DashboardCodeMetricsDetails.JSON_PROPERTY_NUM_SOURCE_FILES,
  DashboardCodeMetricsDetails.JSON_PROPERTY_COMPLEXITY,
  DashboardCodeMetricsDetails.JSON_PROPERTY_CODE_CHURN,
  DashboardCodeMetricsDetails.JSON_PROPERTY_NUM_FINDINGS
})
...
public class DashboardCodeMetricsDetails {
  public static final String JSON_PROPERTY_NUM_TOTAL_LINES = "numTotalLines";
  @jakarta.annotation.Nullable
  private Integer numTotalLines;

  public static final String JSON_PROPERTY_NUM_COMMENT_LINES = "numCommentLines";
  @jakarta.annotation.Nullable
  private Integer numCommentLines;

  public static final String JSON_PROPERTY_NUM_SOURCE_FILES = "numSourceFiles";
  @jakarta.annotation.Nullable
  private Integer numSourceFiles;

  public static final String JSON_PROPERTY_COMPLEXITY = "complexity";
  private JsonNullable<DashboardCodeMetricsDetailsComplexity> complexity = JsonNullable.<DashboardCodeMetricsDetailsComplexity>undefined();

  public static final String JSON_PROPERTY_CODE_CHURN = "codeChurn";
  @jakarta.annotation.Nullable
  private Integer codeChurn;

  public static final String JSON_PROPERTY_NUM_FINDINGS = "numFindings";
  @jakarta.annotation.Nullable
  private Integer numFindings;

  public DashboardCodeMetricsDetails() { 
  }

  public DashboardCodeMetricsDetails numTotalLines(@jakarta.annotation.Nullable Integer numTotalLines) {
    this.numTotalLines = numTotalLines;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_TOTAL_LINES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getNumTotalLines() {
    return numTotalLines;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_TOTAL_LINES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumTotalLines(@jakarta.annotation.Nullable Integer numTotalLines) {
    this.numTotalLines = numTotalLines;
  }


  public DashboardCodeMetricsDetails numCommentLines(@jakarta.annotation.Nullable Integer numCommentLines) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_COMMENT_LINES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_COMMENT_LINES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumCommentLines(@jakarta.annotation.Nullable Integer numCommentLines) {
    this.numCommentLines = numCommentLines;
  }


  public DashboardCodeMetricsDetails numSourceFiles(@jakarta.annotation.Nullable Integer numSourceFiles) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_SOURCE_FILES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getNumSourceFiles() {
    return numSourceFiles;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_SOURCE_FILES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumSourceFiles(@jakarta.annotation.Nullable Integer numSourceFiles) {
    this.numSourceFiles = numSourceFiles;
  }


  public DashboardCodeMetricsDetails complexity(@jakarta.annotation.Nullable DashboardCodeMetricsDetailsComplexity complexity) {
    this.complexity = JsonNullable.<DashboardCodeMetricsDetailsComplexity>of(complexity);
    return this;
  }
  ...
  public DashboardCodeMetricsDetailsComplexity getComplexity() {
        return complexity.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_COMPLEXITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<DashboardCodeMetricsDetailsComplexity> getComplexity_JsonNullable() {
    return complexity;
  }
  
  @JsonProperty(JSON_PROPERTY_COMPLEXITY)
  public void setComplexity_JsonNullable(JsonNullable<DashboardCodeMetricsDetailsComplexity> complexity) {
    this.complexity = complexity;
  }

  public void setComplexity(@jakarta.annotation.Nullable DashboardCodeMetricsDetailsComplexity complexity) {
    this.complexity = JsonNullable.<DashboardCodeMetricsDetailsComplexity>of(complexity);
  }


  public DashboardCodeMetricsDetails codeChurn(@jakarta.annotation.Nullable Integer codeChurn) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CODE_CHURN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CODE_CHURN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCodeChurn(@jakarta.annotation.Nullable Integer codeChurn) {
    this.codeChurn = codeChurn;
  }


  public DashboardCodeMetricsDetails numFindings(@jakarta.annotation.Nullable Integer numFindings) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_FINDINGS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getNumFindings() {
    return numFindings;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_FINDINGS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumFindings(@jakarta.annotation.Nullable Integer numFindings) {
    this.numFindings = numFindings;
  }


  /**
   * Return true if this DashboardCodeMetricsDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardCodeMetricsDetails dashboardCodeMetricsDetails = (DashboardCodeMetricsDetails) o;
    return Objects.equals(this.numTotalLines, dashboardCodeMetricsDetails.numTotalLines) &&
        Objects.equals(this.numCommentLines, dashboardCodeMetricsDetails.numCommentLines) &&
        Objects.equals(this.numSourceFiles, dashboardCodeMetricsDetails.numSourceFiles) &&
        equalsNullable(this.complexity, dashboardCodeMetricsDetails.complexity) &&
        Objects.equals(this.codeChurn, dashboardCodeMetricsDetails.codeChurn) &&
        Objects.equals(this.numFindings, dashboardCodeMetricsDetails.numFindings);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(numTotalLines, numCommentLines, numSourceFiles, hashCodeNullable(complexity), codeChurn, numFindings);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardCodeMetricsDetails {\n");
    sb.append("    numTotalLines: ").append(toIndentedString(numTotalLines)).append("\n");
    sb.append("    numCommentLines: ").append(toIndentedString(numCommentLines)).append("\n");
    sb.append("    numSourceFiles: ").append(toIndentedString(numSourceFiles)).append("\n");
    sb.append("    complexity: ").append(toIndentedString(complexity)).append("\n");
    sb.append("    codeChurn: ").append(toIndentedString(codeChurn)).append("\n");
    sb.append("    numFindings: ").append(toIndentedString(numFindings)).append("\n");
    sb.append("}");
    return sb.toString();
  }
