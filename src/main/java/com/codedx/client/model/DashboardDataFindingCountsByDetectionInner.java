...
import com.codedx.client.model.DashboardFindingCountsByDetectionMethod;
...
/**
 * DashboardDataFindingCountsByDetectionInner
 */
@JsonPropertyOrder({
  DashboardDataFindingCountsByDetectionInner.JSON_PROPERTY_DATE,
  DashboardDataFindingCountsByDetectionInner.JSON_PROPERTY_DATA
})
@JsonTypeName("DashboardData_findingCountsByDetection_inner")
...
public class DashboardDataFindingCountsByDetectionInner {
  ...
  @jakarta.annotation.Nullable
  private List<DashboardFindingCountsByDetectionMethod> data = new ArrayList<>();

  public DashboardDataFindingCountsByDetectionInner() { 
  }

  public DashboardDataFindingCountsByDetectionInner date(@jakarta.annotation.Nullable OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public DashboardDataFindingCountsByDetectionInner data(@jakarta.annotation.Nullable List<DashboardFindingCountsByDetectionMethod> data) {
    this.data = data;
    return this;
  }

  public DashboardDataFindingCountsByDetectionInner addDataItem(DashboardFindingCountsByDetectionMethod dataItem) {
    if (this.data == null) {
  ...
  public List<DashboardFindingCountsByDetectionMethod> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable List<DashboardFindingCountsByDetectionMethod> data) {
    this.data = data;
  }


  /**
   * Return true if this DashboardData_findingCountsByDetection_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardDataFindingCountsByDetectionInner dashboardDataFindingCountsByDetectionInner = (DashboardDataFindingCountsByDetectionInner) o;
    return Objects.equals(this.date, dashboardDataFindingCountsByDetectionInner.date) &&
        Objects.equals(this.data, dashboardDataFindingCountsByDetectionInner.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardDataFindingCountsByDetectionInner {\n");
