 ...
 */
@JsonPropertyOrder({
  DetectionMethod.JSON_PROPERTY_ID,
  DetectionMethod.JSON_PROPERTY_NAME,
  DetectionMethod.JSON_PROPERTY_READ_ONLY
})
...
public class DetectionMethod {
  ...
  public DetectionMethod id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DetectionMethod name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public DetectionMethod readOnly(@jakarta.annotation.Nullable Boolean readOnly) {
  ...
  /**
   * Return true if this DetectionMethod object is equal to o.
   */
  @Override
