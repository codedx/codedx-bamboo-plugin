 ...
 */
@JsonPropertyOrder({
  RuleGroup.JSON_PROPERTY_ID,
  RuleGroup.JSON_PROPERTY_NAME
})
...
public class RuleGroup {
  ...
  public RuleGroup id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RuleGroup name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Return true if this RuleGroup object is equal to o.
   */
  @Override
