...
@JsonPropertyOrder({
  ...
  Branch.JSON_PROPERTY_PROJECT_ID,
  Branch.JSON_PROPERTY_IS_DEFAULT
})
...
public class Branch {
  ...
  public Branch id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Branch name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Branch projectId(@jakarta.annotation.Nullable Integer projectId) {
  ...
  public Branch isDefault(@jakarta.annotation.Nullable Boolean isDefault) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, branch.id) &&
        ...
        Objects.equals(this.projectId, branch.projectId) &&
        Objects.equals(this.isDefault, branch.isDefault);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, projectId, isDefault);
  }
