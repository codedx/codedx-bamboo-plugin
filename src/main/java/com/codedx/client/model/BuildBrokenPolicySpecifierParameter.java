...
@JsonDeserialize(using = BuildBrokenPolicySpecifierParameter.BuildBrokenPolicySpecifierParameterDeserializer.class)
@JsonSerialize(using = BuildBrokenPolicySpecifierParameter.BuildBrokenPolicySpecifierParameterSerializer.class)
public class BuildBrokenPolicySpecifierParameter extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BuildBrokenPolicySpecifierParameter.class.getName());

    public static class BuildBrokenPolicySpecifierParameterSerializer extends StdSerializer<BuildBrokenPolicySpecifierParameter> {
        public BuildBrokenPolicySpecifierParameterSerializer(Class<BuildBrokenPolicySpecifierParameter> t) {
            super(t);
        }

        public BuildBrokenPolicySpecifierParameterSerializer() {
            this(null);
        }

        @Override
        public void serialize(BuildBrokenPolicySpecifierParameter value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class BuildBrokenPolicySpecifierParameterDeserializer extends StdDeserializer<BuildBrokenPolicySpecifierParameter> {
        public BuildBrokenPolicySpecifierParameterDeserializer() {
            this(BuildBrokenPolicySpecifierParameter.class);
        }

        public BuildBrokenPolicySpecifierParameterDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public BuildBrokenPolicySpecifierParameter deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                BuildBrokenPolicySpecifierParameter ret = new BuildBrokenPolicySpecifierParameter();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for BuildBrokenPolicySpecifierParameter: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public BuildBrokenPolicySpecifierParameter getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "BuildBrokenPolicySpecifierParameter cannot be null");
        }
    }
    ...
    public BuildBrokenPolicySpecifierParameter() {
        super("oneOf", Boolean.FALSE);
    }

    public BuildBrokenPolicySpecifierParameter(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BuildBrokenPolicySpecifierParameter(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(BuildBrokenPolicySpecifierParameter.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return BuildBrokenPolicySpecifierParameter.schemas;
    }
