...
@JsonPropertyOrder({
  ...
  Policy.JSON_PROPERTY_PROJECT_IDS
})
...
public class Policy {
  ...
  public Policy name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public Policy description(@jakarta.annotation.Nonnull String description) {
  ...
  public Policy rules(@jakarta.annotation.Nonnull List<PolicySavedFilterRule> rules) {
    this.rules = rules;
    return this;
  }

  public Policy addRulesItem(PolicySavedFilterRule rulesItem) {
    if (this.rules == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RULES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRules(@jakarta.annotation.Nonnull List<PolicySavedFilterRule> rules) {
    this.rules = rules;
  }


  public Policy projectIds(@jakarta.annotation.Nullable List<Integer> projectIds) {
    this.projectIds = projectIds;
    return this;
  }

  public Policy addProjectIdsItem(Integer projectIdsItem) {
  ...
  /**
   * An array of associated projects, denoted by id
   * @return projectIds
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, policy.name) &&
        ...
        Objects.equals(this.projectIds, policy.projectIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, rules, projectIds);
  }
