...
import com.codedx.client.model.CreateReportTemplateRequestFormValues;
 ...
 */
@JsonPropertyOrder({
  CreateReportTemplateRequest.JSON_PROPERTY_NAME,
  CreateReportTemplateRequest.JSON_PROPERTY_DESCRIPTION,
  CreateReportTemplateRequest.JSON_PROPERTY_FILTER_ID,
  CreateReportTemplateRequest.JSON_PROPERTY_REPORT_TYPE,
  CreateReportTemplateRequest.JSON_PROPERTY_SCHEDULE,
  CreateReportTemplateRequest.JSON_PROPERTY_RECIPIENTS,
  CreateReportTemplateRequest.JSON_PROPERTY_PROJECT_IDS,
  CreateReportTemplateRequest.JSON_PROPERTY_FORM_VALUES
})
@JsonTypeName("createReportTemplate_request")
...
public class CreateReportTemplateRequest {
  ...
  @jakarta.annotation.Nullable
  private CreateReportTemplateRequestFormValues formValues;

  public CreateReportTemplateRequest() { 
  }

  public CreateReportTemplateRequest name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateReportTemplateRequest description(@jakarta.annotation.Nullable String description) {
  ...
  public CreateReportTemplateRequest filterId(@jakarta.annotation.Nullable Integer filterId) {
    this.filterId = filterId;
    return this;
  }

  /**
   * An optional ID corresponding to a Saved Filter
   * @return filterId
   */
  @jakarta.annotation.Nullable
  ...
  @JsonProperty(value = JSON_PROPERTY_FILTER_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilterId(@jakarta.annotation.Nullable Integer filterId) {
    this.filterId = filterId;
  }


  public CreateReportTemplateRequest reportType(@jakarta.annotation.Nullable ReportTypeEnum reportType) {
  ...
  public CreateReportTemplateRequest schedule(@jakarta.annotation.Nullable Map<String, Object> schedule) {
    this.schedule = schedule;
    return this;
  }

  public CreateReportTemplateRequest putScheduleItem(String key, Object scheduleItem) {
  ...
  public CreateReportTemplateRequest recipients(@jakarta.annotation.Nullable List<String> recipients) {
    this.recipients = recipients;
    return this;
  }

  public CreateReportTemplateRequest addRecipientsItem(String recipientsItem) {
  ...
  public CreateReportTemplateRequest projectIds(@jakarta.annotation.Nullable List<Integer> projectIds) {
    this.projectIds = projectIds;
    return this;
  }

  public CreateReportTemplateRequest addProjectIdsItem(Integer projectIdsItem) {
  ...
  public CreateReportTemplateRequest formValues(@jakarta.annotation.Nullable CreateReportTemplateRequestFormValues formValues) {
  ...
  public CreateReportTemplateRequestFormValues getFormValues() {
    return formValues;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FORM_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFormValues(@jakarta.annotation.Nullable CreateReportTemplateRequestFormValues formValues) {
    this.formValues = formValues;
  }


  /**
   * Return true if this createReportTemplate_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateReportTemplateRequest createReportTemplateRequest = (CreateReportTemplateRequest) o;
    return Objects.equals(this.name, createReportTemplateRequest.name) &&
        Objects.equals(this.description, createReportTemplateRequest.description) &&
        Objects.equals(this.filterId, createReportTemplateRequest.filterId) &&
        Objects.equals(this.reportType, createReportTemplateRequest.reportType) &&
        Objects.equals(this.schedule, createReportTemplateRequest.schedule) &&
        Objects.equals(this.recipients, createReportTemplateRequest.recipients) &&
        Objects.equals(this.projectIds, createReportTemplateRequest.projectIds) &&
        Objects.equals(this.formValues, createReportTemplateRequest.formValues);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, filterId, reportType, schedule, recipients, projectIds, formValues);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateReportTemplateRequest {\n");
