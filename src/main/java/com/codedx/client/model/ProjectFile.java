 ...
 */
@JsonPropertyOrder({
  ProjectFile.JSON_PROPERTY_ID,
  ProjectFile.JSON_PROPERTY_PATH,
  ProjectFile.JSON_PROPERTY_PATH_TYPE
})
...
public class ProjectFile {
  ...
  public ProjectFile id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ProjectFile path(@jakarta.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public ProjectFile pathType(@jakarta.annotation.Nullable String pathType) {
  ...
  /**
   * Return true if this ProjectFile object is equal to o.
   */
  @Override
