...
/**
 * A width ratio for the field, expressed as &#x60;myNumColumns / columnsPerRow&#x60;
 */
@JsonPropertyOrder({
  InputFieldWidthRatio.JSON_PROPERTY_COLUMNS_PER_ROW,
  InputFieldWidthRatio.JSON_PROPERTY_MY_NUM_COLUMNS
})
@JsonTypeName("InputField_widthRatio")
...
public class InputFieldWidthRatio {
  public static final String JSON_PROPERTY_COLUMNS_PER_ROW = "columnsPerRow";
  @jakarta.annotation.Nonnull
  private BigDecimal columnsPerRow;

  public static final String JSON_PROPERTY_MY_NUM_COLUMNS = "myNumColumns";
  @jakarta.annotation.Nonnull
  private BigDecimal myNumColumns;

  public InputFieldWidthRatio() { 
  }

  public InputFieldWidthRatio columnsPerRow(@jakarta.annotation.Nonnull BigDecimal columnsPerRow) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_COLUMNS_PER_ROW, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public BigDecimal getColumnsPerRow() {
    return columnsPerRow;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_COLUMNS_PER_ROW, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setColumnsPerRow(@jakarta.annotation.Nonnull BigDecimal columnsPerRow) {
    this.columnsPerRow = columnsPerRow;
  }


  public InputFieldWidthRatio myNumColumns(@jakarta.annotation.Nonnull BigDecimal myNumColumns) {
    this.myNumColumns = myNumColumns;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_MY_NUM_COLUMNS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public BigDecimal getMyNumColumns() {
    return myNumColumns;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_MY_NUM_COLUMNS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMyNumColumns(@jakarta.annotation.Nonnull BigDecimal myNumColumns) {
    this.myNumColumns = myNumColumns;
  }


  /**
   * Return true if this InputField_widthRatio object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InputFieldWidthRatio inputFieldWidthRatio = (InputFieldWidthRatio) o;
    return Objects.equals(this.columnsPerRow, inputFieldWidthRatio.columnsPerRow) &&
        Objects.equals(this.myNumColumns, inputFieldWidthRatio.myNumColumns);
  }

  @Override
  public int hashCode() {
    return Objects.hash(columnsPerRow, myNumColumns);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InputFieldWidthRatio {\n");
    sb.append("    columnsPerRow: ").append(toIndentedString(columnsPerRow)).append("\n");
    sb.append("    myNumColumns: ").append(toIndentedString(myNumColumns)).append("\n");
    sb.append("}");
    return sb.toString();
  }
