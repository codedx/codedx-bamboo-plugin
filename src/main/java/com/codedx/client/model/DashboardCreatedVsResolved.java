...
/**
 * DashboardCreatedVsResolved
 */
@JsonPropertyOrder({
  DashboardCreatedVsResolved.JSON_PROPERTY_NUM_CREATED,
  DashboardCreatedVsResolved.JSON_PROPERTY_NUM_RESOLVED
})
...
public class DashboardCreatedVsResolved {
  public static final String JSON_PROPERTY_NUM_CREATED = "numCreated";
  @jakarta.annotation.Nullable
  private Integer numCreated;

  public static final String JSON_PROPERTY_NUM_RESOLVED = "numResolved";
  @jakarta.annotation.Nullable
  private Integer numResolved;

  public DashboardCreatedVsResolved() { 
  }

  public DashboardCreatedVsResolved numCreated(@jakarta.annotation.Nullable Integer numCreated) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_CREATED, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_CREATED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumCreated(@jakarta.annotation.Nullable Integer numCreated) {
    this.numCreated = numCreated;
  }


  public DashboardCreatedVsResolved numResolved(@jakarta.annotation.Nullable Integer numResolved) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_RESOLVED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_RESOLVED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumResolved(@jakarta.annotation.Nullable Integer numResolved) {
    this.numResolved = numResolved;
  }


  /**
   * Return true if this DashboardCreatedVsResolved object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardCreatedVsResolved dashboardCreatedVsResolved = (DashboardCreatedVsResolved) o;
    return Objects.equals(this.numCreated, dashboardCreatedVsResolved.numCreated) &&
        Objects.equals(this.numResolved, dashboardCreatedVsResolved.numResolved);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numCreated, numResolved);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardCreatedVsResolved {\n");
    sb.append("    numCreated: ").append(toIndentedString(numCreated)).append("\n");
    sb.append("    numResolved: ").append(toIndentedString(numResolved)).append("\n");
    sb.append("}");
    return sb.toString();
  }
