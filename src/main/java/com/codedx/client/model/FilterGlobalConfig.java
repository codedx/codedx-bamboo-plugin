 ...
 */
@JsonPropertyOrder({
  FilterGlobalConfig.JSON_PROPERTY_IGNORE_ARCHIVED
})
@JsonTypeName("Filter_globalConfig")
...
public class FilterGlobalConfig {
  public static final String JSON_PROPERTY_IGNORE_ARCHIVED = "ignoreArchived";
  @jakarta.annotation.Nullable
  private Boolean ignoreArchived = true;

  public FilterGlobalConfig() { 
  }

  public FilterGlobalConfig ignoreArchived(@jakarta.annotation.Nullable Boolean ignoreArchived) {
    this.ignoreArchived = ignoreArchived;
    return this;
  }

  /**
   * Flag indicating whether finding-loading operations using this filter should omit inactive Results. If you are trying to load findings that are marked as Gone, you may want to set this flag to &#x60;false&#x60;
   * @return ignoreArchived
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IGNORE_ARCHIVED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getIgnoreArchived() {
    return ignoreArchived;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_IGNORE_ARCHIVED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIgnoreArchived(@jakarta.annotation.Nullable Boolean ignoreArchived) {
    this.ignoreArchived = ignoreArchived;
  }


  /**
   * Return true if this Filter_globalConfig object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FilterGlobalConfig filterGlobalConfig = (FilterGlobalConfig) o;
    return Objects.equals(this.ignoreArchived, filterGlobalConfig.ignoreArchived);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ignoreArchived);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FilterGlobalConfig {\n");
    sb.append("    ignoreArchived: ").append(toIndentedString(ignoreArchived)).append("\n");
    sb.append("}");
    return sb.toString();
  }
