 ...
 */
@JsonPropertyOrder({
  MappingsRequest.JSON_PROPERTY_FILES
})
...
public class MappingsRequest {
  ...
  public MappingsRequest files(@jakarta.annotation.Nullable List<String> files) {
    this.files = files;
    return this;
  }
  ...
  /**
   * Return true if this MappingsRequest object is equal to o.
   */
  @Override
