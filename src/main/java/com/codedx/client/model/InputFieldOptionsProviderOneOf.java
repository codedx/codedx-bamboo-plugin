...
/**
 * Indicates a &#39;static&#39; options provider, where all options are known ahead of time
 */
@JsonPropertyOrder({
  InputFieldOptionsProviderOneOf.JSON_PROPERTY_TYPE,
  InputFieldOptionsProviderOneOf.JSON_PROPERTY_OPTIONS
})
@JsonTypeName("InputField_optionsProvider_oneOf")
...
public class InputFieldOptionsProviderOneOf {
  /**
   * Gets or Sets type
   */
  ...
  public InputFieldOptionsProviderOneOf() { 
  }

  public InputFieldOptionsProviderOneOf type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public InputFieldOptionsProviderOneOf options(@jakarta.annotation.Nonnull List<DropdownOption> options) {
    this.options = options;
    return this;
  }

  public InputFieldOptionsProviderOneOf addOptionsItem(DropdownOption optionsItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPTIONS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOptions(@jakarta.annotation.Nonnull List<DropdownOption> options) {
    this.options = options;
  }


  /**
   * Return true if this InputField_optionsProvider_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InputFieldOptionsProviderOneOf inputFieldOptionsProviderOneOf = (InputFieldOptionsProviderOneOf) o;
    return Objects.equals(this.type, inputFieldOptionsProviderOneOf.type) &&
        Objects.equals(this.options, inputFieldOptionsProviderOneOf.options);
  }
  ...
  public String toString() {
    ...
    sb.append("class InputFieldOptionsProviderOneOf {\n");
