 ...
 */
@JsonPropertyOrder({
  FixedUpdateSetting.JSON_PROPERTY_TYPE,
  FixedUpdateSetting.JSON_PROPERTY_NUM_HOURS,
  FixedUpdateSetting.JSON_PROPERTY_NUM_MINUTES
})
...
public class FixedUpdateSetting {
  ...
  public FixedUpdateSetting() { 
  }

  public FixedUpdateSetting type(@jakarta.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public FixedUpdateSetting numHours(@jakarta.annotation.Nullable Integer numHours) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_HOURS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_HOURS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumHours(@jakarta.annotation.Nullable Integer numHours) {
    this.numHours = numHours;
  }


  public FixedUpdateSetting numMinutes(@jakarta.annotation.Nullable Integer numMinutes) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_MINUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_MINUTES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumMinutes(@jakarta.annotation.Nullable Integer numMinutes) {
    this.numMinutes = numMinutes;
  }


  /**
   * Return true if this FixedUpdateSetting object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FixedUpdateSetting fixedUpdateSetting = (FixedUpdateSetting) o;
    return Objects.equals(this.type, fixedUpdateSetting.type) &&
        Objects.equals(this.numHours, fixedUpdateSetting.numHours) &&
        Objects.equals(this.numMinutes, fixedUpdateSetting.numMinutes);
  }
  ...
  public String toString() {
    ...
    sb.append("class FixedUpdateSetting {\n");
