...
/**
 * BulkSetDefaultScheduleRequest
 */
@JsonPropertyOrder({
  BulkSetDefaultScheduleRequest.JSON_PROPERTY_PROJECT_DEFAULT_SCOPES,
  BulkSetDefaultScheduleRequest.JSON_PROPERTY_SCHEDULE_ID
})
@JsonTypeName("bulkSetDefaultSchedule_request")
...
public class BulkSetDefaultScheduleRequest {
  public static final String JSON_PROPERTY_PROJECT_DEFAULT_SCOPES = "projectDefaultScopes";
  @jakarta.annotation.Nullable
  private List<BulkSetDefaultScheduleRequestProjectDefaultScopesInner> projectDefaultScopes = new ArrayList<>();

  public static final String JSON_PROPERTY_SCHEDULE_ID = "scheduleId";
  @jakarta.annotation.Nullable
  private Integer scheduleId;

  public BulkSetDefaultScheduleRequest() { 
  }

  public BulkSetDefaultScheduleRequest projectDefaultScopes(@jakarta.annotation.Nullable List<BulkSetDefaultScheduleRequestProjectDefaultScopesInner> projectDefaultScopes) {
    this.projectDefaultScopes = projectDefaultScopes;
    return this;
  }

  public BulkSetDefaultScheduleRequest addProjectDefaultScopesItem(BulkSetDefaultScheduleRequestProjectDefaultScopesInner projectDefaultScopesItem) {
    if (this.projectDefaultScopes == null) {
      this.projectDefaultScopes = new ArrayList<>();
    }
    this.projectDefaultScopes.add(projectDefaultScopesItem);
    return this;
  }

  /**
   * Get projectDefaultScopes
   * @return projectDefaultScopes
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PROJECT_DEFAULT_SCOPES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<BulkSetDefaultScheduleRequestProjectDefaultScopesInner> getProjectDefaultScopes() {
    return projectDefaultScopes;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT_DEFAULT_SCOPES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjectDefaultScopes(@jakarta.annotation.Nullable List<BulkSetDefaultScheduleRequestProjectDefaultScopesInner> projectDefaultScopes) {
    this.projectDefaultScopes = projectDefaultScopes;
  }


  public BulkSetDefaultScheduleRequest scheduleId(@jakarta.annotation.Nullable Integer scheduleId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SCHEDULE_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setScheduleId(@jakarta.annotation.Nullable Integer scheduleId) {
    this.scheduleId = scheduleId;
  }


  /**
   * Return true if this bulkSetDefaultSchedule_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BulkSetDefaultScheduleRequest bulkSetDefaultScheduleRequest = (BulkSetDefaultScheduleRequest) o;
    return Objects.equals(this.projectDefaultScopes, bulkSetDefaultScheduleRequest.projectDefaultScopes) &&
        Objects.equals(this.scheduleId, bulkSetDefaultScheduleRequest.scheduleId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectDefaultScopes, scheduleId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BulkSetDefaultScheduleRequest {\n");
    sb.append("    projectDefaultScopes: ").append(toIndentedString(projectDefaultScopes)).append("\n");
