 ...
 */
@JsonPropertyOrder({
  UpdateProject.JSON_PROPERTY_NAME,
  UpdateProject.JSON_PROPERTY_PARENT_ID
})
...
public class UpdateProject {
  ...
  public UpdateProject name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateProject parentId(@jakarta.annotation.Nullable Integer parentId) {
  ...
  /**
   * Return true if this UpdateProject object is equal to o.
   */
  @Override
