...
/**
 * GetProjectNameSyncSupport200Response
 */
@JsonPropertyOrder({
  GetProjectNameSyncSupport200Response.JSON_PROPERTY_SUPPORTED,
  GetProjectNameSyncSupport200Response.JSON_PROPERTY_CONDITIONAL
})
@JsonTypeName("getProjectNameSyncSupport_200_response")
...
public class GetProjectNameSyncSupport200Response {
  ...
  public GetProjectNameSyncSupport200Response() { 
  }

  public GetProjectNameSyncSupport200Response supported(@jakarta.annotation.Nullable Boolean supported) {
    this.supported = supported;
    return this;
  }

  /**
   * Whether project name sync is supported. Will be omitted if &#x60;conditional&#x60; is true and the request body was empty
   * @return supported
   */
  @jakarta.annotation.Nullable
  ...
  public GetProjectNameSyncSupport200Response conditional(@jakarta.annotation.Nullable Boolean conditional) {
  ...
  /**
   * Return true if this getProjectNameSyncSupport_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetProjectNameSyncSupport200Response getProjectNameSyncSupport200Response = (GetProjectNameSyncSupport200Response) o;
    return Objects.equals(this.supported, getProjectNameSyncSupport200Response.supported) &&
        Objects.equals(this.conditional, getProjectNameSyncSupport200Response.conditional);
  }

  @Override
  public int hashCode() {
    return Objects.hash(supported, conditional);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetProjectNameSyncSupport200Response {\n");
