 ...
 */
@JsonPropertyOrder({
  SimpleUser.JSON_PROPERTY_ID,
  SimpleUser.JSON_PROPERTY_NAME
})
...
public class SimpleUser {
  ...
  public SimpleUser id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public SimpleUser name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Return true if this SimpleUser object is equal to o.
   */
  @Override
