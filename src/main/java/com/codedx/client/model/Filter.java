...
import java.util.Map;
import java.util.HashMap;
import com.codedx.client.model.FilterGlobalConfig;
...
/**
 * Filter objects represent criteria used when querying Finding data. A filter object is composed of any number of &#39;criteria&#39; fields (described under the &#x60;&lt; * &gt;&#x60; section below), plus a few optional configuration fields. Each given criteria field represents a condition which must be met by a Finding for that Finding to be considered a match.  That condition is generally represented as an array of values, one of which must be matched by the finding. Most criteria fields allow a shorthand form, where if you have only one criterion, you may provide its value without wrapping it as an array. For example, &#x60;{ \&quot;severity\&quot;: \&quot;Critical\&quot; }&#x60; is equivalent to &#x60;{ \&quot;severity\&quot;: [\&quot;Critical\&quot;] }&#x60;  Separate criteria fields are ANDed together. Values within a criteria field are ORed together. For example, &#x60;{ \&quot;severity\&quot;: [\&quot;High\&quot;, \&quot;Critical\&quot;] }&#x60; represents a filter that matches High OR Critical-severity findings, whereas, &#x60;{ \&quot;severity\&quot;: [\&quot;Critical\&quot;], \&quot;findingStatus\&quot;: [\&quot;new\&quot;] }&#x60; represents a filter that matches findings that are Critical-severity AND have a &#39;New&#39; finding status.  Each given &#x60;&lt;field&gt;&#x60; criteria field (e.g. &#x60;severity&#x60;) can be specified in several ways:  - &#x60;\&quot;&lt;field&gt;\&quot;: [...criteria]&#x60; represents normal filter criteria for that field, e.g. &#x60;\&quot;severity\&quot;: [\&quot;High\&quot;, \&quot;Critical\&quot;]&#x60;  - &#x60;\&quot;&lt;field&gt;:&lt;namespace&gt;\&quot;: [...criteria]&#x60; also represents normal filter criteria for that field, but the extra &#x60;&lt;namespace&gt;&#x60; allows you to AND together multiple values for that field instead of the usual OR, e.g. &#x60;{ \&quot;path:search\&quot;: \&quot;src/_*\&quot;, \&quot;path:filter\&quot;: \&quot;*_/module1/_*\&quot; }&#x60; is a filter like \&quot;path is under the &#x60;src/&#x60; directory AND is in a &#x60;module1&#x60; folder.\&quot;  - &#x60;~&lt;field&gt;&#x60; represents a NOT (inversion) of the field. E.g. &#x60;{ \&quot;~severity\&quot;: [\&quot;Critical\&quot;] }&#x60; is a filter for all findings that are not Critical-severity. This also works with namespaces e.g. &#x60;~findingStatus:foo&#x60;
 */
@JsonPropertyOrder({
  Filter.JSON_PROPERTY_GLOBAL_CONFIG,
  Filter.JSON_PROPERTY_SAVED_FILTER_ID
})
...
public class Filter {
  public static final String JSON_PROPERTY_GLOBAL_CONFIG = "globalConfig";
  @jakarta.annotation.Nullable
  private FilterGlobalConfig globalConfig;

  public static final String JSON_PROPERTY_SAVED_FILTER_ID = "savedFilterId";
  @jakarta.annotation.Nullable
  private BigDecimal savedFilterId;

  public Filter() { 
  }

  public Filter globalConfig(@jakarta.annotation.Nullable FilterGlobalConfig globalConfig) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_GLOBAL_CONFIG, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public FilterGlobalConfig getGlobalConfig() {
    return globalConfig;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_GLOBAL_CONFIG, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGlobalConfig(@jakarta.annotation.Nullable FilterGlobalConfig globalConfig) {
    this.globalConfig = globalConfig;
  }


  public Filter savedFilterId(@jakarta.annotation.Nullable BigDecimal savedFilterId) {
    this.savedFilterId = savedFilterId;
    return this;
  }

  /**
   * Indicates the ID of an existing Saved Filter, which may be used in lieu of explicitly providing filter criteria via the additional properties described below.  Note that a saved filter *may* be used in conjunction with regular criteria fields, but proper attention must be given to criteria &#39;namespaces&#39; in order to avoid unexpected results. Selections from the saved filter will be added to the underlying filter object using &#x60;filter&#x60; as the namespace, e.g. &#x60;{ \&quot;severity:filter\&quot;: [...] }&#x60;. If you intend to include an explicit &#x60;severity&#x60; criteria separate from the saved filter, use &#x60;severity:filter&#x60; if you want to OR your criteria with the saved filter, or use &#x60;severity:&lt;some-other-namespace&gt;&#x60; if you want to AND your criteria with the saved filter.
   * @return savedFilterId
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SAVED_FILTER_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public BigDecimal getSavedFilterId() {
    return savedFilterId;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SAVED_FILTER_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSavedFilterId(@jakarta.annotation.Nullable BigDecimal savedFilterId) {
    this.savedFilterId = savedFilterId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.globalConfig, filter.globalConfig) &&
        Objects.equals(this.savedFilterId, filter.savedFilterId)&&
        Objects.equals(this.additionalProperties, filter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(globalConfig, savedFilterId, additionalProperties);
  }
