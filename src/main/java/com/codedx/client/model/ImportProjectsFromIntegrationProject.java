...
import com.codedx.client.model.ImportNewProject;
import com.codedx.client.model.UseExistingProject;
...
@JsonDeserialize(using = ImportProjectsFromIntegrationProject.ImportProjectsFromIntegrationProjectDeserializer.class)
@JsonSerialize(using = ImportProjectsFromIntegrationProject.ImportProjectsFromIntegrationProjectSerializer.class)
public class ImportProjectsFromIntegrationProject extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ImportProjectsFromIntegrationProject.class.getName());

    public static class ImportProjectsFromIntegrationProjectSerializer extends StdSerializer<ImportProjectsFromIntegrationProject> {
        public ImportProjectsFromIntegrationProjectSerializer(Class<ImportProjectsFromIntegrationProject> t) {
            super(t);
        }

        public ImportProjectsFromIntegrationProjectSerializer() {
            this(null);
        }

        @Override
        public void serialize(ImportProjectsFromIntegrationProject value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ImportProjectsFromIntegrationProjectDeserializer extends StdDeserializer<ImportProjectsFromIntegrationProject> {
        public ImportProjectsFromIntegrationProjectDeserializer() {
            this(ImportProjectsFromIntegrationProject.class);
        }

        public ImportProjectsFromIntegrationProjectDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ImportProjectsFromIntegrationProject deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize ImportNewProject
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(ImportNewProject.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'ImportNewProject'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'ImportNewProject'", e);
            }

            // deserialize UseExistingProject
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(UseExistingProject.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'UseExistingProject'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'UseExistingProject'", e);
            }

            if (match == 1) {
                ImportProjectsFromIntegrationProject ret = new ImportProjectsFromIntegrationProject();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ImportProjectsFromIntegrationProject: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ImportProjectsFromIntegrationProject getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ImportProjectsFromIntegrationProject cannot be null");
        }
    }
    ...
    public ImportProjectsFromIntegrationProject() {
        super("oneOf", Boolean.FALSE);
    }

    public ImportProjectsFromIntegrationProject(ImportNewProject o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ImportProjectsFromIntegrationProject(UseExistingProject o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("ImportNewProject", new GenericType<ImportNewProject>() {
        });
        schemas.put("UseExistingProject", new GenericType<UseExistingProject>() {
        });
        JSON.registerDescendants(ImportProjectsFromIntegrationProject.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return ImportProjectsFromIntegrationProject.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * ImportNewProject, UseExistingProject
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(ImportNewProject.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(UseExistingProject.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be ImportNewProject, UseExistingProject");
    }
     ...
     * ImportNewProject, UseExistingProject
     *
     * @return The actual instance (ImportNewProject, UseExistingProject)
     */
    @Override
    ...
    /**
     * Get the actual instance of `ImportNewProject`. If the actual instance is not `ImportNewProject`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ImportNewProject`
     * @throws ClassCastException if the instance is not `ImportNewProject`
     */
    public ImportNewProject getImportNewProject() throws ClassCastException {
        return (ImportNewProject)super.getActualInstance();
    }

    /**
     * Get the actual instance of `UseExistingProject`. If the actual instance is not `UseExistingProject`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `UseExistingProject`
     * @throws ClassCastException if the instance is not `UseExistingProject`
     */
    public UseExistingProject getUseExistingProject() throws ClassCastException {
        return (UseExistingProject)super.getActualInstance();
    }
