...
import com.codedx.client.model.DashboardCodeMetricsDetails;
...
/**
 * DashboardDataCodeMetricsInner
 */
@JsonPropertyOrder({
  DashboardDataCodeMetricsInner.JSON_PROPERTY_DATE,
  DashboardDataCodeMetricsInner.JSON_PROPERTY_DATA
})
@JsonTypeName("DashboardData_codeMetrics_inner")
...
public class DashboardDataCodeMetricsInner {
  ...
  @jakarta.annotation.Nullable
  private Map<String, DashboardCodeMetricsDetails> data = new HashMap<>();

  public DashboardDataCodeMetricsInner() { 
  }

  public DashboardDataCodeMetricsInner date(@jakarta.annotation.Nullable OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public DashboardDataCodeMetricsInner data(@jakarta.annotation.Nullable Map<String, DashboardCodeMetricsDetails> data) {
    this.data = data;
    return this;
  }

  public DashboardDataCodeMetricsInner putDataItem(String key, DashboardCodeMetricsDetails dataItem) {
    if (this.data == null) {
  ...
  public Map<String, DashboardCodeMetricsDetails> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable Map<String, DashboardCodeMetricsDetails> data) {
    this.data = data;
  }


  /**
   * Return true if this DashboardData_codeMetrics_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardDataCodeMetricsInner dashboardDataCodeMetricsInner = (DashboardDataCodeMetricsInner) o;
    return Objects.equals(this.date, dashboardDataCodeMetricsInner.date) &&
        Objects.equals(this.data, dashboardDataCodeMetricsInner.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardDataCodeMetricsInner {\n");
