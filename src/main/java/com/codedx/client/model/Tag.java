 ...
 */
@JsonPropertyOrder({
  Tag.JSON_PROPERTY_SCOPE,
  Tag.JSON_PROPERTY_NAME,
  Tag.JSON_PROPERTY_COUNT
})
...
public class Tag {
  /**
   * The tag scope to which the tag belongs
   */
  ...
  public Tag scope(@jakarta.annotation.Nullable ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
  ...
  public Tag count(@jakarta.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }

  /**
   * The number of entities associated with the tag
   * @return count
   */
  @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(scope, name, count);
  }
