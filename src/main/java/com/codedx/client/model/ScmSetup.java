 ...
 */
@JsonPropertyOrder({
  ScmSetup.JSON_PROPERTY_SCM_INFO,
  ScmSetup.JSON_PROPERTY_INPUT_ID,
  ScmSetup.JSON_PROPERTY_SETUP_JOB_ID
})
...
public class ScmSetup {
  ...
  public static final String JSON_PROPERTY_SETUP_JOB_ID = "setupJobId";
  @jakarta.annotation.Nullable
  private String setupJobId;

  public ScmSetup() { 
  }

  public ScmSetup scmInfo(@jakarta.annotation.Nullable ScmInfo scmInfo) {
  ...
  public ScmSetup inputId(@jakarta.annotation.Nullable String inputId) {
  ...
  public ScmSetup setupJobId(@jakarta.annotation.Nullable String setupJobId) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SETUP_JOB_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_SETUP_JOB_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSetupJobId(@jakarta.annotation.Nullable String setupJobId) {
    this.setupJobId = setupJobId;
  }


  /**
   * Return true if this ScmSetup object is equal to o.
   */
  @Override
