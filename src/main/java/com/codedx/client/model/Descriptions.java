 ...
 */
@JsonPropertyOrder({
  Descriptions.JSON_PROPERTY_GENERAL,
  Descriptions.JSON_PROPERTY_CONTEXTUAL
})
...
public class Descriptions {
  ...
  public static final String JSON_PROPERTY_CONTEXTUAL = "contextual";
  @jakarta.annotation.Nullable
  private Description contextual;

  public Descriptions() { 
  }

  public Descriptions general(@jakarta.annotation.Nullable Description general) {
  ...
  @JsonProperty(value = JSON_PROPERTY_GENERAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGeneral(@jakarta.annotation.Nullable Description general) {
    this.general = general;
  }


  public Descriptions contextual(@jakarta.annotation.Nullable Description contextual) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONTEXTUAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONTEXTUAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setContextual(@jakarta.annotation.Nullable Description contextual) {
    this.contextual = contextual;
  }
