 ...
 */
@JsonPropertyOrder({
  IncompleteWork.JSON_PROPERTY_JOB_ID,
  IncompleteWork.JSON_PROPERTY_TYPE,
  IncompleteWork.JSON_PROPERTY_ANALYSIS,
  IncompleteWork.JSON_PROPERTY_CREATION_TIME,
  IncompleteWork.JSON_PROPERTY_STATUS
})
...
public class IncompleteWork {
  ...
  public IncompleteWork() { 
  }

  public IncompleteWork jobId(@jakarta.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public IncompleteWork type(@jakarta.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public IncompleteWork analysis(@jakarta.annotation.Nullable Integer analysis) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ANALYSIS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAnalysis(@jakarta.annotation.Nullable Integer analysis) {
    this.analysis = analysis;
  }


  public IncompleteWork creationTime(@jakarta.annotation.Nullable String creationTime) {
  ...
  public IncompleteWork status(@jakarta.annotation.Nullable JobStatus status) {
    this.status = status;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_STATUS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatus(@jakarta.annotation.Nullable JobStatus status) {
    this.status = status;
  }


  /**
   * Return true if this IncompleteWork object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IncompleteWork incompleteWork = (IncompleteWork) o;
    return Objects.equals(this.jobId, incompleteWork.jobId) &&
        Objects.equals(this.type, incompleteWork.type) &&
        Objects.equals(this.analysis, incompleteWork.analysis) &&
        Objects.equals(this.creationTime, incompleteWork.creationTime) &&
        Objects.equals(this.status, incompleteWork.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, type, analysis, creationTime, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IncompleteWork {\n");
