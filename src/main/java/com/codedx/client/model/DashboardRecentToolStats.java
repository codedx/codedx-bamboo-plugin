...
/**
 * DashboardRecentToolStats
 */
@JsonPropertyOrder({
  DashboardRecentToolStats.JSON_PROPERTY_PAST1_WEEK_COUNT,
  DashboardRecentToolStats.JSON_PROPERTY_PAST4_WEEK_COUNT,
  DashboardRecentToolStats.JSON_PROPERTY_PAST3_MONTH_COUNT
})
...
public class DashboardRecentToolStats {
  ...
  public DashboardRecentToolStats() { 
  }

  public DashboardRecentToolStats past1WeekCount(@jakarta.annotation.Nullable Integer past1WeekCount) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PAST1_WEEK_COUNT, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_PAST1_WEEK_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPast1WeekCount(@jakarta.annotation.Nullable Integer past1WeekCount) {
    this.past1WeekCount = past1WeekCount;
  }


  public DashboardRecentToolStats past4WeekCount(@jakarta.annotation.Nullable Integer past4WeekCount) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PAST4_WEEK_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PAST4_WEEK_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPast4WeekCount(@jakarta.annotation.Nullable Integer past4WeekCount) {
    this.past4WeekCount = past4WeekCount;
  }


  public DashboardRecentToolStats past3MonthCount(@jakarta.annotation.Nullable Integer past3MonthCount) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PAST3_MONTH_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PAST3_MONTH_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPast3MonthCount(@jakarta.annotation.Nullable Integer past3MonthCount) {
    this.past3MonthCount = past3MonthCount;
  }


  /**
   * Return true if this DashboardRecentToolStats object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardRecentToolStats dashboardRecentToolStats = (DashboardRecentToolStats) o;
    return Objects.equals(this.past1WeekCount, dashboardRecentToolStats.past1WeekCount) &&
        Objects.equals(this.past4WeekCount, dashboardRecentToolStats.past4WeekCount) &&
        Objects.equals(this.past3MonthCount, dashboardRecentToolStats.past3MonthCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(past1WeekCount, past4WeekCount, past3MonthCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardRecentToolStats {\n");
