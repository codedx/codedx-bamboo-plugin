...
/**
 * DashboardFindingCountsByDetectionMethod
 */
@JsonPropertyOrder({
  DashboardFindingCountsByDetectionMethod.JSON_PROPERTY_FINDING_COUNT,
  DashboardFindingCountsByDetectionMethod.JSON_PROPERTY_DETECTION_METHOD_ID,
  DashboardFindingCountsByDetectionMethod.JSON_PROPERTY_DETECTION_METHOD_NAME
})
...
public class DashboardFindingCountsByDetectionMethod {
  public static final String JSON_PROPERTY_FINDING_COUNT = "findingCount";
  @jakarta.annotation.Nullable
  private Integer findingCount;

  public static final String JSON_PROPERTY_DETECTION_METHOD_ID = "detectionMethodId";
  @jakarta.annotation.Nullable
  private Integer detectionMethodId;

  public static final String JSON_PROPERTY_DETECTION_METHOD_NAME = "detectionMethodName";
  @jakarta.annotation.Nullable
  private String detectionMethodName;

  public DashboardFindingCountsByDetectionMethod() { 
  }

  public DashboardFindingCountsByDetectionMethod findingCount(@jakarta.annotation.Nullable Integer findingCount) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FINDING_COUNT, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_FINDING_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFindingCount(@jakarta.annotation.Nullable Integer findingCount) {
    this.findingCount = findingCount;
  }


  public DashboardFindingCountsByDetectionMethod detectionMethodId(@jakarta.annotation.Nullable Integer detectionMethodId) {
    this.detectionMethodId = detectionMethodId;
    return this;
  }

  /**
   * Get detectionMethodId
   * @return detectionMethodId
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_DETECTION_METHOD_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getDetectionMethodId() {
    return detectionMethodId;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DETECTION_METHOD_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetectionMethodId(@jakarta.annotation.Nullable Integer detectionMethodId) {
    this.detectionMethodId = detectionMethodId;
  }


  public DashboardFindingCountsByDetectionMethod detectionMethodName(@jakarta.annotation.Nullable String detectionMethodName) {
    this.detectionMethodName = detectionMethodName;
    return this;
  }

  /**
   * Get detectionMethodName
   * @return detectionMethodName
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_DETECTION_METHOD_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_DETECTION_METHOD_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetectionMethodName(@jakarta.annotation.Nullable String detectionMethodName) {
    this.detectionMethodName = detectionMethodName;
  }


  /**
   * Return true if this DashboardFindingCountsByDetectionMethod object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardFindingCountsByDetectionMethod dashboardFindingCountsByDetectionMethod = (DashboardFindingCountsByDetectionMethod) o;
    return Objects.equals(this.findingCount, dashboardFindingCountsByDetectionMethod.findingCount) &&
        Objects.equals(this.detectionMethodId, dashboardFindingCountsByDetectionMethod.detectionMethodId) &&
        Objects.equals(this.detectionMethodName, dashboardFindingCountsByDetectionMethod.detectionMethodName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(findingCount, detectionMethodId, detectionMethodName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardFindingCountsByDetectionMethod {\n");
    sb.append("    findingCount: ").append(toIndentedString(findingCount)).append("\n");
    sb.append("    detectionMethodId: ").append(toIndentedString(detectionMethodId)).append("\n");
    sb.append("    detectionMethodName: ").append(toIndentedString(detectionMethodName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
