...
/**
 * A statement that the specified field should have the specified value
 */
@JsonPropertyOrder({
  FormStateExpressionOneOf.JSON_PROPERTY_FIELD,
  FormStateExpressionOneOf.JSON_PROPERTY_VALUE
})
@JsonTypeName("FormStateExpression_oneOf")
...
public class FormStateExpressionOneOf {
  ...
  public FormStateExpressionOneOf() { 
  }

  public FormStateExpressionOneOf field(@jakarta.annotation.Nonnull String field) {
    this.field = field;
    return this;
  }
  ...
  public FormStateExpressionOneOf value(@jakarta.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }

  /**
   * An expected value for the given field. The shape of this value depends on the field&#39;s type as specified in the FormSpecifier
   * @return value
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this FormStateExpression_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FormStateExpressionOneOf formStateExpressionOneOf = (FormStateExpressionOneOf) o;
    return Objects.equals(this.field, formStateExpressionOneOf.field) &&
        Objects.equals(this.value, formStateExpressionOneOf.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormStateExpressionOneOf {\n");
