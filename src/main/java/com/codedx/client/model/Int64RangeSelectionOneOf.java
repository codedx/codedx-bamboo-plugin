...
/**
 * Int64RangeSelectionOneOf
 */
@JsonPropertyOrder({
  Int64RangeSelectionOneOf.JSON_PROPERTY_MIN,
  Int64RangeSelectionOneOf.JSON_PROPERTY_MAX
})
@JsonTypeName("Int64RangeSelection_oneOf")
...
public class Int64RangeSelectionOneOf {
  ...
  public Int64RangeSelectionOneOf() { 
  }

  public Int64RangeSelectionOneOf min(@jakarta.annotation.Nullable Long min) {
    this.min = min;
    return this;
  }
  ...
  public Int64RangeSelectionOneOf max(@jakarta.annotation.Nullable Long max) {
    this.max = max;
    return this;
  }
  ...
  /**
   * Return true if this Int64RangeSelection_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    Int64RangeSelectionOneOf int64RangeSelectionOneOf = (Int64RangeSelectionOneOf) o;
    return Objects.equals(this.min, int64RangeSelectionOneOf.min) &&
        Objects.equals(this.max, int64RangeSelectionOneOf.max);
  }
  ...
  public String toString() {
    ...
    sb.append("class Int64RangeSelectionOneOf {\n");
