...
import com.codedx.client.model.ReportTemplateSavedFilterOneOf;
import com.codedx.client.model.ReportTemplateSavedFilterOneOf1;
...
@JsonDeserialize(using = ReportTemplateSavedFilter.ReportTemplateSavedFilterDeserializer.class)
@JsonSerialize(using = ReportTemplateSavedFilter.ReportTemplateSavedFilterSerializer.class)
public class ReportTemplateSavedFilter extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ReportTemplateSavedFilter.class.getName());

    public static class ReportTemplateSavedFilterSerializer extends StdSerializer<ReportTemplateSavedFilter> {
        public ReportTemplateSavedFilterSerializer(Class<ReportTemplateSavedFilter> t) {
            super(t);
        }

        public ReportTemplateSavedFilterSerializer() {
            this(null);
        }

        @Override
        public void serialize(ReportTemplateSavedFilter value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ReportTemplateSavedFilterDeserializer extends StdDeserializer<ReportTemplateSavedFilter> {
        public ReportTemplateSavedFilterDeserializer() {
            this(ReportTemplateSavedFilter.class);
        }

        public ReportTemplateSavedFilterDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ReportTemplateSavedFilter deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize ReportTemplateSavedFilterOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(ReportTemplateSavedFilterOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'ReportTemplateSavedFilterOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'ReportTemplateSavedFilterOneOf'", e);
            }

            // deserialize ReportTemplateSavedFilterOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(ReportTemplateSavedFilterOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'ReportTemplateSavedFilterOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'ReportTemplateSavedFilterOneOf1'", e);
            }

            if (match == 1) {
                ReportTemplateSavedFilter ret = new ReportTemplateSavedFilter();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ReportTemplateSavedFilter: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ReportTemplateSavedFilter getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ReportTemplateSavedFilter cannot be null");
        }
    }
    ...
    public ReportTemplateSavedFilter() {
        super("oneOf", Boolean.FALSE);
    }

    public ReportTemplateSavedFilter(ReportTemplateSavedFilterOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ReportTemplateSavedFilter(ReportTemplateSavedFilterOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("ReportTemplateSavedFilterOneOf", new GenericType<ReportTemplateSavedFilterOneOf>() {
        });
        schemas.put("ReportTemplateSavedFilterOneOf1", new GenericType<ReportTemplateSavedFilterOneOf1>() {
        });
        JSON.registerDescendants(ReportTemplateSavedFilter.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return ReportTemplateSavedFilter.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * ReportTemplateSavedFilterOneOf, ReportTemplateSavedFilterOneOf1
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(ReportTemplateSavedFilterOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(ReportTemplateSavedFilterOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be ReportTemplateSavedFilterOneOf, ReportTemplateSavedFilterOneOf1");
    }
     ...
     * ReportTemplateSavedFilterOneOf, ReportTemplateSavedFilterOneOf1
     *
     * @return The actual instance (ReportTemplateSavedFilterOneOf, ReportTemplateSavedFilterOneOf1)
     */
    @Override
    ...
    /**
     * Get the actual instance of `ReportTemplateSavedFilterOneOf`. If the actual instance is not `ReportTemplateSavedFilterOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ReportTemplateSavedFilterOneOf`
     * @throws ClassCastException if the instance is not `ReportTemplateSavedFilterOneOf`
     */
    public ReportTemplateSavedFilterOneOf getReportTemplateSavedFilterOneOf() throws ClassCastException {
        return (ReportTemplateSavedFilterOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `ReportTemplateSavedFilterOneOf1`. If the actual instance is not `ReportTemplateSavedFilterOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ReportTemplateSavedFilterOneOf1`
     * @throws ClassCastException if the instance is not `ReportTemplateSavedFilterOneOf1`
     */
    public ReportTemplateSavedFilterOneOf1 getReportTemplateSavedFilterOneOf1() throws ClassCastException {
        return (ReportTemplateSavedFilterOneOf1)super.getActualInstance();
    }
