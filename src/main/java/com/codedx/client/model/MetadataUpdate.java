 ...
 */
@JsonPropertyOrder({
  MetadataUpdate.JSON_PROPERTY_ID,
  MetadataUpdate.JSON_PROPERTY_VALUE
})
...
public class MetadataUpdate {
  ...
  public MetadataUpdate id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public MetadataUpdate value(@jakarta.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this MetadataUpdate object is equal to o.
   */
  @Override
