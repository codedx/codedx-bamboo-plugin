 ...
 */
@JsonPropertyOrder({
  SecurityRisk.JSON_PROPERTY_RANK,
  SecurityRisk.JSON_PROPERTY_NAME
})
...
public class SecurityRisk {
  ...
  public SecurityRisk rank(@jakarta.annotation.Nullable Integer rank) {
    this.rank = rank;
    return this;
  }
  ...
  public SecurityRisk name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Return true if this SecurityRisk object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SecurityRisk securityRisk = (SecurityRisk) o;
    return Objects.equals(this.rank, securityRisk.rank) &&
        Objects.equals(this.name, securityRisk.name);
  }
