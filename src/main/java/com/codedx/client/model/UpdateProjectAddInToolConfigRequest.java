...
/**
 * UpdateProjectAddInToolConfigRequest
 */
@JsonPropertyOrder({
  UpdateProjectAddInToolConfigRequest.JSON_PROPERTY_NEW_CONTENT,
  UpdateProjectAddInToolConfigRequest.JSON_PROPERTY_ALLOWED_SECRETS,
  UpdateProjectAddInToolConfigRequest.JSON_PROPERTY_IS_ENABLED
})
@JsonTypeName("updateProjectAddInToolConfig_request")
...
public class UpdateProjectAddInToolConfigRequest {
  public static final String JSON_PROPERTY_NEW_CONTENT = "newContent";
  @jakarta.annotation.Nullable
  private String newContent;

  public static final String JSON_PROPERTY_ALLOWED_SECRETS = "allowedSecrets";
  @jakarta.annotation.Nullable
  private List<String> allowedSecrets = new ArrayList<>();

  public static final String JSON_PROPERTY_IS_ENABLED = "isEnabled";
  @jakarta.annotation.Nullable
  private Boolean isEnabled;

  public UpdateProjectAddInToolConfigRequest() { 
  }

  public UpdateProjectAddInToolConfigRequest newContent(@jakarta.annotation.Nullable String newContent) {
    this.newContent = newContent;
    return this;
  }

  /**
   * (optional) The new TOML spec. that will replace any existing content. Customized TOML spec. is merged with the Administrator&#39;s base spec. The request will be rejected if the new content contains a &#x60;[request]&#x60; section, which is private and can only be modified by an Administrator
   * @return newContent
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NEW_CONTENT, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_NEW_CONTENT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNewContent(@jakarta.annotation.Nullable String newContent) {
    this.newContent = newContent;
  }


  public UpdateProjectAddInToolConfigRequest allowedSecrets(@jakarta.annotation.Nullable List<String> allowedSecrets) {
    this.allowedSecrets = allowedSecrets;
    return this;
  }

  public UpdateProjectAddInToolConfigRequest addAllowedSecretsItem(String allowedSecretsItem) {
    if (this.allowedSecrets == null) {
      this.allowedSecrets = new ArrayList<>();
    }
    this.allowedSecrets.add(allowedSecretsItem);
    return this;
  }

  /**
   * (optional) A new list of secret names that will replace the old list of accepted secrets
   * @return allowedSecrets
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ALLOWED_SECRETS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOWED_SECRETS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAllowedSecrets(@jakarta.annotation.Nullable List<String> allowedSecrets) {
    this.allowedSecrets = allowedSecrets;
  }


  public UpdateProjectAddInToolConfigRequest isEnabled(@jakarta.annotation.Nullable Boolean isEnabled) {
    this.isEnabled = isEnabled;
    return this;
  }

  /**
   * (optional) Sets whether or not the Add-In Tool is enabled in new Analyses for the Project
   * @return isEnabled
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this updateProjectAddInToolConfig_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateProjectAddInToolConfigRequest updateProjectAddInToolConfigRequest = (UpdateProjectAddInToolConfigRequest) o;
    return Objects.equals(this.newContent, updateProjectAddInToolConfigRequest.newContent) &&
        Objects.equals(this.allowedSecrets, updateProjectAddInToolConfigRequest.allowedSecrets) &&
        Objects.equals(this.isEnabled, updateProjectAddInToolConfigRequest.isEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(newContent, allowedSecrets, isEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateProjectAddInToolConfigRequest {\n");
    sb.append("    newContent: ").append(toIndentedString(newContent)).append("\n");
    sb.append("    allowedSecrets: ").append(toIndentedString(allowedSecrets)).append("\n");
