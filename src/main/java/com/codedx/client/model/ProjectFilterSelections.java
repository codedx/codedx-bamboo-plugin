...
import com.codedx.client.model.ProjectFilterSelectionsOneOf;
import com.codedx.client.model.ProjectFilterSelectionsOneOf1;
...
@JsonDeserialize(using = ProjectFilterSelections.ProjectFilterSelectionsDeserializer.class)
@JsonSerialize(using = ProjectFilterSelections.ProjectFilterSelectionsSerializer.class)
public class ProjectFilterSelections extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ProjectFilterSelections.class.getName());

    public static class ProjectFilterSelectionsSerializer extends StdSerializer<ProjectFilterSelections> {
        public ProjectFilterSelectionsSerializer(Class<ProjectFilterSelections> t) {
            super(t);
        }

        public ProjectFilterSelectionsSerializer() {
            this(null);
        }

        @Override
        public void serialize(ProjectFilterSelections value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ProjectFilterSelectionsDeserializer extends StdDeserializer<ProjectFilterSelections> {
        public ProjectFilterSelectionsDeserializer() {
            this(ProjectFilterSelections.class);
        }

        public ProjectFilterSelectionsDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ProjectFilterSelections deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize ProjectFilterSelectionsOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(ProjectFilterSelectionsOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'ProjectFilterSelectionsOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'ProjectFilterSelectionsOneOf'", e);
            }

            // deserialize ProjectFilterSelectionsOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(ProjectFilterSelectionsOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'ProjectFilterSelectionsOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'ProjectFilterSelectionsOneOf1'", e);
            }

            if (match == 1) {
                ProjectFilterSelections ret = new ProjectFilterSelections();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ProjectFilterSelections: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ProjectFilterSelections getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ProjectFilterSelections cannot be null");
        }
    }
    ...
    public ProjectFilterSelections() {
        super("oneOf", Boolean.FALSE);
    }

    public ProjectFilterSelections(ProjectFilterSelectionsOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ProjectFilterSelections(ProjectFilterSelectionsOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("ProjectFilterSelectionsOneOf", new GenericType<ProjectFilterSelectionsOneOf>() {
        });
        schemas.put("ProjectFilterSelectionsOneOf1", new GenericType<ProjectFilterSelectionsOneOf1>() {
        });
        JSON.registerDescendants(ProjectFilterSelections.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return ProjectFilterSelections.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * ProjectFilterSelectionsOneOf, ProjectFilterSelectionsOneOf1
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(ProjectFilterSelectionsOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(ProjectFilterSelectionsOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be ProjectFilterSelectionsOneOf, ProjectFilterSelectionsOneOf1");
    }
     ...
     * ProjectFilterSelectionsOneOf, ProjectFilterSelectionsOneOf1
     *
     * @return The actual instance (ProjectFilterSelectionsOneOf, ProjectFilterSelectionsOneOf1)
     */
    @Override
    ...
    /**
     * Get the actual instance of `ProjectFilterSelectionsOneOf`. If the actual instance is not `ProjectFilterSelectionsOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ProjectFilterSelectionsOneOf`
     * @throws ClassCastException if the instance is not `ProjectFilterSelectionsOneOf`
     */
    public ProjectFilterSelectionsOneOf getProjectFilterSelectionsOneOf() throws ClassCastException {
        return (ProjectFilterSelectionsOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `ProjectFilterSelectionsOneOf1`. If the actual instance is not `ProjectFilterSelectionsOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ProjectFilterSelectionsOneOf1`
     * @throws ClassCastException if the instance is not `ProjectFilterSelectionsOneOf1`
     */
    public ProjectFilterSelectionsOneOf1 getProjectFilterSelectionsOneOf1() throws ClassCastException {
        return (ProjectFilterSelectionsOneOf1)super.getActualInstance();
    }
