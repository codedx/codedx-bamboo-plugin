...
/**
 * An object representing the user&#39;s notification preferences
 */
@JsonPropertyOrder({
  UserNotificationPreferences.JSON_PROPERTY_EMAIL_ADDRESS,
  UserNotificationPreferences.JSON_PROPERTY_INTERESTED_IN_POLICY_SUCCESS,
  UserNotificationPreferences.JSON_PROPERTY_INTERESTED_IN_POLICY_WARNING,
  UserNotificationPreferences.JSON_PROPERTY_INTERESTED_IN_POLICY_ERROR
})
...
public class UserNotificationPreferences {
  ...
  public static final String JSON_PROPERTY_INTERESTED_IN_POLICY_SUCCESS = "interestedInPolicySuccess";
  @jakarta.annotation.Nullable
  private Boolean interestedInPolicySuccess;

  public static final String JSON_PROPERTY_INTERESTED_IN_POLICY_WARNING = "interestedInPolicyWarning";
  @jakarta.annotation.Nullable
  private Boolean interestedInPolicyWarning;

  public static final String JSON_PROPERTY_INTERESTED_IN_POLICY_ERROR = "interestedInPolicyError";
  @jakarta.annotation.Nullable
  private Boolean interestedInPolicyError;

  public UserNotificationPreferences() { 
  }

  public UserNotificationPreferences emailAddress(@jakarta.annotation.Nullable String emailAddress) {
  ...
  public UserNotificationPreferences interestedInPolicySuccess(@jakarta.annotation.Nullable Boolean interestedInPolicySuccess) {
    this.interestedInPolicySuccess = interestedInPolicySuccess;
    return this;
  }

  /**
   * Get interestedInPolicySuccess
   * @return interestedInPolicySuccess
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INTERESTED_IN_POLICY_SUCCESS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getInterestedInPolicySuccess() {
    return interestedInPolicySuccess;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INTERESTED_IN_POLICY_SUCCESS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInterestedInPolicySuccess(@jakarta.annotation.Nullable Boolean interestedInPolicySuccess) {
    this.interestedInPolicySuccess = interestedInPolicySuccess;
  }


  public UserNotificationPreferences interestedInPolicyWarning(@jakarta.annotation.Nullable Boolean interestedInPolicyWarning) {
    this.interestedInPolicyWarning = interestedInPolicyWarning;
    return this;
  }

  /**
   * Get interestedInPolicyWarning
   * @return interestedInPolicyWarning
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INTERESTED_IN_POLICY_WARNING, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getInterestedInPolicyWarning() {
    return interestedInPolicyWarning;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INTERESTED_IN_POLICY_WARNING, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInterestedInPolicyWarning(@jakarta.annotation.Nullable Boolean interestedInPolicyWarning) {
    this.interestedInPolicyWarning = interestedInPolicyWarning;
  }


  public UserNotificationPreferences interestedInPolicyError(@jakarta.annotation.Nullable Boolean interestedInPolicyError) {
    this.interestedInPolicyError = interestedInPolicyError;
    return this;
  }

  /**
   * Get interestedInPolicyError
   * @return interestedInPolicyError
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INTERESTED_IN_POLICY_ERROR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getInterestedInPolicyError() {
    return interestedInPolicyError;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INTERESTED_IN_POLICY_ERROR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInterestedInPolicyError(@jakarta.annotation.Nullable Boolean interestedInPolicyError) {
    this.interestedInPolicyError = interestedInPolicyError;
  }


  /**
   * Return true if this UserNotificationPreferences object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UserNotificationPreferences userNotificationPreferences = (UserNotificationPreferences) o;
    return Objects.equals(this.emailAddress, userNotificationPreferences.emailAddress) &&
        Objects.equals(this.interestedInPolicySuccess, userNotificationPreferences.interestedInPolicySuccess) &&
        Objects.equals(this.interestedInPolicyWarning, userNotificationPreferences.interestedInPolicyWarning) &&
        Objects.equals(this.interestedInPolicyError, userNotificationPreferences.interestedInPolicyError);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emailAddress, interestedInPolicySuccess, interestedInPolicyWarning, interestedInPolicyError);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserNotificationPreferences {\n");
    sb.append("    emailAddress: ").append(toIndentedString(emailAddress)).append("\n");
    sb.append("    interestedInPolicySuccess: ").append(toIndentedString(interestedInPolicySuccess)).append("\n");
    sb.append("    interestedInPolicyWarning: ").append(toIndentedString(interestedInPolicyWarning)).append("\n");
    sb.append("    interestedInPolicyError: ").append(toIndentedString(interestedInPolicyError)).append("\n");
    sb.append("}");
    return sb.toString();
  }
