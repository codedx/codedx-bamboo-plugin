 ...
 */
@JsonPropertyOrder({
  RenameTagRequest.JSON_PROPERTY_NAME
})
@JsonTypeName("renameTag_request")
...
public class RenameTagRequest {
  ...
  public RenameTagRequest name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }

  /**
   * The name to which the tag with id {tag-id} will be renamed. It must be at most 32 characters in length.
   * @return name
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this renameTag_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RenameTagRequest renameTagRequest = (RenameTagRequest) o;
    return Objects.equals(this.name, renameTagRequest.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class RenameTagRequest {\n");
