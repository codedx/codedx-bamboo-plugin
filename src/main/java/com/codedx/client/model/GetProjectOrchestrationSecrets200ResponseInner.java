...
import com.codedx.client.model.OrchestrationSecretField;
...
/**
 * GetProjectOrchestrationSecrets200ResponseInner
 */
@JsonPropertyOrder({
  GetProjectOrchestrationSecrets200ResponseInner.JSON_PROPERTY_NAME,
  GetProjectOrchestrationSecrets200ResponseInner.JSON_PROPERTY_FIELDS
})
@JsonTypeName("getProjectOrchestrationSecrets_200_response_inner")
...
public class GetProjectOrchestrationSecrets200ResponseInner {
  ...
  @jakarta.annotation.Nullable
  private List<OrchestrationSecretField> fields = new ArrayList<>();

  public GetProjectOrchestrationSecrets200ResponseInner() { 
  }

  public GetProjectOrchestrationSecrets200ResponseInner name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }

  /**
   * The case-insensitive name of a secret, unique within the project.
   * @return name
   */
  @jakarta.annotation.Nullable
  ...
  public GetProjectOrchestrationSecrets200ResponseInner fields(@jakarta.annotation.Nullable List<OrchestrationSecretField> fields) {
    this.fields = fields;
    return this;
  }

  public GetProjectOrchestrationSecrets200ResponseInner addFieldsItem(OrchestrationSecretField fieldsItem) {
    if (this.fields == null) {
  ...
  /**
   * A list of fields stored within the secret.
   * @return fields
   */
  @jakarta.annotation.Nullable
  ...
  public List<OrchestrationSecretField> getFields() {
    return fields;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FIELDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFields(@jakarta.annotation.Nullable List<OrchestrationSecretField> fields) {
    this.fields = fields;
  }


  /**
   * Return true if this getProjectOrchestrationSecrets_200_response_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetProjectOrchestrationSecrets200ResponseInner getProjectOrchestrationSecrets200ResponseInner = (GetProjectOrchestrationSecrets200ResponseInner) o;
    return Objects.equals(this.name, getProjectOrchestrationSecrets200ResponseInner.name) &&
        Objects.equals(this.fields, getProjectOrchestrationSecrets200ResponseInner.fields);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetProjectOrchestrationSecrets200ResponseInner {\n");
