 ...
 */
@JsonPropertyOrder({
  ProjectQueryResponse.JSON_PROPERTY_ID,
  ProjectQueryResponse.JSON_PROPERTY_NAME,
  ProjectQueryResponse.JSON_PROPERTY_PARENT_ID,
  ProjectQueryResponse.JSON_PROPERTY_HIERARCHY_IDS,
  ProjectQueryResponse.JSON_PROPERTY_LATEST_COMPLETE_ANALYSIS,
  ProjectQueryResponse.JSON_PROPERTY_LATEST_FAILED_ANALYSIS,
  ProjectQueryResponse.JSON_PROPERTY_METADATA
})
...
public class ProjectQueryResponse {
  ...
  @jakarta.annotation.Nullable
  private AnalysisRecord latestCompleteAnalysis;

  public static final String JSON_PROPERTY_LATEST_FAILED_ANALYSIS = "latestFailedAnalysis";
  @jakarta.annotation.Nullable
  private AnalysisRecord latestFailedAnalysis;
  ...
  public ProjectQueryResponse id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ProjectQueryResponse name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectQueryResponse parentId(@jakarta.annotation.Nullable Integer parentId) {
  ...
  public ProjectQueryResponse hierarchyIds(@jakarta.annotation.Nullable List<Integer> hierarchyIds) {
  ...
  public ProjectQueryResponse latestCompleteAnalysis(@jakarta.annotation.Nullable AnalysisRecord latestCompleteAnalysis) {
  ...
  @JsonProperty(value = JSON_PROPERTY_LATEST_COMPLETE_ANALYSIS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLatestCompleteAnalysis(@jakarta.annotation.Nullable AnalysisRecord latestCompleteAnalysis) {
    this.latestCompleteAnalysis = latestCompleteAnalysis;
  }


  public ProjectQueryResponse latestFailedAnalysis(@jakarta.annotation.Nullable AnalysisRecord latestFailedAnalysis) {
  ...
  @JsonProperty(value = JSON_PROPERTY_LATEST_FAILED_ANALYSIS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLatestFailedAnalysis(@jakarta.annotation.Nullable AnalysisRecord latestFailedAnalysis) {
    this.latestFailedAnalysis = latestFailedAnalysis;
  }


  public ProjectQueryResponse metadata(@jakarta.annotation.Nullable List<MetadataValue> metadata) {
  ...
  /**
   * Return true if this ProjectQueryResponse object is equal to o.
   */
  @Override
