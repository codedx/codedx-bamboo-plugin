 ...
 */
@JsonPropertyOrder({
  ReportConfigRegex.JSON_PROPERTY_REGEX,
  ReportConfigRegex.JSON_PROPERTY_MESSAGE
})
...
public class ReportConfigRegex {
  ...
  public ReportConfigRegex() { 
  }

  public ReportConfigRegex regex(@jakarta.annotation.Nullable String regex) {
    this.regex = regex;
    return this;
  }
  ...
  public ReportConfigRegex message(@jakarta.annotation.Nullable String message) {
  ...
  /**
   * Return true if this ReportConfigRegex object is equal to o.
   */
  @Override
