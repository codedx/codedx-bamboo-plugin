 ...
 */
@JsonPropertyOrder({
  ActivityEvent.JSON_PROPERTY_TYPE,
  ActivityEvent.JSON_PROPERTY_DATA
})
...
public class ActivityEvent {
  ...
  public enum TypeEnum {
    FINDING_UPDATED(String.valueOf("finding-updated")),
    
    FINDING_COMMENT(String.valueOf("finding-comment")),
    
    TOOL_COMMENT(String.valueOf("tool-comment"));
  ...
  public ActivityEvent type(@jakarta.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ActivityEvent data(@jakarta.annotation.Nullable Map<String, Object> data) {
    this.data = data;
    return this;
  }
  ...
  /**
   * Return true if this ActivityEvent object is equal to o.
   */
  @Override
