 ...
 */
@JsonPropertyOrder({
  SeverityOverride.JSON_PROPERTY_SEVERITY
})
...
public class SeverityOverride {
  ...
  public SeverityOverride severity(@jakarta.annotation.Nullable SeverityValue severity) {
  ...
  /**
   * Return true if this SeverityOverride object is equal to o.
   */
  @Override
