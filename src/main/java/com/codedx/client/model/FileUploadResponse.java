 ...
 */
@JsonPropertyOrder({
  FileUploadResponse.JSON_PROPERTY_JOB_ID,
  FileUploadResponse.JSON_PROPERTY_INPUT_ID,
  FileUploadResponse.JSON_PROPERTY_SIZE
})
...
public class FileUploadResponse {
  ...
  public FileUploadResponse jobId(@jakarta.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public FileUploadResponse inputId(@jakarta.annotation.Nullable String inputId) {
  ...
  public FileUploadResponse size(@jakarta.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }

  /**
   * The size (in bytes) of the uploaded file. Note that this may differ from the original size of the file, as Software Risk Manager performs some internal cleanup of zip-like files.
   * @return size
   */
  @jakarta.annotation.Nullable
