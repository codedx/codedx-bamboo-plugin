...
import com.codedx.client.model.GetProjectEnumerationSupport200ResponseConnectionsInner;
...
/**
 * GetProjectEnumerationSupport200Response
 */
@JsonPropertyOrder({
  GetProjectEnumerationSupport200Response.JSON_PROPERTY_SUPPORTED,
  GetProjectEnumerationSupport200Response.JSON_PROPERTY_CONDITIONAL,
  GetProjectEnumerationSupport200Response.JSON_PROPERTY_CONNECTIONS,
  GetProjectEnumerationSupport200Response.JSON_PROPERTY_PARENT_MAPPING_SUPPORTED
})
@JsonTypeName("getProjectEnumerationSupport_200_response")
...
public class GetProjectEnumerationSupport200Response {
  ...
  @jakarta.annotation.Nullable
  private List<GetProjectEnumerationSupport200ResponseConnectionsInner> connections = new ArrayList<>();

  public static final String JSON_PROPERTY_PARENT_MAPPING_SUPPORTED = "parentMappingSupported";
  @jakarta.annotation.Nullable
  private Boolean parentMappingSupported;

  public GetProjectEnumerationSupport200Response() { 
  }

  public GetProjectEnumerationSupport200Response supported(@jakarta.annotation.Nullable Boolean supported) {
  ...
  public GetProjectEnumerationSupport200Response conditional(@jakarta.annotation.Nullable Boolean conditional) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONDITIONAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONDITIONAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConditional(@jakarta.annotation.Nullable Boolean conditional) {
    this.conditional = conditional;
  }


  public GetProjectEnumerationSupport200Response connections(@jakarta.annotation.Nullable List<GetProjectEnumerationSupport200ResponseConnectionsInner> connections) {
    this.connections = connections;
    return this;
  }

  public GetProjectEnumerationSupport200Response addConnectionsItem(GetProjectEnumerationSupport200ResponseConnectionsInner connectionsItem) {
  ...
  public List<GetProjectEnumerationSupport200ResponseConnectionsInner> getConnections() {
    return connections;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONNECTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConnections(@jakarta.annotation.Nullable List<GetProjectEnumerationSupport200ResponseConnectionsInner> connections) {
    this.connections = connections;
  }


  public GetProjectEnumerationSupport200Response parentMappingSupported(@jakarta.annotation.Nullable Boolean parentMappingSupported) {
    this.parentMappingSupported = parentMappingSupported;
    return this;
  }

  /**
   * Get parentMappingSupported
   * @return parentMappingSupported
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PARENT_MAPPING_SUPPORTED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getParentMappingSupported() {
    return parentMappingSupported;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PARENT_MAPPING_SUPPORTED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParentMappingSupported(@jakarta.annotation.Nullable Boolean parentMappingSupported) {
    this.parentMappingSupported = parentMappingSupported;
  }


  /**
   * Return true if this getProjectEnumerationSupport_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetProjectEnumerationSupport200Response getProjectEnumerationSupport200Response = (GetProjectEnumerationSupport200Response) o;
    return Objects.equals(this.supported, getProjectEnumerationSupport200Response.supported) &&
        Objects.equals(this.conditional, getProjectEnumerationSupport200Response.conditional) &&
        Objects.equals(this.connections, getProjectEnumerationSupport200Response.connections) &&
        Objects.equals(this.parentMappingSupported, getProjectEnumerationSupport200Response.parentMappingSupported);
  }

  @Override
  public int hashCode() {
    return Objects.hash(supported, conditional, connections, parentMappingSupported);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetProjectEnumerationSupport200Response {\n");
    sb.append("    supported: ").append(toIndentedString(supported)).append("\n");
    sb.append("    conditional: ").append(toIndentedString(conditional)).append("\n");
    sb.append("    connections: ").append(toIndentedString(connections)).append("\n");
    sb.append("    parentMappingSupported: ").append(toIndentedString(parentMappingSupported)).append("\n");
    sb.append("}");
    return sb.toString();
  }
