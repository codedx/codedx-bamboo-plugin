...
/**
 * BulkSeverityOverride
 */
@JsonPropertyOrder({
  BulkSeverityOverride.JSON_PROPERTY_FILTER,
  BulkSeverityOverride.JSON_PROPERTY_SEVERITY
})
...
public class BulkSeverityOverride {
  ...
  public BulkSeverityOverride() { 
  }

  public BulkSeverityOverride filter(@jakarta.annotation.Nullable Filter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public BulkSeverityOverride severity(@jakarta.annotation.Nullable String severity) {
  ...
  /**
   * Return true if this BulkSeverityOverride object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BulkSeverityOverride bulkSeverityOverride = (BulkSeverityOverride) o;
    return Objects.equals(this.filter, bulkSeverityOverride.filter) &&
        Objects.equals(this.severity, bulkSeverityOverride.severity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filter, severity);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BulkSeverityOverride {\n");
