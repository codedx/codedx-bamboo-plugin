...
/**
 * OverridableNameEntity
 */
@JsonPropertyOrder({
  OverridableNameEntity.JSON_PROPERTY_ID,
  OverridableNameEntity.JSON_PROPERTY_NAME,
  OverridableNameEntity.JSON_PROPERTY_ORIGINAL_NAME
})
...
public class OverridableNameEntity {
  ...
  public OverridableNameEntity() { 
  }

  public OverridableNameEntity id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public OverridableNameEntity name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OverridableNameEntity originalName(@jakarta.annotation.Nullable String originalName) {
    this.originalName = originalName;
    return this;
  }

  /**
   * Optional field that represents the actual name of the entity when the entity name has been overridden for the given connector
   * @return originalName
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this OverridableNameEntity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OverridableNameEntity overridableNameEntity = (OverridableNameEntity) o;
    return Objects.equals(this.id, overridableNameEntity.id) &&
        Objects.equals(this.name, overridableNameEntity.name) &&
        Objects.equals(this.originalName, overridableNameEntity.originalName);
  }
  ...
  public String toString() {
    ...
    sb.append("class OverridableNameEntity {\n");
