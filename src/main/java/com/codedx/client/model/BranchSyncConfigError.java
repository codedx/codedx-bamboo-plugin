...
/**
 * BranchSyncConfigError
 */
@JsonPropertyOrder({
  BranchSyncConfigError.JSON_PROPERTY_MISSING_BRANCH,
  BranchSyncConfigError.JSON_PROPERTY_CONFLICTING_BRANCHES
})
...
public class BranchSyncConfigError {
  public static final String JSON_PROPERTY_MISSING_BRANCH = "missingBranch";
  @jakarta.annotation.Nullable
  private String missingBranch;

  public static final String JSON_PROPERTY_CONFLICTING_BRANCHES = "conflictingBranches";
  @jakarta.annotation.Nullable
  private List<String> conflictingBranches = new ArrayList<>();

  public BranchSyncConfigError() { 
  }

  public BranchSyncConfigError missingBranch(@jakarta.annotation.Nullable String missingBranch) {
    this.missingBranch = missingBranch;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MISSING_BRANCH, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getMissingBranch() {
    return missingBranch;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_MISSING_BRANCH, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMissingBranch(@jakarta.annotation.Nullable String missingBranch) {
    this.missingBranch = missingBranch;
  }


  public BranchSyncConfigError conflictingBranches(@jakarta.annotation.Nullable List<String> conflictingBranches) {
    this.conflictingBranches = conflictingBranches;
    return this;
  }

  public BranchSyncConfigError addConflictingBranchesItem(String conflictingBranchesItem) {
    if (this.conflictingBranches == null) {
      this.conflictingBranches = new ArrayList<>();
    }
    this.conflictingBranches.add(conflictingBranchesItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONFLICTING_BRANCHES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<String> getConflictingBranches() {
    return conflictingBranches;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONFLICTING_BRANCHES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConflictingBranches(@jakarta.annotation.Nullable List<String> conflictingBranches) {
    this.conflictingBranches = conflictingBranches;
  }


  /**
   * Return true if this BranchSyncConfigError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BranchSyncConfigError branchSyncConfigError = (BranchSyncConfigError) o;
    return Objects.equals(this.missingBranch, branchSyncConfigError.missingBranch) &&
        Objects.equals(this.conflictingBranches, branchSyncConfigError.conflictingBranches);
  }

  @Override
  public int hashCode() {
    return Objects.hash(missingBranch, conflictingBranches);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BranchSyncConfigError {\n");
    sb.append("    missingBranch: ").append(toIndentedString(missingBranch)).append("\n");
    sb.append("    conflictingBranches: ").append(toIndentedString(conflictingBranches)).append("\n");
    sb.append("}");
    return sb.toString();
  }
