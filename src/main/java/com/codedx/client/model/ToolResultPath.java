 ...
 */
@JsonPropertyOrder({
  ToolResultPath.JSON_PROPERTY_ID,
  ToolResultPath.JSON_PROPERTY_INPUT_ID,
  ToolResultPath.JSON_PROPERTY_PATH_TYPE,
  ToolResultPath.JSON_PROPERTY_PATH,
  ToolResultPath.JSON_PROPERTY_SHORT_NAME
})
...
public class ToolResultPath {
  ...
  public ToolResultPath() { 
  }

  public ToolResultPath id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ToolResultPath inputId(@jakarta.annotation.Nullable Integer inputId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INPUT_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInputId(@jakarta.annotation.Nullable Integer inputId) {
    this.inputId = inputId;
  }


  public ToolResultPath pathType(@jakarta.annotation.Nullable String pathType) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PATH_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PATH_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPathType(@jakarta.annotation.Nullable String pathType) {
    this.pathType = pathType;
  }


  public ToolResultPath path(@jakarta.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public ToolResultPath shortName(@jakarta.annotation.Nullable String shortName) {
  ...
  /**
   * Return true if this ToolResultPath object is equal to o.
   */
  @Override
