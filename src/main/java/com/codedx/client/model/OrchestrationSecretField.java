...
/**
 * OrchestrationSecretField
 */
@JsonPropertyOrder({
  OrchestrationSecretField.JSON_PROPERTY_KEY,
  OrchestrationSecretField.JSON_PROPERTY_VALUE,
  OrchestrationSecretField.JSON_PROPERTY_IS_SENSITIVE
})
...
public class OrchestrationSecretField {
  ...
  public OrchestrationSecretField() { 
  }

  public OrchestrationSecretField key(@jakarta.annotation.Nullable String key) {
    this.key = key;
    return this;
  }

  /**
   * The case-sensitive field name, unique within a secret
   * @return key
   */
  @jakarta.annotation.Nullable
  ...
  public OrchestrationSecretField value(@jakarta.annotation.Nullable String value) {
    this.value = value;
    return this;
  }

  /**
   * The field value, or a placeholder if the field is sensitive
   * @return value
   */
  @jakarta.annotation.Nullable
  ...
  public OrchestrationSecretField isSensitive(@jakarta.annotation.Nullable Boolean isSensitive) {
    this.isSensitive = isSensitive;
    return this;
  }

  /**
   * Whether or not the field content should be write-only (sensitive) or read-write (non-sensitive). Sensitive field values can be read by tools but not by Software Risk Manager
   * @return isSensitive
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_SENSITIVE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_SENSITIVE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsSensitive(@jakarta.annotation.Nullable Boolean isSensitive) {
    this.isSensitive = isSensitive;
  }


  /**
   * Return true if this OrchestrationSecretField object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OrchestrationSecretField orchestrationSecretField = (OrchestrationSecretField) o;
    return Objects.equals(this.key, orchestrationSecretField.key) &&
        Objects.equals(this.value, orchestrationSecretField.value) &&
        Objects.equals(this.isSensitive, orchestrationSecretField.isSensitive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, value, isSensitive);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrchestrationSecretField {\n");
