 ...
 */
@JsonPropertyOrder({
  IdentifiedBinding.JSON_PROPERTY_ID,
  IdentifiedBinding.JSON_PROPERTY_BINDING
})
...
public class IdentifiedBinding {
  ...
  @jakarta.annotation.Nullable
  private ToolConnectorStaticBindingCreateRef binding;

  public IdentifiedBinding() { 
  }

  public IdentifiedBinding id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public IdentifiedBinding binding(@jakarta.annotation.Nullable ToolConnectorStaticBindingCreateRef binding) {
  ...
  public ToolConnectorStaticBindingCreateRef getBinding() {
    return binding;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_BINDING, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBinding(@jakarta.annotation.Nullable ToolConnectorStaticBindingCreateRef binding) {
    this.binding = binding;
  }


  /**
   * Return true if this IdentifiedBinding object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IdentifiedBinding identifiedBinding = (IdentifiedBinding) o;
    return Objects.equals(this.id, identifiedBinding.id) &&
        Objects.equals(this.binding, identifiedBinding.binding);
  }
  ...
  public String toString() {
    ...
    sb.append("class IdentifiedBinding {\n");
