...
public class StandardsApi {
  ...
  /**
   * Get Standards
   * Returns a list of standards hierarchies available for use as filter views.  Requires the \&quot;site:read\&quot; permission which is available to all users regardless of role.
   ...
   * @http.response.details
     <table border="1">
       ...
       <tr><td> 200 </td><td> OK - Contains a list of standards hierarchies </td><td>  -  </td></tr>
  ...
  public ApiResponse<List<Standard>> getStandardsWithHttpInfo() throws ApiException {
    ...
    return apiClient.invokeAPI("StandardsApi.getStandards", "/api/standards/filter-views", "GET", new ArrayList<>(), null,
