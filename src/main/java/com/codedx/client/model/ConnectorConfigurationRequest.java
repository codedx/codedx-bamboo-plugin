 ...
 */
@JsonPropertyOrder({
  ConnectorConfigurationRequest.JSON_PROPERTY_TOOL,
  ConnectorConfigurationRequest.JSON_PROPERTY_NAME,
  ConnectorConfigurationRequest.JSON_PROPERTY_BRANCH_SYNC_TARGET,
  ConnectorConfigurationRequest.JSON_PROPERTY_AVAILABLE_DURING_ANALYSIS,
  ConnectorConfigurationRequest.JSON_PROPERTY_AUTO_UPDATE,
  ConnectorConfigurationRequest.JSON_PROPERTY_USE_DYNAMIC_VERSION,
  ConnectorConfigurationRequest.JSON_PROPERTY_VALUES,
  ConnectorConfigurationRequest.JSON_PROPERTY_VALIDATION
})
...
public class ConnectorConfigurationRequest {
  ...
  public ConnectorConfigurationRequest() { 
  }

  public ConnectorConfigurationRequest tool(@jakarta.annotation.Nonnull String tool) {
    this.tool = tool;
    return this;
  }
  ...
  public ConnectorConfigurationRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ConnectorConfigurationRequest branchSyncTarget(@jakarta.annotation.Nullable String branchSyncTarget) {
    this.branchSyncTarget = branchSyncTarget;
    return this;
  }

  /**
   * If specified, indicates this connector should only run when the SRM analysis&#39;s branch matches the given string. Use &#x60;null&#x60; or omit this field to indicate no constraint.
  ...
  public ConnectorConfigurationRequest availableDuringAnalysis(@jakarta.annotation.Nullable Boolean availableDuringAnalysis) {
    this.availableDuringAnalysis = availableDuringAnalysis;
    return this;
  }

  /**
   * Indicates whether this connector should be available to run during &#39;normal&#39; analyses, e.g. analyses set up via the Analysis Prep system. If omitted or set to &#x60;false&#x60;, this connector will only run as part of its &#x60;autoUpdate&#x60; schedule, or when explicitly requested via a corresponding API endpoint.
  ...
  public ConnectorConfigurationRequest autoUpdate(@jakarta.annotation.Nullable AutoUpdateSetting autoUpdate) {
  ...
  public ConnectorConfigurationRequest useDynamicVersion(@jakarta.annotation.Nullable Boolean useDynamicVersion) {
    this.useDynamicVersion = useDynamicVersion;
    return this;
  }

  /**
   * If specified as &#x60;true&#x60;, this connector omits its &#39;version&#39; configuration, instead deriving it based on the current analysis&#39;s branch context.
  ...
  public ConnectorConfigurationRequest values(@jakarta.annotation.Nullable Map<String, Object> values) {
    this.values = values;
    return this;
  }

  public ConnectorConfigurationRequest putValuesItem(String key, Object valuesItem) {
    if (this.values == null) {
  ...
  public ConnectorConfigurationRequest validation(@jakarta.annotation.Nullable ConnectorValidationTokens validation) {
  ...
  /**
   * Return true if this ConnectorConfigurationRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ConnectorConfigurationRequest connectorConfigurationRequest = (ConnectorConfigurationRequest) o;
    return Objects.equals(this.tool, connectorConfigurationRequest.tool) &&
        Objects.equals(this.name, connectorConfigurationRequest.name) &&
        Objects.equals(this.branchSyncTarget, connectorConfigurationRequest.branchSyncTarget) &&
        Objects.equals(this.availableDuringAnalysis, connectorConfigurationRequest.availableDuringAnalysis) &&
        Objects.equals(this.autoUpdate, connectorConfigurationRequest.autoUpdate) &&
        Objects.equals(this.useDynamicVersion, connectorConfigurationRequest.useDynamicVersion) &&
        Objects.equals(this.values, connectorConfigurationRequest.values) &&
        Objects.equals(this.validation, connectorConfigurationRequest.validation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tool, name, branchSyncTarget, availableDuringAnalysis, autoUpdate, useDynamicVersion, values, validation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConnectorConfigurationRequest {\n");
