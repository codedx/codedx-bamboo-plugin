...
import com.codedx.client.model.DefaultEntitiesForToolProjectDefaultsInner;
...
/**
 * An object containing the default entity IDs for a tool and all projects integrated with that tool
 */
@JsonPropertyOrder({
  DefaultEntitiesForTool.JSON_PROPERTY_TOOL_DEFAULT,
  DefaultEntitiesForTool.JSON_PROPERTY_PROJECT_DEFAULTS
})
...
public class DefaultEntitiesForTool {
  ...
  @jakarta.annotation.Nullable
  private List<DefaultEntitiesForToolProjectDefaultsInner> projectDefaults = new ArrayList<>();

  public DefaultEntitiesForTool() { 
  }

  public DefaultEntitiesForTool toolDefault(@jakarta.annotation.Nullable Integer toolDefault) {
  ...
  public DefaultEntitiesForTool projectDefaults(@jakarta.annotation.Nullable List<DefaultEntitiesForToolProjectDefaultsInner> projectDefaults) {
    this.projectDefaults = projectDefaults;
    return this;
  }

  public DefaultEntitiesForTool addProjectDefaultsItem(DefaultEntitiesForToolProjectDefaultsInner projectDefaultsItem) {
  ...
  /**
   * An array of objects containing the project default Entity IDs and the Project, Project Entity, and Connection Entity IDs
  ...
  public List<DefaultEntitiesForToolProjectDefaultsInner> getProjectDefaults() {
    return projectDefaults;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT_DEFAULTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjectDefaults(@jakarta.annotation.Nullable List<DefaultEntitiesForToolProjectDefaultsInner> projectDefaults) {
    this.projectDefaults = projectDefaults;
  }


  /**
   * Return true if this DefaultEntitiesForTool object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DefaultEntitiesForTool defaultEntitiesForTool = (DefaultEntitiesForTool) o;
    return Objects.equals(this.toolDefault, defaultEntitiesForTool.toolDefault) &&
        Objects.equals(this.projectDefaults, defaultEntitiesForTool.projectDefaults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(toolDefault, projectDefaults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DefaultEntitiesForTool {\n");
