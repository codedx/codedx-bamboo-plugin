 ...
 */
@JsonPropertyOrder({
  FlowRequest.JSON_PROPERTY_FILTER
})
...
public class FlowRequest {
  ...
  public FlowRequest filter(@jakarta.annotation.Nullable Filter filter) {
    this.filter = filter;
    return this;
  }
  ...
  /**
   * Return true if this FlowRequest object is equal to o.
   */
  @Override
