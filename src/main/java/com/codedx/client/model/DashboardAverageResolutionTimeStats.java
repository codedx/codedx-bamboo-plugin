...
/**
 * DashboardAverageResolutionTimeStats
 */
@JsonPropertyOrder({
  DashboardAverageResolutionTimeStats.JSON_PROPERTY_NUM_FINDINGS,
  DashboardAverageResolutionTimeStats.JSON_PROPERTY_TOTAL_NUM_DAYS,
  DashboardAverageResolutionTimeStats.JSON_PROPERTY_AVG_NUM_DAYS
})
...
public class DashboardAverageResolutionTimeStats {
  public static final String JSON_PROPERTY_NUM_FINDINGS = "numFindings";
  @jakarta.annotation.Nonnull
  private Integer numFindings;

  public static final String JSON_PROPERTY_TOTAL_NUM_DAYS = "totalNumDays";
  @jakarta.annotation.Nonnull
  private Integer totalNumDays;

  public static final String JSON_PROPERTY_AVG_NUM_DAYS = "avgNumDays";
  @jakarta.annotation.Nonnull
  private BigDecimal avgNumDays;

  public DashboardAverageResolutionTimeStats() { 
  }

  public DashboardAverageResolutionTimeStats numFindings(@jakarta.annotation.Nonnull Integer numFindings) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_NUM_FINDINGS, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_FINDINGS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNumFindings(@jakarta.annotation.Nonnull Integer numFindings) {
    this.numFindings = numFindings;
  }


  public DashboardAverageResolutionTimeStats totalNumDays(@jakarta.annotation.Nonnull Integer totalNumDays) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_TOTAL_NUM_DAYS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Integer getTotalNumDays() {
    return totalNumDays;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TOTAL_NUM_DAYS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTotalNumDays(@jakarta.annotation.Nonnull Integer totalNumDays) {
    this.totalNumDays = totalNumDays;
  }


  public DashboardAverageResolutionTimeStats avgNumDays(@jakarta.annotation.Nonnull BigDecimal avgNumDays) {
    this.avgNumDays = avgNumDays;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_AVG_NUM_DAYS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public BigDecimal getAvgNumDays() {
    return avgNumDays;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_AVG_NUM_DAYS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAvgNumDays(@jakarta.annotation.Nonnull BigDecimal avgNumDays) {
    this.avgNumDays = avgNumDays;
  }


  /**
   * Return true if this DashboardAverageResolutionTimeStats object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardAverageResolutionTimeStats dashboardAverageResolutionTimeStats = (DashboardAverageResolutionTimeStats) o;
    return Objects.equals(this.numFindings, dashboardAverageResolutionTimeStats.numFindings) &&
        Objects.equals(this.totalNumDays, dashboardAverageResolutionTimeStats.totalNumDays) &&
        Objects.equals(this.avgNumDays, dashboardAverageResolutionTimeStats.avgNumDays);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numFindings, totalNumDays, avgNumDays);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardAverageResolutionTimeStats {\n");
    sb.append("    numFindings: ").append(toIndentedString(numFindings)).append("\n");
    sb.append("    totalNumDays: ").append(toIndentedString(totalNumDays)).append("\n");
    sb.append("    avgNumDays: ").append(toIndentedString(avgNumDays)).append("\n");
    sb.append("}");
    return sb.toString();
  }
