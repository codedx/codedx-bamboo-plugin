...
import com.codedx.client.model.DashboardLatest;
import com.codedx.client.model.DashboardSince;
...
@JsonDeserialize(using = DashboardDataRange.DashboardDataRangeDeserializer.class)
@JsonSerialize(using = DashboardDataRange.DashboardDataRangeSerializer.class)
public class DashboardDataRange extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DashboardDataRange.class.getName());

    public static class DashboardDataRangeSerializer extends StdSerializer<DashboardDataRange> {
        public DashboardDataRangeSerializer(Class<DashboardDataRange> t) {
            super(t);
        }

        public DashboardDataRangeSerializer() {
            this(null);
        }

        @Override
        public void serialize(DashboardDataRange value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class DashboardDataRangeDeserializer extends StdDeserializer<DashboardDataRange> {
        public DashboardDataRangeDeserializer() {
            this(DashboardDataRange.class);
        }

        public DashboardDataRangeDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public DashboardDataRange deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize DashboardLatest
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(DashboardLatest.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'DashboardLatest'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'DashboardLatest'", e);
            }

            // deserialize DashboardSince
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(DashboardSince.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'DashboardSince'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'DashboardSince'", e);
            }

            if (match == 1) {
                DashboardDataRange ret = new DashboardDataRange();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DashboardDataRange: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public DashboardDataRange getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "DashboardDataRange cannot be null");
        }
    }
    ...
    public DashboardDataRange(DashboardLatest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DashboardDataRange(DashboardSince o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("DashboardLatest", new GenericType<DashboardLatest>() {
        });
        schemas.put("DashboardSince", new GenericType<DashboardSince>() {
        });
        JSON.registerDescendants(DashboardDataRange.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return DashboardDataRange.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * DashboardLatest, DashboardSince
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(DashboardLatest.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(DashboardSince.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be DashboardLatest, DashboardSince");
    }
     ...
     * DashboardLatest, DashboardSince
     *
     * @return The actual instance (DashboardLatest, DashboardSince)
     */
    @Override
    ...
    /**
     * Get the actual instance of `DashboardLatest`. If the actual instance is not `DashboardLatest`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `DashboardLatest`
     * @throws ClassCastException if the instance is not `DashboardLatest`
     */
    public DashboardLatest getDashboardLatest() throws ClassCastException {
        return (DashboardLatest)super.getActualInstance();
    }

    /**
     * Get the actual instance of `DashboardSince`. If the actual instance is not `DashboardSince`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `DashboardSince`
     * @throws ClassCastException if the instance is not `DashboardSince`
     */
    public DashboardSince getDashboardSince() throws ClassCastException {
        return (DashboardSince)super.getActualInstance();
    }
