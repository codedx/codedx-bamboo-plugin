...
/**
 * GetProjectAddInToolConfig200Response
 */
@JsonPropertyOrder({
  GetProjectAddInToolConfig200Response.JSON_PROPERTY_CONTENT,
  GetProjectAddInToolConfig200Response.JSON_PROPERTY_ALLOWED_SECRETS,
  GetProjectAddInToolConfig200Response.JSON_PROPERTY_IS_ENABLED
})
@JsonTypeName("getProjectAddInToolConfig_200_response")
...
public class GetProjectAddInToolConfig200Response {
  ...
  public GetProjectAddInToolConfig200Response() { 
  }

  public GetProjectAddInToolConfig200Response content(@jakarta.annotation.Nullable String content) {
    this.content = content;
    return this;
  }

  /**
   * The current customizable, Project-specific TOML configuration used for the Add-In Tool. All original TOML content is included by default except the &#x60;[request]&#x60; section, which can only be modified by an Admin
   * @return content
   */
  @jakarta.annotation.Nullable
  ...
  public GetProjectAddInToolConfig200Response allowedSecrets(@jakarta.annotation.Nullable List<String> allowedSecrets) {
    this.allowedSecrets = allowedSecrets;
    return this;
  }

  public GetProjectAddInToolConfig200Response addAllowedSecretsItem(String allowedSecretsItem) {
  ...
  /**
   * A case-sensitive list of Project secret names that are currently accessible to the Add-In Tool
  ...
  public GetProjectAddInToolConfig200Response isEnabled(@jakarta.annotation.Nullable Boolean isEnabled) {
    this.isEnabled = isEnabled;
    return this;
  }

  /**
   * Indicates whether or not this Add-In Tool is enabled for use in Analyses for the Project
   * @return isEnabled
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this getProjectAddInToolConfig_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetProjectAddInToolConfig200Response getProjectAddInToolConfig200Response = (GetProjectAddInToolConfig200Response) o;
    return Objects.equals(this.content, getProjectAddInToolConfig200Response.content) &&
        Objects.equals(this.allowedSecrets, getProjectAddInToolConfig200Response.allowedSecrets) &&
        Objects.equals(this.isEnabled, getProjectAddInToolConfig200Response.isEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(content, allowedSecrets, isEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetProjectAddInToolConfig200Response {\n");
