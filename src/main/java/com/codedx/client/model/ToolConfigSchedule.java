...
import com.codedx.client.model.ToolConfigScheduleInterval;
 ...
 */
@JsonPropertyOrder({
  ToolConfigSchedule.JSON_PROPERTY_NAME,
  ToolConfigSchedule.JSON_PROPERTY_INTERVAL,
  ToolConfigSchedule.JSON_PROPERTY_RUN_DURING_ANALYSIS
})
...
public class ToolConfigSchedule {
  ...
  @jakarta.annotation.Nullable
  private ToolConfigScheduleInterval interval;

  public static final String JSON_PROPERTY_RUN_DURING_ANALYSIS = "runDuringAnalysis";
  @jakarta.annotation.Nullable
  private Boolean runDuringAnalysis;

  public ToolConfigSchedule() { 
  }

  public ToolConfigSchedule name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ToolConfigSchedule interval(@jakarta.annotation.Nullable ToolConfigScheduleInterval interval) {
  ...
  public ToolConfigScheduleInterval getInterval() {
    return interval;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INTERVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInterval(@jakarta.annotation.Nullable ToolConfigScheduleInterval interval) {
    this.interval = interval;
  }


  public ToolConfigSchedule runDuringAnalysis(@jakarta.annotation.Nullable Boolean runDuringAnalysis) {
  ...
  /**
   * Return true if this ToolConfigSchedule object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ToolConfigSchedule toolConfigSchedule = (ToolConfigSchedule) o;
    return Objects.equals(this.name, toolConfigSchedule.name) &&
        Objects.equals(this.interval, toolConfigSchedule.interval) &&
        Objects.equals(this.runDuringAnalysis, toolConfigSchedule.runDuringAnalysis);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, interval, runDuringAnalysis);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ToolConfigSchedule {\n");
