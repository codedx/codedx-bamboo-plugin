...
import com.codedx.client.model.DashboardFindingCountsByDescriptor;
...
/**
 * DashboardDataFindingCountsByDescriptorInner
 */
@JsonPropertyOrder({
  DashboardDataFindingCountsByDescriptorInner.JSON_PROPERTY_DATE,
  DashboardDataFindingCountsByDescriptorInner.JSON_PROPERTY_DATA
})
@JsonTypeName("DashboardData_findingCountsByDescriptor_inner")
...
public class DashboardDataFindingCountsByDescriptorInner {
  ...
  @jakarta.annotation.Nullable
  private List<DashboardFindingCountsByDescriptor> data = new ArrayList<>();

  public DashboardDataFindingCountsByDescriptorInner() { 
  }

  public DashboardDataFindingCountsByDescriptorInner date(@jakarta.annotation.Nullable OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public DashboardDataFindingCountsByDescriptorInner data(@jakarta.annotation.Nullable List<DashboardFindingCountsByDescriptor> data) {
    this.data = data;
    return this;
  }

  public DashboardDataFindingCountsByDescriptorInner addDataItem(DashboardFindingCountsByDescriptor dataItem) {
    if (this.data == null) {
  ...
  public List<DashboardFindingCountsByDescriptor> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable List<DashboardFindingCountsByDescriptor> data) {
    this.data = data;
  }


  /**
   * Return true if this DashboardData_findingCountsByDescriptor_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardDataFindingCountsByDescriptorInner dashboardDataFindingCountsByDescriptorInner = (DashboardDataFindingCountsByDescriptorInner) o;
    return Objects.equals(this.date, dashboardDataFindingCountsByDescriptorInner.date) &&
        Objects.equals(this.data, dashboardDataFindingCountsByDescriptorInner.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardDataFindingCountsByDescriptorInner {\n");
