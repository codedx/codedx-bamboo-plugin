...
import com.codedx.client.model.DateTimeRangeSelectionOneOf;
import com.codedx.client.model.DateTimeRangeSelectionOneOf1;
import com.codedx.client.model.DateTimeRangeSelectionOneOf2;
...
@JsonDeserialize(using = DateTimeRangeSelection.DateTimeRangeSelectionDeserializer.class)
@JsonSerialize(using = DateTimeRangeSelection.DateTimeRangeSelectionSerializer.class)
public class DateTimeRangeSelection extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DateTimeRangeSelection.class.getName());

    public static class DateTimeRangeSelectionSerializer extends StdSerializer<DateTimeRangeSelection> {
        public DateTimeRangeSelectionSerializer(Class<DateTimeRangeSelection> t) {
            super(t);
        }

        public DateTimeRangeSelectionSerializer() {
            this(null);
        }

        @Override
        public void serialize(DateTimeRangeSelection value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class DateTimeRangeSelectionDeserializer extends StdDeserializer<DateTimeRangeSelection> {
        public DateTimeRangeSelectionDeserializer() {
            this(DateTimeRangeSelection.class);
        }

        public DateTimeRangeSelectionDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public DateTimeRangeSelection deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize DateTimeRangeSelectionOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(DateTimeRangeSelectionOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'DateTimeRangeSelectionOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'DateTimeRangeSelectionOneOf'", e);
            }

            // deserialize DateTimeRangeSelectionOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(DateTimeRangeSelectionOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'DateTimeRangeSelectionOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'DateTimeRangeSelectionOneOf1'", e);
            }

            // deserialize DateTimeRangeSelectionOneOf2
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(DateTimeRangeSelectionOneOf2.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'DateTimeRangeSelectionOneOf2'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'DateTimeRangeSelectionOneOf2'", e);
            }

            if (match == 1) {
                DateTimeRangeSelection ret = new DateTimeRangeSelection();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DateTimeRangeSelection: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public DateTimeRangeSelection getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "DateTimeRangeSelection cannot be null");
        }
    }
    ...
    public DateTimeRangeSelection(DateTimeRangeSelectionOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DateTimeRangeSelection(DateTimeRangeSelectionOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public DateTimeRangeSelection(DateTimeRangeSelectionOneOf2 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("DateTimeRangeSelectionOneOf", new GenericType<DateTimeRangeSelectionOneOf>() {
        });
        schemas.put("DateTimeRangeSelectionOneOf1", new GenericType<DateTimeRangeSelectionOneOf1>() {
        });
        schemas.put("DateTimeRangeSelectionOneOf2", new GenericType<DateTimeRangeSelectionOneOf2>() {
        });
        JSON.registerDescendants(DateTimeRangeSelection.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return DateTimeRangeSelection.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * DateTimeRangeSelectionOneOf, DateTimeRangeSelectionOneOf1, DateTimeRangeSelectionOneOf2
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(DateTimeRangeSelectionOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(DateTimeRangeSelectionOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(DateTimeRangeSelectionOneOf2.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be DateTimeRangeSelectionOneOf, DateTimeRangeSelectionOneOf1, DateTimeRangeSelectionOneOf2");
    }
     ...
     * DateTimeRangeSelectionOneOf, DateTimeRangeSelectionOneOf1, DateTimeRangeSelectionOneOf2
     *
     * @return The actual instance (DateTimeRangeSelectionOneOf, DateTimeRangeSelectionOneOf1, DateTimeRangeSelectionOneOf2)
     */
    @Override
    ...
    /**
     * Get the actual instance of `DateTimeRangeSelectionOneOf`. If the actual instance is not `DateTimeRangeSelectionOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `DateTimeRangeSelectionOneOf`
     * @throws ClassCastException if the instance is not `DateTimeRangeSelectionOneOf`
     */
    public DateTimeRangeSelectionOneOf getDateTimeRangeSelectionOneOf() throws ClassCastException {
        return (DateTimeRangeSelectionOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `DateTimeRangeSelectionOneOf1`. If the actual instance is not `DateTimeRangeSelectionOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `DateTimeRangeSelectionOneOf1`
     * @throws ClassCastException if the instance is not `DateTimeRangeSelectionOneOf1`
     */
    public DateTimeRangeSelectionOneOf1 getDateTimeRangeSelectionOneOf1() throws ClassCastException {
        return (DateTimeRangeSelectionOneOf1)super.getActualInstance();
    }

    /**
     * Get the actual instance of `DateTimeRangeSelectionOneOf2`. If the actual instance is not `DateTimeRangeSelectionOneOf2`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `DateTimeRangeSelectionOneOf2`
     * @throws ClassCastException if the instance is not `DateTimeRangeSelectionOneOf2`
     */
    public DateTimeRangeSelectionOneOf2 getDateTimeRangeSelectionOneOf2() throws ClassCastException {
        return (DateTimeRangeSelectionOneOf2)super.getActualInstance();
    }
