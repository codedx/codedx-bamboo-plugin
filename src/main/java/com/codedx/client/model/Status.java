...
@JsonPropertyOrder({
  ...
  Status.JSON_PROPERTY_DISPLAY,
  Status.JSON_PROPERTY_SETTABLE,
  Status.JSON_PROPERTY_ORDER,
  Status.JSON_PROPERTY_GROUP
})
...
public class Status {
  ...
  public Status id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Status type(@jakarta.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public Status display(@jakarta.annotation.Nullable String display) {
  ...
  public Status settable(@jakarta.annotation.Nullable Boolean settable) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SETTABLE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_SETTABLE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSettable(@jakarta.annotation.Nullable Boolean settable) {
    this.settable = settable;
  }


  public Status order(@jakarta.annotation.Nullable Integer order) {
    this.order = order;
    return this;
  }
  ...
  public Status group(@jakarta.annotation.Nullable Integer group) {
    this.group = group;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_GROUP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGroup(@jakarta.annotation.Nullable Integer group) {
    this.group = group;
  }
