...
/**
 * DynamicAddInToolDisplayTag
 */
@JsonPropertyOrder({
  DynamicAddInToolDisplayTag.JSON_PROPERTY_ID,
  DynamicAddInToolDisplayTag.JSON_PROPERTY_TOOL_INPUT,
  DynamicAddInToolDisplayTag.JSON_PROPERTY_ENABLED,
  DynamicAddInToolDisplayTag.JSON_PROPERTY_ENABLED_REASON
})
...
public class DynamicAddInToolDisplayTag {
  ...
  public DynamicAddInToolDisplayTag() { 
  }

  public DynamicAddInToolDisplayTag id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }

  /**
   * The unique ID of the dynamic Add-In Tool
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public DynamicAddInToolDisplayTag toolInput(@jakarta.annotation.Nullable String toolInput) {
    this.toolInput = toolInput;
    return this;
  }

  /**
   * The name of the dynamic Add-In Tool
   * @return toolInput
   */
  @jakarta.annotation.Nullable
  ...
  public DynamicAddInToolDisplayTag enabled(@jakarta.annotation.Nullable Boolean enabled) {
    this.enabled = enabled;
    return this;
  }

  /**
   * Indicates whether or not the tool is enabled and can be used in this Analysis
   * @return enabled
   */
  @jakarta.annotation.Nullable
  ...
  public DynamicAddInToolDisplayTag enabledReason(@jakarta.annotation.Nullable String enabledReason) {
    this.enabledReason = enabledReason;
    return this;
  }

  /**
   * Either \&quot;user\&quot; or \&quot;orchestration-config\&quot;. If the Add-In Tool is disabled in the Project&#39;s orchestration config, it will be disabled by \&quot;orchestration-config\&quot;. If the Analysis API is used to enable or disable a tag, it will be disabled by \&quot;user\&quot;.
  ...
  /**
   * Return true if this DynamicAddInToolDisplayTag object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DynamicAddInToolDisplayTag dynamicAddInToolDisplayTag = (DynamicAddInToolDisplayTag) o;
    return Objects.equals(this.id, dynamicAddInToolDisplayTag.id) &&
        Objects.equals(this.toolInput, dynamicAddInToolDisplayTag.toolInput) &&
        Objects.equals(this.enabled, dynamicAddInToolDisplayTag.enabled) &&
        Objects.equals(this.enabledReason, dynamicAddInToolDisplayTag.enabledReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, toolInput, enabled, enabledReason);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DynamicAddInToolDisplayTag {\n");
