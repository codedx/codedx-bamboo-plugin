 ...
 */
@JsonPropertyOrder({
  Cwe.JSON_PROPERTY_ID,
  Cwe.JSON_PROPERTY_NAME
})
...
public class Cwe {
  ...
  public Cwe id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Cwe name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   * Return true if this Cwe object is equal to o.
   */
  @Override
