...
/**
 * ToolConnectorStaticBindingCreateRef
 */
@JsonPropertyOrder({
  ToolConnectorStaticBindingCreateRef.JSON_PROPERTY_PROJECT_ID,
  ToolConnectorStaticBindingCreateRef.JSON_PROPERTY_BRANCH_NAME,
  ToolConnectorStaticBindingCreateRef.JSON_PROPERTY_CONNECTION_ENTITY_ID,
  ToolConnectorStaticBindingCreateRef.JSON_PROPERTY_SCHEDULE_ENTITY_ID,
  ToolConnectorStaticBindingCreateRef.JSON_PROPERTY_OPTION_ENTITY_ID,
  ToolConnectorStaticBindingCreateRef.JSON_PROPERTY_PROJECT_ENTITY_ID,
  ToolConnectorStaticBindingCreateRef.JSON_PROPERTY_VERSION_ENTITY_ID,
  ToolConnectorStaticBindingCreateRef.JSON_PROPERTY_ENABLED
})
...
public class ToolConnectorStaticBindingCreateRef {
  ...
  public ToolConnectorStaticBindingCreateRef() { 
  }

  public ToolConnectorStaticBindingCreateRef projectId(@jakarta.annotation.Nullable Integer projectId) {
  ...
  public ToolConnectorStaticBindingCreateRef branchName(@jakarta.annotation.Nullable String branchName) {
  ...
  public ToolConnectorStaticBindingCreateRef connectionEntityId(@jakarta.annotation.Nullable Integer connectionEntityId) {
  ...
  public ToolConnectorStaticBindingCreateRef scheduleEntityId(@jakarta.annotation.Nullable Integer scheduleEntityId) {
  ...
  public ToolConnectorStaticBindingCreateRef optionEntityId(@jakarta.annotation.Nullable Integer optionEntityId) {
  ...
  public ToolConnectorStaticBindingCreateRef projectEntityId(@jakarta.annotation.Nullable Integer projectEntityId) {
  ...
  public ToolConnectorStaticBindingCreateRef versionEntityId(@jakarta.annotation.Nullable Integer versionEntityId) {
  ...
  public ToolConnectorStaticBindingCreateRef enabled(@jakarta.annotation.Nullable Boolean enabled) {
  ...
  /**
   * Return true if this ToolConnectorStaticBindingCreateRef object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ToolConnectorStaticBindingCreateRef toolConnectorStaticBindingCreateRef = (ToolConnectorStaticBindingCreateRef) o;
    return Objects.equals(this.projectId, toolConnectorStaticBindingCreateRef.projectId) &&
        Objects.equals(this.branchName, toolConnectorStaticBindingCreateRef.branchName) &&
        Objects.equals(this.connectionEntityId, toolConnectorStaticBindingCreateRef.connectionEntityId) &&
        Objects.equals(this.scheduleEntityId, toolConnectorStaticBindingCreateRef.scheduleEntityId) &&
        Objects.equals(this.optionEntityId, toolConnectorStaticBindingCreateRef.optionEntityId) &&
        Objects.equals(this.projectEntityId, toolConnectorStaticBindingCreateRef.projectEntityId) &&
        Objects.equals(this.versionEntityId, toolConnectorStaticBindingCreateRef.versionEntityId) &&
        Objects.equals(this.enabled, toolConnectorStaticBindingCreateRef.enabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectId, branchName, connectionEntityId, scheduleEntityId, optionEntityId, projectEntityId, versionEntityId, enabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ToolConnectorStaticBindingCreateRef {\n");
