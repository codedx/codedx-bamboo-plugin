...
public class Sort {
  ...
  public Sort by(@jakarta.annotation.Nullable SortDescriptor by) {
    this.by = by;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_BY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBy(@jakarta.annotation.Nullable SortDescriptor by) {
    this.by = by;
  }


  public Sort direction(@jakarta.annotation.Nullable SortDirection direction) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DIRECTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDirection(@jakarta.annotation.Nullable SortDirection direction) {
    this.direction = direction;
  }


  /**
   * Return true if this Sort object is equal to o.
   */
  @Override
