...
/**
 * A role granted to a user or user-group, in relation to a shareable entity such as a saved filter. May be &#x60;\&quot;view\&quot;&#x60;, &#x60;\&quot;edit\&quot;&#x60;, or &#x60;null&#x60;. A user view the &#x60;\&quot;view\&quot;&#x60; role has read-only access the details of the entity. A user with the &#x60;\&quot;edit\&quot;&#x60; role has full access to the entity, including the ability to rename, overwrite, delete, and manage permissions for that entity. A user with a &#x60;null&#x60; role does not have access to the entity.
 */
public enum SharingRole {
  ...
  @JsonCreator
  public static SharingRole fromValue(String value) {
    for (SharingRole b : SharingRole.values()) {
