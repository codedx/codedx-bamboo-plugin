 ...
 */
@JsonPropertyOrder({
  AnalysisQueryResponse.JSON_PROPERTY_INPUT_IDS,
  AnalysisQueryResponse.JSON_PROPERTY_VERIFICATION_ERRORS
})
...
public class AnalysisQueryResponse {
  public static final String JSON_PROPERTY_INPUT_IDS = "inputIds";
  ...
  public AnalysisQueryResponse() { 
  }

  public AnalysisQueryResponse inputIds(@jakarta.annotation.Nullable List<String> inputIds) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INPUT_IDS, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_INPUT_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInputIds(@jakarta.annotation.Nullable List<String> inputIds) {
    this.inputIds = inputIds;
  }


  public AnalysisQueryResponse verificationErrors(@jakarta.annotation.Nullable List<String> verificationErrors) {
  ...
  /**
   * Return true if this AnalysisQueryResponse object is equal to o.
   */
  @Override
