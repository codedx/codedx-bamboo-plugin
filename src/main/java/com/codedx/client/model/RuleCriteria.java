 ...
 */
@JsonPropertyOrder({
  RuleCriteria.JSON_PROPERTY_TYPE,
  RuleCriteria.JSON_PROPERTY_TOOL,
  RuleCriteria.JSON_PROPERTY_CODE,
  RuleCriteria.JSON_PROPERTY_CWE_ID,
  RuleCriteria.JSON_PROPERTY_CATEGORY
})
...
public class RuleCriteria {
  ...
  public RuleCriteria type(@jakarta.annotation.Nullable RuleCriteriaType type) {
    this.type = type;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setType(@jakarta.annotation.Nullable RuleCriteriaType type) {
    this.type = type;
  }


  public RuleCriteria tool(@jakarta.annotation.Nullable String tool) {
    this.tool = tool;
    return this;
  }
  ...
  public RuleCriteria code(@jakarta.annotation.Nullable List<String> code) {
    this.code = code;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CODE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCode(@jakarta.annotation.Nullable List<String> code) {
    this.code = code;
  }


  public RuleCriteria cweId(@jakarta.annotation.Nullable Integer cweId) {
    this.cweId = cweId;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CWE_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CWE_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCweId(@jakarta.annotation.Nullable Integer cweId) {
    this.cweId = cweId;
  }


  public RuleCriteria category(@jakarta.annotation.Nullable String category) {
  ...
  /**
   * Return true if this RuleCriteria object is equal to o.
   */
  @Override
