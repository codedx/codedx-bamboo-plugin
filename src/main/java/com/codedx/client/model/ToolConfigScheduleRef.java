...
import com.codedx.client.model.ToolConfigScheduleRefInterval;
...
/**
 * ToolConfigScheduleRef
 */
@JsonPropertyOrder({
  ToolConfigScheduleRef.JSON_PROPERTY_ID,
  ToolConfigScheduleRef.JSON_PROPERTY_IS_GLOBAL_DEFAULT,
  ToolConfigScheduleRef.JSON_PROPERTY_IS_TOOL_DEFAULT,
  ToolConfigScheduleRef.JSON_PROPERTY_NAME,
  ToolConfigScheduleRef.JSON_PROPERTY_INTERVAL,
  ToolConfigScheduleRef.JSON_PROPERTY_RUN_DURING_ANALYSIS
})
...
public class ToolConfigScheduleRef {
  public static final String JSON_PROPERTY_ID = "id";
  @jakarta.annotation.Nullable
  private Integer id;

  public static final String JSON_PROPERTY_IS_GLOBAL_DEFAULT = "isGlobalDefault";
  @jakarta.annotation.Nullable
  private Boolean isGlobalDefault;

  public static final String JSON_PROPERTY_IS_TOOL_DEFAULT = "isToolDefault";
  @jakarta.annotation.Nullable
  private Boolean isToolDefault;
  ...
  @jakarta.annotation.Nullable
  private ToolConfigScheduleRefInterval interval;

  public static final String JSON_PROPERTY_RUN_DURING_ANALYSIS = "runDuringAnalysis";
  @jakarta.annotation.Nullable
  private Boolean runDuringAnalysis;

  public ToolConfigScheduleRef() { 
  }

  public ToolConfigScheduleRef id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ToolConfigScheduleRef isGlobalDefault(@jakarta.annotation.Nullable Boolean isGlobalDefault) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_GLOBAL_DEFAULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_GLOBAL_DEFAULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsGlobalDefault(@jakarta.annotation.Nullable Boolean isGlobalDefault) {
    this.isGlobalDefault = isGlobalDefault;
  }


  public ToolConfigScheduleRef isToolDefault(@jakarta.annotation.Nullable Boolean isToolDefault) {
    this.isToolDefault = isToolDefault;
    return this;
  }

  /**
   * Get isToolDefault
   * @return isToolDefault
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_TOOL_DEFAULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getIsToolDefault() {
    return isToolDefault;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_TOOL_DEFAULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsToolDefault(@jakarta.annotation.Nullable Boolean isToolDefault) {
    this.isToolDefault = isToolDefault;
  }


  public ToolConfigScheduleRef name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ToolConfigScheduleRef interval(@jakarta.annotation.Nullable ToolConfigScheduleRefInterval interval) {
  ...
  public ToolConfigScheduleRefInterval getInterval() {
    return interval;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INTERVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInterval(@jakarta.annotation.Nullable ToolConfigScheduleRefInterval interval) {
    this.interval = interval;
  }


  public ToolConfigScheduleRef runDuringAnalysis(@jakarta.annotation.Nullable Boolean runDuringAnalysis) {
    this.runDuringAnalysis = runDuringAnalysis;
    return this;
  }

  /**
   * Get runDuringAnalysis
   * @return runDuringAnalysis
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RUN_DURING_ANALYSIS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getRunDuringAnalysis() {
    return runDuringAnalysis;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RUN_DURING_ANALYSIS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRunDuringAnalysis(@jakarta.annotation.Nullable Boolean runDuringAnalysis) {
    this.runDuringAnalysis = runDuringAnalysis;
  }


  /**
   * Return true if this ToolConfigScheduleRef object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ToolConfigScheduleRef toolConfigScheduleRef = (ToolConfigScheduleRef) o;
    return Objects.equals(this.id, toolConfigScheduleRef.id) &&
        Objects.equals(this.isGlobalDefault, toolConfigScheduleRef.isGlobalDefault) &&
        Objects.equals(this.isToolDefault, toolConfigScheduleRef.isToolDefault) &&
        Objects.equals(this.name, toolConfigScheduleRef.name) &&
        Objects.equals(this.interval, toolConfigScheduleRef.interval) &&
        Objects.equals(this.runDuringAnalysis, toolConfigScheduleRef.runDuringAnalysis);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, isGlobalDefault, isToolDefault, name, interval, runDuringAnalysis);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ToolConfigScheduleRef {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    isGlobalDefault: ").append(toIndentedString(isGlobalDefault)).append("\n");
    sb.append("    isToolDefault: ").append(toIndentedString(isToolDefault)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    interval: ").append(toIndentedString(interval)).append("\n");
    sb.append("    runDuringAnalysis: ").append(toIndentedString(runDuringAnalysis)).append("\n");
    sb.append("}");
    return sb.toString();
  }
