...
import com.codedx.client.model.PolicySavedFilterRule;
 ...
 */
@JsonPropertyOrder({
  PolicyUpdate.JSON_PROPERTY_NAME,
  PolicyUpdate.JSON_PROPERTY_DESCRIPTION,
  PolicyUpdate.JSON_PROPERTY_RULES,
  PolicyUpdate.JSON_PROPERTY_ADD_PROJECT_IDS,
  PolicyUpdate.JSON_PROPERTY_REMOVE_PROJECT_IDS
})
...
public class PolicyUpdate {
  ...
  @jakarta.annotation.Nullable
  private List<PolicySavedFilterRule> rules = new ArrayList<>();

  public static final String JSON_PROPERTY_ADD_PROJECT_IDS = "addProjectIds";
  @jakarta.annotation.Nullable
  private List<Integer> addProjectIds = new ArrayList<>();

  public static final String JSON_PROPERTY_REMOVE_PROJECT_IDS = "removeProjectIds";
  @jakarta.annotation.Nullable
  private List<Integer> removeProjectIds = new ArrayList<>();

  public PolicyUpdate() { 
  }

  public PolicyUpdate name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PolicyUpdate description(@jakarta.annotation.Nullable String description) {
  ...
  public PolicyUpdate rules(@jakarta.annotation.Nullable List<PolicySavedFilterRule> rules) {
    this.rules = rules;
    return this;
  }

  public PolicyUpdate addRulesItem(PolicySavedFilterRule rulesItem) {
    if (this.rules == null) {
  ...
  public List<PolicySavedFilterRule> getRules() {
    return rules;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RULES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRules(@jakarta.annotation.Nullable List<PolicySavedFilterRule> rules) {
    this.rules = rules;
  }


  public PolicyUpdate addProjectIds(@jakarta.annotation.Nullable List<Integer> addProjectIds) {
    this.addProjectIds = addProjectIds;
    return this;
  }

  public PolicyUpdate addAddProjectIdsItem(Integer addProjectIdsItem) {
    if (this.addProjectIds == null) {
      this.addProjectIds = new ArrayList<>();
    }
    this.addProjectIds.add(addProjectIdsItem);
    return this;
  }

  /**
   * An array of projects to be associated to the policy, denoted by id
   * @return addProjectIds
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ADD_PROJECT_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<Integer> getAddProjectIds() {
    return addProjectIds;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ADD_PROJECT_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAddProjectIds(@jakarta.annotation.Nullable List<Integer> addProjectIds) {
    this.addProjectIds = addProjectIds;
  }


  public PolicyUpdate removeProjectIds(@jakarta.annotation.Nullable List<Integer> removeProjectIds) {
    this.removeProjectIds = removeProjectIds;
    return this;
  }

  public PolicyUpdate addRemoveProjectIdsItem(Integer removeProjectIdsItem) {
    if (this.removeProjectIds == null) {
      this.removeProjectIds = new ArrayList<>();
    }
    this.removeProjectIds.add(removeProjectIdsItem);
    return this;
  }

  /**
   * An array of projects to be unassociated to the policy, denoted by id
   * @return removeProjectIds
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_REMOVE_PROJECT_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<Integer> getRemoveProjectIds() {
    return removeProjectIds;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_REMOVE_PROJECT_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRemoveProjectIds(@jakarta.annotation.Nullable List<Integer> removeProjectIds) {
    this.removeProjectIds = removeProjectIds;
  }


  /**
   * Return true if this PolicyUpdate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, policyUpdate.name) &&
        ...
        Objects.equals(this.rules, policyUpdate.rules) &&
        Objects.equals(this.addProjectIds, policyUpdate.addProjectIds) &&
        Objects.equals(this.removeProjectIds, policyUpdate.removeProjectIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, rules, addProjectIds, removeProjectIds);
  }
  ...
  public String toString() {
    ...
    sb.append("    addProjectIds: ").append(toIndentedString(addProjectIds)).append("\n");
    sb.append("    removeProjectIds: ").append(toIndentedString(removeProjectIds)).append("\n");
    sb.append("}");
    return sb.toString();
  }
