...
/**
 * A fixed interval, representing &#39;every &lt;n&gt; hours and &lt;m&gt; minutes&#39;
 */
@JsonPropertyOrder({
  AutoUpdateSettingOneOf.JSON_PROPERTY_TYPE,
  AutoUpdateSettingOneOf.JSON_PROPERTY_NUM_HOURS,
  AutoUpdateSettingOneOf.JSON_PROPERTY_NUM_MINUTES
})
@JsonTypeName("AutoUpdateSetting_oneOf")
...
public class AutoUpdateSettingOneOf {
  /**
   * Gets or Sets type
   */
  ...
  public static final String JSON_PROPERTY_NUM_HOURS = "numHours";
  @jakarta.annotation.Nonnull
  private BigDecimal numHours;

  public static final String JSON_PROPERTY_NUM_MINUTES = "numMinutes";
  @jakarta.annotation.Nonnull
  private BigDecimal numMinutes;

  public AutoUpdateSettingOneOf() { 
  }

  public AutoUpdateSettingOneOf type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AutoUpdateSettingOneOf numHours(@jakarta.annotation.Nonnull BigDecimal numHours) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_NUM_HOURS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_HOURS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNumHours(@jakarta.annotation.Nonnull BigDecimal numHours) {
    this.numHours = numHours;
  }


  public AutoUpdateSettingOneOf numMinutes(@jakarta.annotation.Nonnull BigDecimal numMinutes) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_NUM_MINUTES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_MINUTES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNumMinutes(@jakarta.annotation.Nonnull BigDecimal numMinutes) {
    this.numMinutes = numMinutes;
  }


  /**
   * Return true if this AutoUpdateSetting_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AutoUpdateSettingOneOf autoUpdateSettingOneOf = (AutoUpdateSettingOneOf) o;
    return Objects.equals(this.type, autoUpdateSettingOneOf.type) &&
        Objects.equals(this.numHours, autoUpdateSettingOneOf.numHours) &&
        Objects.equals(this.numMinutes, autoUpdateSettingOneOf.numMinutes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, numHours, numMinutes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AutoUpdateSettingOneOf {\n");
