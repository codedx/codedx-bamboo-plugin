...
import com.codedx.client.model.DashboardAnalysisCountByMethod;
...
/**
 * DashboardAnalysisCountsByMethod
 */
@JsonPropertyOrder({
  DashboardAnalysisCountsByMethod.JSON_PROPERTY_OVERALL_ANALYSIS_COUNT,
  DashboardAnalysisCountsByMethod.JSON_PROPERTY_BY_DETECTION_METHOD
})
...
public class DashboardAnalysisCountsByMethod {
  public static final String JSON_PROPERTY_OVERALL_ANALYSIS_COUNT = "overallAnalysisCount";
  @jakarta.annotation.Nullable
  private Integer overallAnalysisCount;

  public static final String JSON_PROPERTY_BY_DETECTION_METHOD = "byDetectionMethod";
  @jakarta.annotation.Nullable
  private List<DashboardAnalysisCountByMethod> byDetectionMethod = new ArrayList<>();

  public DashboardAnalysisCountsByMethod() { 
  }

  public DashboardAnalysisCountsByMethod overallAnalysisCount(@jakarta.annotation.Nullable Integer overallAnalysisCount) {
    this.overallAnalysisCount = overallAnalysisCount;
    return this;
  }

  /**
   * Get overallAnalysisCount
   * @return overallAnalysisCount
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_OVERALL_ANALYSIS_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getOverallAnalysisCount() {
    return overallAnalysisCount;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_OVERALL_ANALYSIS_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOverallAnalysisCount(@jakarta.annotation.Nullable Integer overallAnalysisCount) {
    this.overallAnalysisCount = overallAnalysisCount;
  }


  public DashboardAnalysisCountsByMethod byDetectionMethod(@jakarta.annotation.Nullable List<DashboardAnalysisCountByMethod> byDetectionMethod) {
    this.byDetectionMethod = byDetectionMethod;
    return this;
  }

  public DashboardAnalysisCountsByMethod addByDetectionMethodItem(DashboardAnalysisCountByMethod byDetectionMethodItem) {
    if (this.byDetectionMethod == null) {
      this.byDetectionMethod = new ArrayList<>();
    }
    this.byDetectionMethod.add(byDetectionMethodItem);
    return this;
  }

  /**
   * Get byDetectionMethod
   * @return byDetectionMethod
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_BY_DETECTION_METHOD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<DashboardAnalysisCountByMethod> getByDetectionMethod() {
    return byDetectionMethod;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_BY_DETECTION_METHOD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setByDetectionMethod(@jakarta.annotation.Nullable List<DashboardAnalysisCountByMethod> byDetectionMethod) {
    this.byDetectionMethod = byDetectionMethod;
  }


  /**
   * Return true if this DashboardAnalysisCountsByMethod object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardAnalysisCountsByMethod dashboardAnalysisCountsByMethod = (DashboardAnalysisCountsByMethod) o;
    return Objects.equals(this.overallAnalysisCount, dashboardAnalysisCountsByMethod.overallAnalysisCount) &&
        Objects.equals(this.byDetectionMethod, dashboardAnalysisCountsByMethod.byDetectionMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(overallAnalysisCount, byDetectionMethod);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardAnalysisCountsByMethod {\n");
    sb.append("    overallAnalysisCount: ").append(toIndentedString(overallAnalysisCount)).append("\n");
    sb.append("    byDetectionMethod: ").append(toIndentedString(byDetectionMethod)).append("\n");
    sb.append("}");
    return sb.toString();
  }
