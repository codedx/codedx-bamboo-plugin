 ...
 */
@JsonPropertyOrder({
  DisabledToolResultsCount.JSON_PROPERTY_COUNT
})
...
public class DisabledToolResultsCount {
  ...
  public DisabledToolResultsCount() { 
  }

  public DisabledToolResultsCount count(@jakarta.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  /**
   * Return true if this DisabledToolResultsCount object is equal to o.
   */
  @Override
