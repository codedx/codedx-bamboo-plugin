...
/**
 * ToolConnectorFormsResponse
 */
@JsonPropertyOrder({
  ToolConnectorFormsResponse.JSON_PROPERTY_CONNECTION,
  ToolConnectorFormsResponse.JSON_PROPERTY_OPTIONS,
  ToolConnectorFormsResponse.JSON_PROPERTY_PROJECT,
  ToolConnectorFormsResponse.JSON_PROPERTY_VERSION,
  ToolConnectorFormsResponse.JSON_PROPERTY_SUPPORTS_DYNAMIC_VERSION
})
...
public class ToolConnectorFormsResponse {
  public static final String JSON_PROPERTY_CONNECTION = "connection";
  @jakarta.annotation.Nullable
  private List<FormSpecifierInner> connection = new ArrayList<>();

  public static final String JSON_PROPERTY_OPTIONS = "options";
  @jakarta.annotation.Nullable
  private List<FormSpecifierInner> options = new ArrayList<>();

  public static final String JSON_PROPERTY_PROJECT = "project";
  @jakarta.annotation.Nullable
  private List<FormSpecifierInner> project = new ArrayList<>();

  public static final String JSON_PROPERTY_VERSION = "version";
  @jakarta.annotation.Nullable
  private List<FormSpecifierInner> version = new ArrayList<>();

  public static final String JSON_PROPERTY_SUPPORTS_DYNAMIC_VERSION = "supportsDynamicVersion";
  @jakarta.annotation.Nullable
  private Boolean supportsDynamicVersion;

  public ToolConnectorFormsResponse() { 
  }

  public ToolConnectorFormsResponse connection(@jakarta.annotation.Nullable List<FormSpecifierInner> connection) {
    this.connection = connection;
    return this;
  }

  public ToolConnectorFormsResponse addConnectionItem(FormSpecifierInner connectionItem) {
  ...
  public List<FormSpecifierInner> getConnection() {
    return connection;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONNECTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConnection(@jakarta.annotation.Nullable List<FormSpecifierInner> connection) {
    this.connection = connection;
  }


  public ToolConnectorFormsResponse options(@jakarta.annotation.Nullable List<FormSpecifierInner> options) {
    this.options = options;
    return this;
  }

  public ToolConnectorFormsResponse addOptionsItem(FormSpecifierInner optionsItem) {
  ...
  public List<FormSpecifierInner> getOptions() {
    return options;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_OPTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptions(@jakarta.annotation.Nullable List<FormSpecifierInner> options) {
    this.options = options;
  }


  public ToolConnectorFormsResponse project(@jakarta.annotation.Nullable List<FormSpecifierInner> project) {
    this.project = project;
    return this;
  }

  public ToolConnectorFormsResponse addProjectItem(FormSpecifierInner projectItem) {
  ...
  public List<FormSpecifierInner> getProject() {
    return project;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProject(@jakarta.annotation.Nullable List<FormSpecifierInner> project) {
    this.project = project;
  }


  public ToolConnectorFormsResponse version(@jakarta.annotation.Nullable List<FormSpecifierInner> version) {
    this.version = version;
    return this;
  }

  public ToolConnectorFormsResponse addVersionItem(FormSpecifierInner versionItem) {
  ...
  public List<FormSpecifierInner> getVersion() {
    return version;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_VERSION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVersion(@jakarta.annotation.Nullable List<FormSpecifierInner> version) {
    this.version = version;
  }


  public ToolConnectorFormsResponse supportsDynamicVersion(@jakarta.annotation.Nullable Boolean supportsDynamicVersion) {
    this.supportsDynamicVersion = supportsDynamicVersion;
    return this;
  }

  /**
   * Get supportsDynamicVersion
   * @return supportsDynamicVersion
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SUPPORTS_DYNAMIC_VERSION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getSupportsDynamicVersion() {
    return supportsDynamicVersion;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SUPPORTS_DYNAMIC_VERSION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSupportsDynamicVersion(@jakarta.annotation.Nullable Boolean supportsDynamicVersion) {
    this.supportsDynamicVersion = supportsDynamicVersion;
  }


  /**
   * Return true if this ToolConnectorFormsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ToolConnectorFormsResponse toolConnectorFormsResponse = (ToolConnectorFormsResponse) o;
    return Objects.equals(this.connection, toolConnectorFormsResponse.connection) &&
        Objects.equals(this.options, toolConnectorFormsResponse.options) &&
        Objects.equals(this.project, toolConnectorFormsResponse.project) &&
        Objects.equals(this.version, toolConnectorFormsResponse.version) &&
        Objects.equals(this.supportsDynamicVersion, toolConnectorFormsResponse.supportsDynamicVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connection, options, project, version, supportsDynamicVersion);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ToolConnectorFormsResponse {\n");
    sb.append("    connection: ").append(toIndentedString(connection)).append("\n");
    sb.append("    options: ").append(toIndentedString(options)).append("\n");
    sb.append("    project: ").append(toIndentedString(project)).append("\n");
    sb.append("    version: ").append(toIndentedString(version)).append("\n");
    sb.append("    supportsDynamicVersion: ").append(toIndentedString(supportsDynamicVersion)).append("\n");
    sb.append("}");
    return sb.toString();
  }
