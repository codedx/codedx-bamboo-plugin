 ...
 */
@JsonPropertyOrder({
  RiskCounts.JSON_PROPERTY_CRITICAL,
  RiskCounts.JSON_PROPERTY_HIGH,
  RiskCounts.JSON_PROPERTY_MEDIUM,
  RiskCounts.JSON_PROPERTY_LOW
})
...
public class RiskCounts {
  ...
  public RiskCounts critical(@jakarta.annotation.Nullable Integer critical) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CRITICAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCritical(@jakarta.annotation.Nullable Integer critical) {
    this.critical = critical;
  }


  public RiskCounts high(@jakarta.annotation.Nullable Integer high) {
    this.high = high;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_HIGH, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHigh(@jakarta.annotation.Nullable Integer high) {
    this.high = high;
  }


  public RiskCounts medium(@jakarta.annotation.Nullable Integer medium) {
    this.medium = medium;
    return this;
  }
  ...
  public RiskCounts low(@jakarta.annotation.Nullable Integer low) {
    this.low = low;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_LOW, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLow(@jakarta.annotation.Nullable Integer low) {
    this.low = low;
  }


  /**
   * Return true if this RiskCounts object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RiskCounts riskCounts = (RiskCounts) o;
    return Objects.equals(this.critical, riskCounts.critical) &&
        Objects.equals(this.high, riskCounts.high) &&
        Objects.equals(this.medium, riskCounts.medium) &&
        Objects.equals(this.low, riskCounts.low);
  }
