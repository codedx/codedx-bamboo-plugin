...
/**
 * VersionConfigurationEntry
 */
@JsonPropertyOrder({
  VersionConfigurationEntry.JSON_PROPERTY_CONNECTION_ENTITY_ID,
  VersionConfigurationEntry.JSON_PROPERTY_PROJECT_ENTITY_ID,
  VersionConfigurationEntry.JSON_PROPERTY_VERSION_ENTITY,
  VersionConfigurationEntry.JSON_PROPERTY_BRANCH,
  VersionConfigurationEntry.JSON_PROPERTY_SYNC_VERSION_NAME,
  VersionConfigurationEntry.JSON_PROPERTY_IGNORE_UNSUPPORTED_SYNC
})
...
public class VersionConfigurationEntry {
  ...
  @jakarta.annotation.Nullable
  private CreateNewEntity versionEntity;
  ...
  public VersionConfigurationEntry() { 
  }

  public VersionConfigurationEntry connectionEntityId(@jakarta.annotation.Nullable Integer connectionEntityId) {
  ...
  public VersionConfigurationEntry projectEntityId(@jakarta.annotation.Nullable Integer projectEntityId) {
  ...
  public VersionConfigurationEntry versionEntity(@jakarta.annotation.Nullable CreateNewEntity versionEntity) {
  ...
  public CreateNewEntity getVersionEntity() {
    return versionEntity;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_VERSION_ENTITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVersionEntity(@jakarta.annotation.Nullable CreateNewEntity versionEntity) {
    this.versionEntity = versionEntity;
  }


  public VersionConfigurationEntry branch(@jakarta.annotation.Nullable String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public VersionConfigurationEntry syncVersionName(@jakarta.annotation.Nullable Boolean syncVersionName) {
  ...
  public VersionConfigurationEntry ignoreUnsupportedSync(@jakarta.annotation.Nullable Boolean ignoreUnsupportedSync) {
    this.ignoreUnsupportedSync = ignoreUnsupportedSync;
    return this;
  }

  /**
   * Ignores syncVersionName if the connector does not support version name syncing
  ...
  /**
   * Return true if this VersionConfigurationEntry object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    VersionConfigurationEntry versionConfigurationEntry = (VersionConfigurationEntry) o;
    return Objects.equals(this.connectionEntityId, versionConfigurationEntry.connectionEntityId) &&
        Objects.equals(this.projectEntityId, versionConfigurationEntry.projectEntityId) &&
        Objects.equals(this.versionEntity, versionConfigurationEntry.versionEntity) &&
        Objects.equals(this.branch, versionConfigurationEntry.branch) &&
        Objects.equals(this.syncVersionName, versionConfigurationEntry.syncVersionName) &&
        Objects.equals(this.ignoreUnsupportedSync, versionConfigurationEntry.ignoreUnsupportedSync);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectionEntityId, projectEntityId, versionEntity, branch, syncVersionName, ignoreUnsupportedSync);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VersionConfigurationEntry {\n");
