...
/**
 * ProjectFilterSelectionsOneOf1
 */
@JsonPropertyOrder({
  ProjectFilterSelectionsOneOf1.JSON_PROPERTY_FLAT
})
@JsonTypeName("ProjectFilterSelections_oneOf_1")
...
public class ProjectFilterSelectionsOneOf1 {
  public static final String JSON_PROPERTY_FLAT = "flat";
  @jakarta.annotation.Nonnull
  private List<NamePath> flat = new ArrayList<>();

  public ProjectFilterSelectionsOneOf1() { 
  }

  public ProjectFilterSelectionsOneOf1 flat(@jakarta.annotation.Nonnull List<NamePath> flat) {
    this.flat = flat;
    return this;
  }

  public ProjectFilterSelectionsOneOf1 addFlatItem(NamePath flatItem) {
    if (this.flat == null) {
      this.flat = new ArrayList<>();
    }
    this.flat.add(flatItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_FLAT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<NamePath> getFlat() {
    return flat;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FLAT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFlat(@jakarta.annotation.Nonnull List<NamePath> flat) {
    this.flat = flat;
  }


  /**
   * Return true if this ProjectFilterSelections_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ProjectFilterSelectionsOneOf1 projectFilterSelectionsOneOf1 = (ProjectFilterSelectionsOneOf1) o;
    return Objects.equals(this.flat, projectFilterSelectionsOneOf1.flat);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectFilterSelectionsOneOf1 {\n");
