...
import com.codedx.client.model.BulkSetDefaultScheduleRequestProjectDefaultScopesInner;
...
/**
 * DefaultEntitiesForToolProjectDefaultsInner
 */
@JsonPropertyOrder({
  DefaultEntitiesForToolProjectDefaultsInner.JSON_PROPERTY_TOOL_DEFAULT,
  DefaultEntitiesForToolProjectDefaultsInner.JSON_PROPERTY_PROJECT_DEFAULT_SCOPE
})
@JsonTypeName("DefaultEntitiesForTool_projectDefaults_inner")
...
public class DefaultEntitiesForToolProjectDefaultsInner {
  public static final String JSON_PROPERTY_TOOL_DEFAULT = "toolDefault";
  @jakarta.annotation.Nullable
  private Integer toolDefault;

  public static final String JSON_PROPERTY_PROJECT_DEFAULT_SCOPE = "projectDefaultScope";
  @jakarta.annotation.Nullable
  private BulkSetDefaultScheduleRequestProjectDefaultScopesInner projectDefaultScope;

  public DefaultEntitiesForToolProjectDefaultsInner() { 
  }

  public DefaultEntitiesForToolProjectDefaultsInner toolDefault(@jakarta.annotation.Nullable Integer toolDefault) {
  ...
  public DefaultEntitiesForToolProjectDefaultsInner projectDefaultScope(@jakarta.annotation.Nullable BulkSetDefaultScheduleRequestProjectDefaultScopesInner projectDefaultScope) {
    this.projectDefaultScope = projectDefaultScope;
    return this;
  }

  /**
   * Get projectDefaultScope
   * @return projectDefaultScope
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PROJECT_DEFAULT_SCOPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public BulkSetDefaultScheduleRequestProjectDefaultScopesInner getProjectDefaultScope() {
    return projectDefaultScope;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT_DEFAULT_SCOPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjectDefaultScope(@jakarta.annotation.Nullable BulkSetDefaultScheduleRequestProjectDefaultScopesInner projectDefaultScope) {
    this.projectDefaultScope = projectDefaultScope;
  }


  /**
   * Return true if this DefaultEntitiesForTool_projectDefaults_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DefaultEntitiesForToolProjectDefaultsInner defaultEntitiesForToolProjectDefaultsInner = (DefaultEntitiesForToolProjectDefaultsInner) o;
    return Objects.equals(this.toolDefault, defaultEntitiesForToolProjectDefaultsInner.toolDefault) &&
        Objects.equals(this.projectDefaultScope, defaultEntitiesForToolProjectDefaultsInner.projectDefaultScope);
  }

  @Override
  public int hashCode() {
    return Objects.hash(toolDefault, projectDefaultScope);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DefaultEntitiesForToolProjectDefaultsInner {\n");
    sb.append("    toolDefault: ").append(toIndentedString(toolDefault)).append("\n");
    sb.append("    projectDefaultScope: ").append(toIndentedString(projectDefaultScope)).append("\n");
    sb.append("}");
    return sb.toString();
  }
