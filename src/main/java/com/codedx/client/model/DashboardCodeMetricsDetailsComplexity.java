...
/**
 * DashboardCodeMetricsDetailsComplexity
 */
@JsonPropertyOrder({
  DashboardCodeMetricsDetailsComplexity.JSON_PROPERTY_TOTAL_CCN,
  DashboardCodeMetricsDetailsComplexity.JSON_PROPERTY_NUM_FUNCTIONS,
  DashboardCodeMetricsDetailsComplexity.JSON_PROPERTY_AVERAGE_CCN
})
@JsonTypeName("DashboardCodeMetricsDetails_complexity")
...
public class DashboardCodeMetricsDetailsComplexity {
  public static final String JSON_PROPERTY_TOTAL_CCN = "totalCcn";
  @jakarta.annotation.Nullable
  private Integer totalCcn;

  public static final String JSON_PROPERTY_NUM_FUNCTIONS = "numFunctions";
  @jakarta.annotation.Nullable
  private Integer numFunctions;

  public static final String JSON_PROPERTY_AVERAGE_CCN = "averageCcn";
  @jakarta.annotation.Nullable
  private BigDecimal averageCcn;

  public DashboardCodeMetricsDetailsComplexity() { 
  }

  public DashboardCodeMetricsDetailsComplexity totalCcn(@jakarta.annotation.Nullable Integer totalCcn) {
    this.totalCcn = totalCcn;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_TOTAL_CCN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getTotalCcn() {
    return totalCcn;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TOTAL_CCN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTotalCcn(@jakarta.annotation.Nullable Integer totalCcn) {
    this.totalCcn = totalCcn;
  }


  public DashboardCodeMetricsDetailsComplexity numFunctions(@jakarta.annotation.Nullable Integer numFunctions) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NUM_FUNCTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NUM_FUNCTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumFunctions(@jakarta.annotation.Nullable Integer numFunctions) {
    this.numFunctions = numFunctions;
  }


  public DashboardCodeMetricsDetailsComplexity averageCcn(@jakarta.annotation.Nullable BigDecimal averageCcn) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_AVERAGE_CCN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public BigDecimal getAverageCcn() {
    return averageCcn;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_AVERAGE_CCN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAverageCcn(@jakarta.annotation.Nullable BigDecimal averageCcn) {
    this.averageCcn = averageCcn;
  }


  /**
   * Return true if this DashboardCodeMetricsDetails_complexity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardCodeMetricsDetailsComplexity dashboardCodeMetricsDetailsComplexity = (DashboardCodeMetricsDetailsComplexity) o;
    return Objects.equals(this.totalCcn, dashboardCodeMetricsDetailsComplexity.totalCcn) &&
        Objects.equals(this.numFunctions, dashboardCodeMetricsDetailsComplexity.numFunctions) &&
        Objects.equals(this.averageCcn, dashboardCodeMetricsDetailsComplexity.averageCcn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalCcn, numFunctions, averageCcn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardCodeMetricsDetailsComplexity {\n");
    sb.append("    totalCcn: ").append(toIndentedString(totalCcn)).append("\n");
    sb.append("    numFunctions: ").append(toIndentedString(numFunctions)).append("\n");
    sb.append("    averageCcn: ").append(toIndentedString(averageCcn)).append("\n");
    sb.append("}");
    return sb.toString();
  }
