...
import com.codedx.client.model.InputField;
 ...
 */
@JsonPropertyOrder({
  FormSpecifierInner.JSON_PROPERTY_KEY,
  FormSpecifierInner.JSON_PROPERTY_INPUT
})
@JsonTypeName("FormSpecifier_inner")
...
public class FormSpecifierInner {
  ...
  public FormSpecifierInner() { 
  }

  public FormSpecifierInner key(@jakarta.annotation.Nonnull String key) {
    this.key = key;
    return this;
  }
  ...
  public FormSpecifierInner input(@jakarta.annotation.Nonnull InputField input) {
    this.input = input;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INPUT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInput(@jakarta.annotation.Nonnull InputField input) {
    this.input = input;
  }


  /**
   * Return true if this FormSpecifier_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FormSpecifierInner formSpecifierInner = (FormSpecifierInner) o;
    return Objects.equals(this.key, formSpecifierInner.key) &&
        Objects.equals(this.input, formSpecifierInner.input);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, input);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormSpecifierInner {\n");
