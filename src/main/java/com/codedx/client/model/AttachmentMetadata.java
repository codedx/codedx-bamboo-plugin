...
import com.codedx.client.model.AttachmentMetadataUploader;
 ...
 */
@JsonPropertyOrder({
  AttachmentMetadata.JSON_PROPERTY_UUID,
  AttachmentMetadata.JSON_PROPERTY_NAME,
  AttachmentMetadata.JSON_PROPERTY_ATTACHMENT_TYPE,
  AttachmentMetadata.JSON_PROPERTY_SIZE,
  AttachmentMetadata.JSON_PROPERTY_UPLOADER,
  AttachmentMetadata.JSON_PROPERTY_HASH,
  AttachmentMetadata.JSON_PROPERTY_UPLOADED_AT
})
...
public class AttachmentMetadata {
  ...
  @jakarta.annotation.Nullable
  private AttachmentMetadataUploader uploader;
  ...
  public AttachmentMetadata uuid(@jakarta.annotation.Nullable UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public AttachmentMetadata name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AttachmentMetadata attachmentType(@jakarta.annotation.Nullable String attachmentType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ATTACHMENT_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttachmentType(@jakarta.annotation.Nullable String attachmentType) {
    this.attachmentType = attachmentType;
  }


  public AttachmentMetadata size(@jakarta.annotation.Nullable Long size) {
    this.size = size;
    return this;
  }
  ...
  public AttachmentMetadata uploader(@jakarta.annotation.Nullable AttachmentMetadataUploader uploader) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_UPLOADER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public AttachmentMetadataUploader getUploader() {
    return uploader;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_UPLOADER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUploader(@jakarta.annotation.Nullable AttachmentMetadataUploader uploader) {
    this.uploader = uploader;
  }


  public AttachmentMetadata hash(@jakarta.annotation.Nullable String hash) {
    this.hash = hash;
    return this;
  }
  ...
  public AttachmentMetadata uploadedAt(@jakarta.annotation.Nullable OffsetDateTime uploadedAt) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_UPLOADED_AT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_UPLOADED_AT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUploadedAt(@jakarta.annotation.Nullable OffsetDateTime uploadedAt) {
    this.uploadedAt = uploadedAt;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, attachmentMetadata.uuid) &&
        Objects.equals(this.name, attachmentMetadata.name) &&
        Objects.equals(this.attachmentType, attachmentMetadata.attachmentType) &&
        Objects.equals(this.size, attachmentMetadata.size) &&
        Objects.equals(this.uploader, attachmentMetadata.uploader) &&
        Objects.equals(this.hash, attachmentMetadata.hash) &&
        Objects.equals(this.uploadedAt, attachmentMetadata.uploadedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, attachmentType, size, uploader, hash, uploadedAt);
  }
