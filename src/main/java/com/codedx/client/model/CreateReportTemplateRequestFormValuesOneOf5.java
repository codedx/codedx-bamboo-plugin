...
/**
 * Nessus report form values
 */
@JsonPropertyOrder({
  CreateReportTemplateRequestFormValuesOneOf5.JSON_PROPERTY_DEFAULT_HOST,
  CreateReportTemplateRequestFormValuesOneOf5.JSON_PROPERTY_OPERATION_SYSTEM,
  CreateReportTemplateRequestFormValuesOneOf5.JSON_PROPERTY_MAC_ADDRESS,
  CreateReportTemplateRequestFormValuesOneOf5.JSON_PROPERTY_NET_BIOS_NAME
})
@JsonTypeName("createReportTemplate_request_formValues_oneOf_5")
...
public class CreateReportTemplateRequestFormValuesOneOf5 {
  public static final String JSON_PROPERTY_DEFAULT_HOST = "default-host";
  @jakarta.annotation.Nullable
  private String defaultHost;

  public static final String JSON_PROPERTY_OPERATION_SYSTEM = "operation-system";
  @jakarta.annotation.Nullable
  ...
  public static final String JSON_PROPERTY_NET_BIOS_NAME = "net-bios-name";
  @jakarta.annotation.Nullable
  private String netBiosName;

  public CreateReportTemplateRequestFormValuesOneOf5() { 
  }

  public CreateReportTemplateRequestFormValuesOneOf5 defaultHost(@jakarta.annotation.Nullable String defaultHost) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_DEFAULT_HOST, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_DEFAULT_HOST, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultHost(@jakarta.annotation.Nullable String defaultHost) {
    this.defaultHost = defaultHost;
  }


  public CreateReportTemplateRequestFormValuesOneOf5 operationSystem(@jakarta.annotation.Nullable String operationSystem) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_OPERATION_SYSTEM, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERATION_SYSTEM, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOperationSystem(@jakarta.annotation.Nullable String operationSystem) {
    this.operationSystem = operationSystem;
  }


  public CreateReportTemplateRequestFormValuesOneOf5 macAddress(@jakarta.annotation.Nullable String macAddress) {
  ...
  public CreateReportTemplateRequestFormValuesOneOf5 netBiosName(@jakarta.annotation.Nullable String netBiosName) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NET_BIOS_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_NET_BIOS_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNetBiosName(@jakarta.annotation.Nullable String netBiosName) {
    this.netBiosName = netBiosName;
  }


  /**
   * Return true if this createReportTemplate_request_formValues_oneOf_5 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateReportTemplateRequestFormValuesOneOf5 createReportTemplateRequestFormValuesOneOf5 = (CreateReportTemplateRequestFormValuesOneOf5) o;
    return Objects.equals(this.defaultHost, createReportTemplateRequestFormValuesOneOf5.defaultHost) &&
        Objects.equals(this.operationSystem, createReportTemplateRequestFormValuesOneOf5.operationSystem) &&
        Objects.equals(this.macAddress, createReportTemplateRequestFormValuesOneOf5.macAddress) &&
        Objects.equals(this.netBiosName, createReportTemplateRequestFormValuesOneOf5.netBiosName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultHost, operationSystem, macAddress, netBiosName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateReportTemplateRequestFormValuesOneOf5 {\n");
