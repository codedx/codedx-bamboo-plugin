...
import com.codedx.client.model.ValidateToolConnectorSection200ResponseFeedbackInner;
...
/**
 * ValidateToolConnectorSection200Response
 */
@JsonPropertyOrder({
  ValidateToolConnectorSection200Response.JSON_PROPERTY_FEEDBACK,
  ValidateToolConnectorSection200Response.JSON_PROPERTY_TOKEN
})
@JsonTypeName("validateToolConnectorSection_200_response")
...
public class ValidateToolConnectorSection200Response {
  public static final String JSON_PROPERTY_FEEDBACK = "feedback";
  @jakarta.annotation.Nonnull
  private List<ValidateToolConnectorSection200ResponseFeedbackInner> feedback = new ArrayList<>();
  ...
  public ValidateToolConnectorSection200Response feedback(@jakarta.annotation.Nonnull List<ValidateToolConnectorSection200ResponseFeedbackInner> feedback) {
    this.feedback = feedback;
    return this;
  }

  public ValidateToolConnectorSection200Response addFeedbackItem(ValidateToolConnectorSection200ResponseFeedbackInner feedbackItem) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_FEEDBACK, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<ValidateToolConnectorSection200ResponseFeedbackInner> getFeedback() {
    return feedback;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FEEDBACK, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFeedback(@jakarta.annotation.Nonnull List<ValidateToolConnectorSection200ResponseFeedbackInner> feedback) {
    this.feedback = feedback;
  }


  public ValidateToolConnectorSection200Response token(@jakarta.annotation.Nullable String token) {
    this.token = token;
    return this;
  }

  /**
   * If validation succeeded without errors, this token should be re-submitted when attempting to save the same values
   * @return token
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this validateToolConnectorSection_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ValidateToolConnectorSection200Response validateToolConnectorSection200Response = (ValidateToolConnectorSection200Response) o;
    return Objects.equals(this.feedback, validateToolConnectorSection200Response.feedback) &&
        Objects.equals(this.token, validateToolConnectorSection200Response.token);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feedback, token);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValidateToolConnectorSection200Response {\n");
