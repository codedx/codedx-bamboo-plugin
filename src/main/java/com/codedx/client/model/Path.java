 ...
 */
@JsonPropertyOrder({
  Path.JSON_PROPERTY_ID,
  Path.JSON_PROPERTY_PATH_TYPE,
  Path.JSON_PROPERTY_PATH,
  Path.JSON_PROPERTY_SHORT_NAME,
  Path.JSON_PROPERTY_HAS_SOURCE
})
...
public class Path {
  ...
  public static final String JSON_PROPERTY_HAS_SOURCE = "hasSource";
  @jakarta.annotation.Nullable
  ...
  public Path id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Path pathType(@jakarta.annotation.Nullable String pathType) {
  ...
  public Path path(@jakarta.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public Path shortName(@jakarta.annotation.Nullable String shortName) {
  ...
  public Path hasSource(@jakarta.annotation.Nullable Boolean hasSource) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_HAS_SOURCE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_HAS_SOURCE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHasSource(@jakarta.annotation.Nullable Boolean hasSource) {
    this.hasSource = hasSource;
  }
