 ...
 */
@JsonPropertyOrder({
  UpdateUserGroupMembersRequest.JSON_PROPERTY_ADD_USER_IDS,
  UpdateUserGroupMembersRequest.JSON_PROPERTY_REMOVE_USER_IDS
})
@JsonTypeName("updateUserGroupMembers_request")
...
public class UpdateUserGroupMembersRequest {
  public static final String JSON_PROPERTY_ADD_USER_IDS = "addUserIds";
  @jakarta.annotation.Nullable
  private List<Integer> addUserIds = new ArrayList<>();

  public static final String JSON_PROPERTY_REMOVE_USER_IDS = "removeUserIds";
  @jakarta.annotation.Nullable
  private List<Integer> removeUserIds = new ArrayList<>();

  public UpdateUserGroupMembersRequest() { 
  }

  public UpdateUserGroupMembersRequest addUserIds(@jakarta.annotation.Nullable List<Integer> addUserIds) {
    this.addUserIds = addUserIds;
    return this;
  }

  public UpdateUserGroupMembersRequest addAddUserIdsItem(Integer addUserIdsItem) {
    if (this.addUserIds == null) {
      this.addUserIds = new ArrayList<>();
    }
    this.addUserIds.add(addUserIdsItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ADD_USER_IDS, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_ADD_USER_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAddUserIds(@jakarta.annotation.Nullable List<Integer> addUserIds) {
    this.addUserIds = addUserIds;
  }


  public UpdateUserGroupMembersRequest removeUserIds(@jakarta.annotation.Nullable List<Integer> removeUserIds) {
    this.removeUserIds = removeUserIds;
    return this;
  }

  public UpdateUserGroupMembersRequest addRemoveUserIdsItem(Integer removeUserIdsItem) {
    if (this.removeUserIds == null) {
      this.removeUserIds = new ArrayList<>();
    }
    this.removeUserIds.add(removeUserIdsItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_REMOVE_USER_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_REMOVE_USER_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRemoveUserIds(@jakarta.annotation.Nullable List<Integer> removeUserIds) {
    this.removeUserIds = removeUserIds;
  }


  /**
   * Return true if this updateUserGroupMembers_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateUserGroupMembersRequest updateUserGroupMembersRequest = (UpdateUserGroupMembersRequest) o;
    return Objects.equals(this.addUserIds, updateUserGroupMembersRequest.addUserIds) &&
        Objects.equals(this.removeUserIds, updateUserGroupMembersRequest.removeUserIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addUserIds, removeUserIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateUserGroupMembersRequest {\n");
    sb.append("    addUserIds: ").append(toIndentedString(addUserIds)).append("\n");
    sb.append("    removeUserIds: ").append(toIndentedString(removeUserIds)).append("\n");
    sb.append("}");
    return sb.toString();
  }
