 ...
 */
@JsonPropertyOrder({
  ProfilePasswordChange.JSON_PROPERTY_CURRENT_PASSWORD,
  ProfilePasswordChange.JSON_PROPERTY_NEW_PASSWORD
})
...
public class ProfilePasswordChange {
  ...
  public ProfilePasswordChange currentPassword(@jakarta.annotation.Nullable String currentPassword) {
  ...
  public ProfilePasswordChange newPassword(@jakarta.annotation.Nullable String newPassword) {
  ...
  /**
   * Return true if this ProfilePasswordChange object is equal to o.
   */
  @Override
