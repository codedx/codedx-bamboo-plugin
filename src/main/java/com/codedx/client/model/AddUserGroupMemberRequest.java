 ...
 */
@JsonPropertyOrder({
  AddUserGroupMemberRequest.JSON_PROPERTY_ID
})
@JsonTypeName("addUserGroupMember_request")
...
public class AddUserGroupMemberRequest {
  ...
  public AddUserGroupMemberRequest id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  /**
   * Return true if this addUserGroupMember_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AddUserGroupMemberRequest addUserGroupMemberRequest = (AddUserGroupMemberRequest) o;
    return Objects.equals(this.id, addUserGroupMemberRequest.id);
  }
