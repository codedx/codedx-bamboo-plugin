...
/**
 * ImportSource202Response
 */
@JsonPropertyOrder({
  ImportSource202Response.JSON_PROPERTY_JOB_ID,
  ImportSource202Response.JSON_PROPERTY_INPUT_ID,
  ImportSource202Response.JSON_PROPERTY_FILE_NAME
})
@JsonTypeName("importSource_202_response")
...
public class ImportSource202Response {
  ...
  public ImportSource202Response() { 
  }

  public ImportSource202Response jobId(@jakarta.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public ImportSource202Response inputId(@jakarta.annotation.Nullable String inputId) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INPUT_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_INPUT_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInputId(@jakarta.annotation.Nullable String inputId) {
    this.inputId = inputId;
  }


  public ImportSource202Response fileName(@jakarta.annotation.Nullable String fileName) {
  ...
  /**
   * Return true if this importSource_202_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ImportSource202Response importSource202Response = (ImportSource202Response) o;
    return Objects.equals(this.jobId, importSource202Response.jobId) &&
        Objects.equals(this.inputId, importSource202Response.inputId) &&
        Objects.equals(this.fileName, importSource202Response.fileName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, inputId, fileName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportSource202Response {\n");
