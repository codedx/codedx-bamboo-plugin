...
import com.codedx.client.model.SetToolRunnerIntentRequestOptions;
...
/**
 * SetToolRunnerIntentRequest
 */
@JsonPropertyOrder({
  SetToolRunnerIntentRequest.JSON_PROPERTY_TOOL,
  SetToolRunnerIntentRequest.JSON_PROPERTY_OPTIONS
})
@JsonTypeName("setToolRunnerIntent_request")
...
public class SetToolRunnerIntentRequest {
  /**
   * The name of the requested tool.
   */
  public enum ToolEnum {
    COVERITY(String.valueOf("Coverity")),
    
    BLACK_DUCK_SCA(String.valueOf("Black Duck SCA"));
  ...
  @jakarta.annotation.Nullable
  private SetToolRunnerIntentRequestOptions options;

  public SetToolRunnerIntentRequest() { 
  }

  public SetToolRunnerIntentRequest tool(@jakarta.annotation.Nullable ToolEnum tool) {
    this.tool = tool;
    return this;
  }
  ...
  public SetToolRunnerIntentRequest options(@jakarta.annotation.Nullable SetToolRunnerIntentRequestOptions options) {
  ...
  public SetToolRunnerIntentRequestOptions getOptions() {
    return options;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_OPTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptions(@jakarta.annotation.Nullable SetToolRunnerIntentRequestOptions options) {
    this.options = options;
  }


  /**
   * Return true if this setToolRunnerIntent_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SetToolRunnerIntentRequest setToolRunnerIntentRequest = (SetToolRunnerIntentRequest) o;
    return Objects.equals(this.tool, setToolRunnerIntentRequest.tool) &&
        Objects.equals(this.options, setToolRunnerIntentRequest.options);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tool, options);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetToolRunnerIntentRequest {\n");
