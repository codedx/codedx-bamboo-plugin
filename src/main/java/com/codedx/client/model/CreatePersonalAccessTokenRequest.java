...
import com.codedx.client.model.CreatePersonalAccessTokenRequestInherit;
 ...
 */
@JsonPropertyOrder({
  CreatePersonalAccessTokenRequest.JSON_PROPERTY_NAME,
  CreatePersonalAccessTokenRequest.JSON_PROPERTY_INHERIT,
  CreatePersonalAccessTokenRequest.JSON_PROPERTY_EXPIRATION_DATE,
  CreatePersonalAccessTokenRequest.JSON_PROPERTY_EXPIRATION_DURATION
})
@JsonTypeName("createPersonalAccessToken_request")
...
public class CreatePersonalAccessTokenRequest {
  ...
  @jakarta.annotation.Nonnull
  private CreatePersonalAccessTokenRequestInherit inherit;
  ...
  public CreatePersonalAccessTokenRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }

  /**
   * The name used to display the new PAT
   * @return name
   */
  @jakarta.annotation.Nonnull
  ...
  public CreatePersonalAccessTokenRequest inherit(@jakarta.annotation.Nonnull CreatePersonalAccessTokenRequestInherit inherit) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_INHERIT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public CreatePersonalAccessTokenRequestInherit getInherit() {
    return inherit;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INHERIT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInherit(@jakarta.annotation.Nonnull CreatePersonalAccessTokenRequestInherit inherit) {
    this.inherit = inherit;
  }


  public CreatePersonalAccessTokenRequest expirationDate(@jakarta.annotation.Nullable String expirationDate) {
    this.expirationDate = expirationDate;
    return this;
  }

  /**
   * An ISO-8601 date string which will be interpreted in SRM&#39;s time zone and used to expire a resource. Use &#x60;null&#x60; for this value if no expiration is desired.
  ...
  public CreatePersonalAccessTokenRequest expirationDuration(@jakarta.annotation.Nullable String expirationDuration) {
    this.expirationDuration = expirationDuration;
    return this;
  }

  /**
   * A duration that must be representable in terms of days. Use &#x60;null&#x60; for this value if no expiration is desired.
   * @return expirationDuration
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_EXPIRATION_DURATION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_EXPIRATION_DURATION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExpirationDuration(@jakarta.annotation.Nullable String expirationDuration) {
    this.expirationDuration = expirationDuration;
  }


  /**
   * Return true if this createPersonalAccessToken_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createPersonalAccessTokenRequest.name) &&
        Objects.equals(this.inherit, createPersonalAccessTokenRequest.inherit) &&
        Objects.equals(this.expirationDate, createPersonalAccessTokenRequest.expirationDate) &&
        Objects.equals(this.expirationDuration, createPersonalAccessTokenRequest.expirationDuration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, inherit, expirationDate, expirationDuration);
  }
