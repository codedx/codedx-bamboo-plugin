...
/**
 * UpdateBulkConnectorBinding
 */
@JsonPropertyOrder({
  UpdateBulkConnectorBinding.JSON_PROPERTY_BINDING_IDS,
  UpdateBulkConnectorBinding.JSON_PROPERTY_OPTION_ENTITY_ID,
  UpdateBulkConnectorBinding.JSON_PROPERTY_SCHEDULE_ENTITY_ID,
  UpdateBulkConnectorBinding.JSON_PROPERTY_BRANCH_NAME,
  UpdateBulkConnectorBinding.JSON_PROPERTY_ENABLED,
  UpdateBulkConnectorBinding.JSON_PROPERTY_VERSION_ENTITY
})
...
public class UpdateBulkConnectorBinding {
  public static final String JSON_PROPERTY_BINDING_IDS = "bindingIds";
  @jakarta.annotation.Nullable
  private List<Integer> bindingIds = new ArrayList<>();
  ...
  @jakarta.annotation.Nullable
  private SetProjectEntityNameOverrideRequest versionEntity;

  public UpdateBulkConnectorBinding() { 
  }

  public UpdateBulkConnectorBinding bindingIds(@jakarta.annotation.Nullable List<Integer> bindingIds) {
    this.bindingIds = bindingIds;
    return this;
  }

  public UpdateBulkConnectorBinding addBindingIdsItem(Integer bindingIdsItem) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_BINDING_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<Integer> getBindingIds() {
    return bindingIds;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_BINDING_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBindingIds(@jakarta.annotation.Nullable List<Integer> bindingIds) {
    this.bindingIds = bindingIds;
  }


  public UpdateBulkConnectorBinding optionEntityId(@jakarta.annotation.Nullable Integer optionEntityId) {
  ...
  public UpdateBulkConnectorBinding scheduleEntityId(@jakarta.annotation.Nullable Integer scheduleEntityId) {
  ...
  public UpdateBulkConnectorBinding branchName(@jakarta.annotation.Nullable String branchName) {
  ...
  public UpdateBulkConnectorBinding enabled(@jakarta.annotation.Nullable Boolean enabled) {
  ...
  public UpdateBulkConnectorBinding versionEntity(@jakarta.annotation.Nullable SetProjectEntityNameOverrideRequest versionEntity) {
  ...
  public SetProjectEntityNameOverrideRequest getVersionEntity() {
    return versionEntity;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_VERSION_ENTITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVersionEntity(@jakarta.annotation.Nullable SetProjectEntityNameOverrideRequest versionEntity) {
    this.versionEntity = versionEntity;
  }


  /**
   * Return true if this UpdateBulkConnectorBinding object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateBulkConnectorBinding updateBulkConnectorBinding = (UpdateBulkConnectorBinding) o;
    return Objects.equals(this.bindingIds, updateBulkConnectorBinding.bindingIds) &&
        Objects.equals(this.optionEntityId, updateBulkConnectorBinding.optionEntityId) &&
        Objects.equals(this.scheduleEntityId, updateBulkConnectorBinding.scheduleEntityId) &&
        Objects.equals(this.branchName, updateBulkConnectorBinding.branchName) &&
        Objects.equals(this.enabled, updateBulkConnectorBinding.enabled) &&
        Objects.equals(this.versionEntity, updateBulkConnectorBinding.versionEntity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bindingIds, optionEntityId, scheduleEntityId, branchName, enabled, versionEntity);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateBulkConnectorBinding {\n");
