...
import com.codedx.client.model.FormStateExpressionOneOf;
import com.codedx.client.model.FormStateExpressionOneOf1;
import com.codedx.client.model.FormStateExpressionOneOf2;
...
@JsonDeserialize(using = FormStateExpression.FormStateExpressionDeserializer.class)
@JsonSerialize(using = FormStateExpression.FormStateExpressionSerializer.class)
public class FormStateExpression extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(FormStateExpression.class.getName());

    public static class FormStateExpressionSerializer extends StdSerializer<FormStateExpression> {
        public FormStateExpressionSerializer(Class<FormStateExpression> t) {
            super(t);
        }

        public FormStateExpressionSerializer() {
            this(null);
        }

        @Override
        public void serialize(FormStateExpression value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class FormStateExpressionDeserializer extends StdDeserializer<FormStateExpression> {
        public FormStateExpressionDeserializer() {
            this(FormStateExpression.class);
        }

        public FormStateExpressionDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public FormStateExpression deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize FormStateExpressionOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(FormStateExpressionOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'FormStateExpressionOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormStateExpressionOneOf'", e);
            }

            // deserialize FormStateExpressionOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(FormStateExpressionOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'FormStateExpressionOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormStateExpressionOneOf1'", e);
            }

            // deserialize FormStateExpressionOneOf2
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(FormStateExpressionOneOf2.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'FormStateExpressionOneOf2'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormStateExpressionOneOf2'", e);
            }

            if (match == 1) {
                FormStateExpression ret = new FormStateExpression();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for FormStateExpression: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public FormStateExpression getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "FormStateExpression cannot be null");
        }
    }
    ...
    public FormStateExpression() {
        super("oneOf", Boolean.FALSE);
    }

    public FormStateExpression(FormStateExpressionOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public FormStateExpression(FormStateExpressionOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public FormStateExpression(FormStateExpressionOneOf2 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("FormStateExpressionOneOf", new GenericType<FormStateExpressionOneOf>() {
        });
        schemas.put("FormStateExpressionOneOf1", new GenericType<FormStateExpressionOneOf1>() {
        });
        schemas.put("FormStateExpressionOneOf2", new GenericType<FormStateExpressionOneOf2>() {
        });
        JSON.registerDescendants(FormStateExpression.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return FormStateExpression.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * FormStateExpressionOneOf, FormStateExpressionOneOf1, FormStateExpressionOneOf2
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(FormStateExpressionOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(FormStateExpressionOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(FormStateExpressionOneOf2.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be FormStateExpressionOneOf, FormStateExpressionOneOf1, FormStateExpressionOneOf2");
    }
     ...
     * FormStateExpressionOneOf, FormStateExpressionOneOf1, FormStateExpressionOneOf2
     *
     * @return The actual instance (FormStateExpressionOneOf, FormStateExpressionOneOf1, FormStateExpressionOneOf2)
     */
    @Override
    ...
    /**
     * Get the actual instance of `FormStateExpressionOneOf`. If the actual instance is not `FormStateExpressionOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FormStateExpressionOneOf`
     * @throws ClassCastException if the instance is not `FormStateExpressionOneOf`
     */
    public FormStateExpressionOneOf getFormStateExpressionOneOf() throws ClassCastException {
        return (FormStateExpressionOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `FormStateExpressionOneOf1`. If the actual instance is not `FormStateExpressionOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FormStateExpressionOneOf1`
     * @throws ClassCastException if the instance is not `FormStateExpressionOneOf1`
     */
    public FormStateExpressionOneOf1 getFormStateExpressionOneOf1() throws ClassCastException {
        return (FormStateExpressionOneOf1)super.getActualInstance();
    }

    /**
     * Get the actual instance of `FormStateExpressionOneOf2`. If the actual instance is not `FormStateExpressionOneOf2`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FormStateExpressionOneOf2`
     * @throws ClassCastException if the instance is not `FormStateExpressionOneOf2`
     */
    public FormStateExpressionOneOf2 getFormStateExpressionOneOf2() throws ClassCastException {
        return (FormStateExpressionOneOf2)super.getActualInstance();
    }
