 ...
 */
@JsonPropertyOrder({
  DateRange.JSON_PROPERTY_MIN,
  DateRange.JSON_PROPERTY_MAX
})
...
public class DateRange {
  ...
  public DateRange min(@jakarta.annotation.Nullable String min) {
    this.min = min;
    return this;
  }
  ...
  public DateRange max(@jakarta.annotation.Nullable String max) {
    this.max = max;
    return this;
  }
  ...
  /**
   * Return true if this DateRange object is equal to o.
   */
  @Override
