...
/**
 * DashboardAnalysisCountByMethod
 */
@JsonPropertyOrder({
  DashboardAnalysisCountByMethod.JSON_PROPERTY_ANALYSIS_COUNT,
  DashboardAnalysisCountByMethod.JSON_PROPERTY_DETECTION_METHOD_ID,
  DashboardAnalysisCountByMethod.JSON_PROPERTY_DETECTION_METHOD_NAME
})
...
public class DashboardAnalysisCountByMethod {
  public static final String JSON_PROPERTY_ANALYSIS_COUNT = "analysisCount";
  ...
  public DashboardAnalysisCountByMethod() { 
  }

  public DashboardAnalysisCountByMethod analysisCount(@jakarta.annotation.Nonnull Integer analysisCount) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_ANALYSIS_COUNT, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_ANALYSIS_COUNT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAnalysisCount(@jakarta.annotation.Nonnull Integer analysisCount) {
    this.analysisCount = analysisCount;
  }


  public DashboardAnalysisCountByMethod detectionMethodId(@jakarta.annotation.Nonnull Integer detectionMethodId) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_DETECTION_METHOD_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_DETECTION_METHOD_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDetectionMethodId(@jakarta.annotation.Nonnull Integer detectionMethodId) {
    this.detectionMethodId = detectionMethodId;
  }


  public DashboardAnalysisCountByMethod detectionMethodName(@jakarta.annotation.Nonnull String detectionMethodName) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_DETECTION_METHOD_NAME, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_DETECTION_METHOD_NAME, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDetectionMethodName(@jakarta.annotation.Nonnull String detectionMethodName) {
    this.detectionMethodName = detectionMethodName;
  }


  /**
   * Return true if this DashboardAnalysisCountByMethod object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardAnalysisCountByMethod dashboardAnalysisCountByMethod = (DashboardAnalysisCountByMethod) o;
    return Objects.equals(this.analysisCount, dashboardAnalysisCountByMethod.analysisCount) &&
        Objects.equals(this.detectionMethodId, dashboardAnalysisCountByMethod.detectionMethodId) &&
        Objects.equals(this.detectionMethodName, dashboardAnalysisCountByMethod.detectionMethodName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(analysisCount, detectionMethodId, detectionMethodName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardAnalysisCountByMethod {\n");
    sb.append("    analysisCount: ").append(toIndentedString(analysisCount)).append("\n");
