 ...
 */
@JsonPropertyOrder({
  FlowData.JSON_PROPERTY_SEVERITY,
  FlowData.JSON_PROPERTY_CWE,
  FlowData.JSON_PROPERTY_STATUS,
  FlowData.JSON_PROPERTY_RULE,
  FlowData.JSON_PROPERTY_DETECTED_BY,
  FlowData.JSON_PROPERTY_COUNT
})
...
public class FlowData {
  ...
  public static final String JSON_PROPERTY_DETECTED_BY = "detected by";
  @jakarta.annotation.Nullable
  ...
  public FlowData severity(@jakarta.annotation.Nullable SeverityValue severity) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SEVERITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSeverity(@jakarta.annotation.Nullable SeverityValue severity) {
    this.severity = severity;
  }


  public FlowData cwe(@jakarta.annotation.Nullable String cwe) {
    this.cwe = cwe;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CWE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCwe(@jakarta.annotation.Nullable String cwe) {
    this.cwe = cwe;
  }


  public FlowData status(@jakarta.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public FlowData rule(@jakarta.annotation.Nullable String rule) {
    this.rule = rule;
    return this;
  }
  ...
  public FlowData detectedBy(@jakarta.annotation.Nullable String detectedBy) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_DETECTED_BY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_DETECTED_BY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetectedBy(@jakarta.annotation.Nullable String detectedBy) {
    this.detectedBy = detectedBy;
  }


  public FlowData count(@jakarta.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  /**
   * Return true if this FlowData object is equal to o.
   */
  @Override
