 ...
 */
@JsonPropertyOrder({
  CreateUserGroup.JSON_PROPERTY_NAME,
  CreateUserGroup.JSON_PROPERTY_PARENT_ID,
  CreateUserGroup.JSON_PROPERTY_ROLES
})
...
public class CreateUserGroup {
  ...
  public CreateUserGroup name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateUserGroup parentId(@jakarta.annotation.Nullable Integer parentId) {
    this.parentId = parentId;
    return this;
  }

  /**
   * Optional - The id of the parent user group
   * @return parentId
   */
  @jakarta.annotation.Nullable
  ...
  public CreateUserGroup roles(@jakarta.annotation.Nullable List<String> roles) {
    this.roles = roles;
    return this;
  }

  public CreateUserGroup addRolesItem(String rolesItem) {
    if (this.roles == null) {
  ...
  /**
   * Optional - A list of role names (Creator, Reader, Updater, and/or Manager)
   * @return roles
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this CreateUserGroup object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateUserGroup createUserGroup = (CreateUserGroup) o;
    return Objects.equals(this.name, createUserGroup.name) &&
        Objects.equals(this.parentId, createUserGroup.parentId) &&
        Objects.equals(this.roles, createUserGroup.roles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, parentId, roles);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateUserGroup {\n");
