 ...
 */
@JsonPropertyOrder({
  UseExistingEntity.JSON_PROPERTY_ID
})
...
public class UseExistingEntity {
  public static final String JSON_PROPERTY_ID = "id";
  @jakarta.annotation.Nullable
  private Integer id;

  public UseExistingEntity() { 
  }

  public UseExistingEntity id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  /**
   * Return true if this UseExistingEntity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UseExistingEntity useExistingEntity = (UseExistingEntity) o;
    return Objects.equals(this.id, useExistingEntity.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class UseExistingEntity {\n");
