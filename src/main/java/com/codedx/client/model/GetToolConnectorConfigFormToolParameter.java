...
@JsonDeserialize(using = GetToolConnectorConfigFormToolParameter.GetToolConnectorConfigFormToolParameterDeserializer.class)
@JsonSerialize(using = GetToolConnectorConfigFormToolParameter.GetToolConnectorConfigFormToolParameterSerializer.class)
public class GetToolConnectorConfigFormToolParameter extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetToolConnectorConfigFormToolParameter.class.getName());

    public static class GetToolConnectorConfigFormToolParameterSerializer extends StdSerializer<GetToolConnectorConfigFormToolParameter> {
        public GetToolConnectorConfigFormToolParameterSerializer(Class<GetToolConnectorConfigFormToolParameter> t) {
            super(t);
        }

        public GetToolConnectorConfigFormToolParameterSerializer() {
            this(null);
        }

        @Override
        public void serialize(GetToolConnectorConfigFormToolParameter value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class GetToolConnectorConfigFormToolParameterDeserializer extends StdDeserializer<GetToolConnectorConfigFormToolParameter> {
        public GetToolConnectorConfigFormToolParameterDeserializer() {
            this(GetToolConnectorConfigFormToolParameter.class);
        }

        public GetToolConnectorConfigFormToolParameterDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public GetToolConnectorConfigFormToolParameter deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                GetToolConnectorConfigFormToolParameter ret = new GetToolConnectorConfigFormToolParameter();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetToolConnectorConfigFormToolParameter: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public GetToolConnectorConfigFormToolParameter getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "GetToolConnectorConfigFormToolParameter cannot be null");
        }
    }
    ...
    public GetToolConnectorConfigFormToolParameter() {
        super("oneOf", Boolean.FALSE);
    }

    public GetToolConnectorConfigFormToolParameter(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetToolConnectorConfigFormToolParameter(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(GetToolConnectorConfigFormToolParameter.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return GetToolConnectorConfigFormToolParameter.schemas;
    }
