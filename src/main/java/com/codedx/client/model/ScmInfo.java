 ...
 */
@JsonPropertyOrder({
  ScmInfo.JSON_PROPERTY_REPO_TYPE,
  ScmInfo.JSON_PROPERTY_URL,
  ScmInfo.JSON_PROPERTY_REV
})
...
public class ScmInfo {
  ...
  public ScmInfo repoType(@jakarta.annotation.Nullable String repoType) {
    this.repoType = repoType;
    return this;
  }

  /**
   * In current versions of Software Risk Manager, this will only ever be the string \&quot;git\&quot;
   * @return repoType
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_REPO_TYPE, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_REPO_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRepoType(@jakarta.annotation.Nullable String repoType) {
    this.repoType = repoType;
  }


  public ScmInfo url(@jakarta.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public ScmInfo rev(@jakarta.annotation.Nullable Rev rev) {
    this.rev = rev;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_REV, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRev(@jakarta.annotation.Nullable Rev rev) {
    this.rev = rev;
  }


  /**
   * Return true if this ScmInfo object is equal to o.
   */
  @Override
