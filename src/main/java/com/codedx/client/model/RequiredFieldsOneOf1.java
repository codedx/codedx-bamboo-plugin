...
/**
 * A set of fields, at least one of which is required
 */
@JsonPropertyOrder({
  RequiredFieldsOneOf1.JSON_PROPERTY_ANY_OF
})
@JsonTypeName("RequiredFields_oneOf_1")
...
public class RequiredFieldsOneOf1 {
  public static final String JSON_PROPERTY_ANY_OF = "anyOf";
  @jakarta.annotation.Nonnull
  private List<RequiredFields> anyOf = new ArrayList<>();

  public RequiredFieldsOneOf1() { 
  }

  public RequiredFieldsOneOf1 anyOf(@jakarta.annotation.Nonnull List<RequiredFields> anyOf) {
    this.anyOf = anyOf;
    return this;
  }

  public RequiredFieldsOneOf1 addAnyOfItem(RequiredFields anyOfItem) {
    if (this.anyOf == null) {
  ...
  public List<RequiredFields> getAnyOf() {
    return anyOf;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ANY_OF, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAnyOf(@jakarta.annotation.Nonnull List<RequiredFields> anyOf) {
    this.anyOf = anyOf;
  }


  /**
   * Return true if this RequiredFields_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RequiredFieldsOneOf1 requiredFieldsOneOf1 = (RequiredFieldsOneOf1) o;
    return Objects.equals(this.anyOf, requiredFieldsOneOf1.anyOf);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequiredFieldsOneOf1 {\n");
