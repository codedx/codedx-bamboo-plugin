 ...
 */
@JsonPropertyOrder({
  SetStatusBulk.JSON_PROPERTY_FILTER,
  SetStatusBulk.JSON_PROPERTY_STATUS
})
...
public class SetStatusBulk {
  ...
  public SetStatusBulk() { 
  }

  public SetStatusBulk filter(@jakarta.annotation.Nullable Filter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public SetStatusBulk status(@jakarta.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  /**
   * Return true if this SetStatusBulk object is equal to o.
   */
  @Override
