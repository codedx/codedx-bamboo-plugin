...
@JsonPropertyOrder({
  ...
  CreateProjectRequest.JSON_PROPERTY_PARENT,
  CreateProjectRequest.JSON_PROPERTY_DEFAULT_BRANCH_NAME
})
...
public class CreateProjectRequest {
  ...
  public static final String JSON_PROPERTY_DEFAULT_BRANCH_NAME = "defaultBranchName";
  @jakarta.annotation.Nullable
  ...
  public CreateProjectRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateProjectRequest parent(@jakarta.annotation.Nullable Integer parent) {
    this.parent = parent;
    return this;
  }

  /**
   * The ID of the parent project - not required
   * @return parent
   */
  @jakarta.annotation.Nullable
  ...
  public CreateProjectRequest defaultBranchName(@jakarta.annotation.Nullable String defaultBranchName) {
    this.defaultBranchName = defaultBranchName;
    return this;
  }

  /**
   * Name of the default branch - cannot exceed 128 characters, not required
   * @return defaultBranchName
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_DEFAULT_BRANCH_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_DEFAULT_BRANCH_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDefaultBranchName(@jakarta.annotation.Nullable String defaultBranchName) {
    this.defaultBranchName = defaultBranchName;
  }


  /**
   * Return true if this CreateProjectRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createProjectRequest.name) &&
        Objects.equals(this.parent, createProjectRequest.parent) &&
        Objects.equals(this.defaultBranchName, createProjectRequest.defaultBranchName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, parent, defaultBranchName);
  }
