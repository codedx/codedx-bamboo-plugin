...
/**
 * A statement that at least one of the inner expressions should be true
 */
@JsonPropertyOrder({
  FormStateExpressionOneOf1.JSON_PROPERTY_ANY_OF
})
@JsonTypeName("FormStateExpression_oneOf_1")
...
public class FormStateExpressionOneOf1 {
  public static final String JSON_PROPERTY_ANY_OF = "anyOf";
  @jakarta.annotation.Nonnull
  private List<FormStateExpression> anyOf = new ArrayList<>();

  public FormStateExpressionOneOf1() { 
  }

  public FormStateExpressionOneOf1 anyOf(@jakarta.annotation.Nonnull List<FormStateExpression> anyOf) {
    this.anyOf = anyOf;
    return this;
  }

  public FormStateExpressionOneOf1 addAnyOfItem(FormStateExpression anyOfItem) {
    if (this.anyOf == null) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_ANY_OF, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<FormStateExpression> getAnyOf() {
    return anyOf;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ANY_OF, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAnyOf(@jakarta.annotation.Nonnull List<FormStateExpression> anyOf) {
    this.anyOf = anyOf;
  }


  /**
   * Return true if this FormStateExpression_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FormStateExpressionOneOf1 formStateExpressionOneOf1 = (FormStateExpressionOneOf1) o;
    return Objects.equals(this.anyOf, formStateExpressionOneOf1.anyOf);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormStateExpressionOneOf1 {\n");
