...
@JsonDeserialize(using = BranchSpecifierOneOfParent.BranchSpecifierOneOfParentDeserializer.class)
@JsonSerialize(using = BranchSpecifierOneOfParent.BranchSpecifierOneOfParentSerializer.class)
public class BranchSpecifierOneOfParent extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BranchSpecifierOneOfParent.class.getName());

    public static class BranchSpecifierOneOfParentSerializer extends StdSerializer<BranchSpecifierOneOfParent> {
        public BranchSpecifierOneOfParentSerializer(Class<BranchSpecifierOneOfParent> t) {
            super(t);
        }

        public BranchSpecifierOneOfParentSerializer() {
            this(null);
        }

        @Override
        public void serialize(BranchSpecifierOneOfParent value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class BranchSpecifierOneOfParentDeserializer extends StdDeserializer<BranchSpecifierOneOfParent> {
        public BranchSpecifierOneOfParentDeserializer() {
            this(BranchSpecifierOneOfParent.class);
        }

        public BranchSpecifierOneOfParentDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public BranchSpecifierOneOfParent deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                BranchSpecifierOneOfParent ret = new BranchSpecifierOneOfParent();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for BranchSpecifierOneOfParent: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public BranchSpecifierOneOfParent getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "BranchSpecifierOneOfParent cannot be null");
        }
    }
    ...
    public BranchSpecifierOneOfParent() {
        super("oneOf", Boolean.FALSE);
    }

    public BranchSpecifierOneOfParent(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BranchSpecifierOneOfParent(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(BranchSpecifierOneOfParent.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return BranchSpecifierOneOfParent.schemas;
    }
