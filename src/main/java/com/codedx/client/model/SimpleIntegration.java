 ...
 */
@JsonPropertyOrder({
  SimpleIntegration.JSON_PROPERTY_TYPE,
  SimpleIntegration.JSON_PROPERTY_NAME,
  SimpleIntegration.JSON_PROPERTY_HEADER,
  SimpleIntegration.JSON_PROPERTY_LOGO,
  SimpleIntegration.JSON_PROPERTY_INTEGRATION_ENABLED,
  SimpleIntegration.JSON_PROPERTY_IS_CONFIGURED,
  SimpleIntegration.JSON_PROPERTY_HELP_REF,
  SimpleIntegration.JSON_PROPERTY_FORMATS
})
...
public class SimpleIntegration {
  ...
  public static final String JSON_PROPERTY_INTEGRATION_ENABLED = "integrationEnabled";
  @jakarta.annotation.Nullable
  private Boolean integrationEnabled;

  public static final String JSON_PROPERTY_IS_CONFIGURED = "isConfigured";
  @jakarta.annotation.Nullable
  private Boolean isConfigured;

  public static final String JSON_PROPERTY_HELP_REF = "helpRef";
  @jakarta.annotation.Nullable
  ...
  public SimpleIntegration type(@jakarta.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public SimpleIntegration name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public SimpleIntegration header(@jakarta.annotation.Nullable String header) {
    this.header = header;
    return this;
  }
  ...
  public SimpleIntegration logo(@jakarta.annotation.Nullable String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public SimpleIntegration integrationEnabled(@jakarta.annotation.Nullable Boolean integrationEnabled) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INTEGRATION_ENABLED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_INTEGRATION_ENABLED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIntegrationEnabled(@jakarta.annotation.Nullable Boolean integrationEnabled) {
    this.integrationEnabled = integrationEnabled;
  }


  public SimpleIntegration isConfigured(@jakarta.annotation.Nullable Boolean isConfigured) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_CONFIGURED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_CONFIGURED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsConfigured(@jakarta.annotation.Nullable Boolean isConfigured) {
    this.isConfigured = isConfigured;
  }


  public SimpleIntegration helpRef(@jakarta.annotation.Nullable String helpRef) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_HELP_REF, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_HELP_REF, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHelpRef(@jakarta.annotation.Nullable String helpRef) {
    this.helpRef = helpRef;
  }


  public SimpleIntegration formats(@jakarta.annotation.Nullable List<String> formats) {
    this.formats = formats;
    return this;
  }

  public SimpleIntegration addFormatsItem(String formatsItem) {
  ...
  /**
   * Return true if this SimpleIntegration object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SimpleIntegration simpleIntegration = (SimpleIntegration) o;
    return Objects.equals(this.type, simpleIntegration.type) &&
        Objects.equals(this.name, simpleIntegration.name) &&
        Objects.equals(this.header, simpleIntegration.header) &&
        Objects.equals(this.logo, simpleIntegration.logo) &&
        Objects.equals(this.integrationEnabled, simpleIntegration.integrationEnabled) &&
        Objects.equals(this.isConfigured, simpleIntegration.isConfigured) &&
        Objects.equals(this.helpRef, simpleIntegration.helpRef) &&
        Objects.equals(this.formats, simpleIntegration.formats);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, name, header, logo, integrationEnabled, isConfigured, helpRef, formats);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SimpleIntegration {\n");
    ...
    sb.append("    helpRef: ").append(toIndentedString(helpRef)).append("\n");
