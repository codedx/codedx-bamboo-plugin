 ...
 */
@JsonPropertyOrder({
  ReportConfigRequired.JSON_PROPERTY_MESSAGE
})
...
public class ReportConfigRequired {
  ...
  public ReportConfigRequired() { 
  }

  public ReportConfigRequired message(@jakarta.annotation.Nullable String message) {
  ...
  /**
   * Return true if this ReportConfigRequired object is equal to o.
   */
  @Override
