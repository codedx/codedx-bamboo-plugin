 ...
 */
@JsonPropertyOrder({
  IssueStatus.JSON_PROPERTY_NAME,
  IssueStatus.JSON_PROPERTY_CATEGORY
})
...
public class IssueStatus {
  ...
  public IssueStatus name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IssueStatus category(@jakarta.annotation.Nullable String category) {
  ...
  /**
   * Return true if this IssueStatus object is equal to o.
   */
  @Override
