...
/**
 * The fields that appear in this object depend on how the &#39;fields&#39; query parameter is set when calling the &#39;Get All Policies&#39; endpoint. If &#39;fields&#39; is not provided, only &#39;id&#39; and &#39;name&#39; will be returned. If &#39;fields&#39; is provided, only the specified fields will be returned.
 */
@JsonPropertyOrder({
  PolicyListItem.JSON_PROPERTY_ID,
  PolicyListItem.JSON_PROPERTY_NAME,
  PolicyListItem.JSON_PROPERTY_DESCRIPTION,
  PolicyListItem.JSON_PROPERTY_CREATION_TIME,
  PolicyListItem.JSON_PROPERTY_EFFECTIVE_DATE,
  PolicyListItem.JSON_PROPERTY_IS_DEFAULT,
  PolicyListItem.JSON_PROPERTY_PROJECT_COUNT,
  PolicyListItem.JSON_PROPERTY_PROJECTS,
  PolicyListItem.JSON_PROPERTY_PROJECT_IDS
})
...
public class PolicyListItem {
  ...
  public static final String JSON_PROPERTY_PROJECT_COUNT = "projectCount";
  @jakarta.annotation.Nullable
  ...
  public PolicyListItem id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public PolicyListItem name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public PolicyListItem description(@jakarta.annotation.Nullable String description) {
    this.description = description;
    return this;
  }

  /**
   * A short description describing the policy
   * @return description
   */
  @jakarta.annotation.Nullable
  ...
  public PolicyListItem creationTime(@jakarta.annotation.Nullable String creationTime) {
    this.creationTime = creationTime;
    return this;
  }

  /**
   * The DateTime when the policy was created
   * @return creationTime
   */
  @jakarta.annotation.Nullable
  ...
  public PolicyListItem effectiveDate(@jakarta.annotation.Nullable String effectiveDate) {
    this.effectiveDate = effectiveDate;
    return this;
  }

  /**
   * The DateTime when the policy is in effect
  ...
  @JsonProperty(value = JSON_PROPERTY_EFFECTIVE_DATE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEffectiveDate(@jakarta.annotation.Nullable String effectiveDate) {
    this.effectiveDate = effectiveDate;
  }


  public PolicyListItem isDefault(@jakarta.annotation.Nullable Boolean isDefault) {
    this.isDefault = isDefault;
    return this;
  }

  /**
   * &#x60;true&#x60; if the policy is set as the global default policy
   * @return isDefault
   */
  @jakarta.annotation.Nullable
  ...
  public PolicyListItem projectCount(@jakarta.annotation.Nullable Integer projectCount) {
    this.projectCount = projectCount;
    return this;
  }

  /**
   * The number of projects the policy on which this policy is applied
   * @return projectCount
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PROJECT_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjectCount(@jakarta.annotation.Nullable Integer projectCount) {
    this.projectCount = projectCount;
  }


  public PolicyListItem projects(@jakarta.annotation.Nullable List<Project> projects) {
    this.projects = projects;
    return this;
  }

  public PolicyListItem addProjectsItem(Project projectsItem) {
  ...
  public PolicyListItem projectIds(@jakarta.annotation.Nullable List<Integer> projectIds) {
    this.projectIds = projectIds;
    return this;
  }

  public PolicyListItem addProjectIdsItem(Integer projectIdsItem) {
  ...
  /**
   * Return true if this PolicyListItem object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, policyListItem.id) &&
        ...
        Objects.equals(this.description, policyListItem.description) &&
        Objects.equals(this.creationTime, policyListItem.creationTime) &&
        Objects.equals(this.effectiveDate, policyListItem.effectiveDate) &&
        Objects.equals(this.isDefault, policyListItem.isDefault) &&
        Objects.equals(this.projectCount, policyListItem.projectCount) &&
        Objects.equals(this.projects, policyListItem.projects) &&
        Objects.equals(this.projectIds, policyListItem.projectIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, creationTime, effectiveDate, isDefault, projectCount, projects, projectIds);
  }
