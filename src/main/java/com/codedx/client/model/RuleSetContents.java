 ...
 */
@JsonPropertyOrder({
  RuleSetContents.JSON_PROPERTY_ID,
  RuleSetContents.JSON_PROPERTY_NAME,
  RuleSetContents.JSON_PROPERTY_RULES
})
...
public class RuleSetContents {
  ...
  public RuleSetContents() { 
  }

  public RuleSetContents id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public RuleSetContents name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RuleSetContents rules(@jakarta.annotation.Nullable List<Rule> rules) {
    this.rules = rules;
    return this;
  }
  ...
  /**
   * Return true if this RuleSetContents object is equal to o.
   */
  @Override
