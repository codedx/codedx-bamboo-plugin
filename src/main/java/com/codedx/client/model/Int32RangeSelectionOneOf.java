...
/**
 * Int32RangeSelectionOneOf
 */
@JsonPropertyOrder({
  Int32RangeSelectionOneOf.JSON_PROPERTY_MIN,
  Int32RangeSelectionOneOf.JSON_PROPERTY_MAX
})
@JsonTypeName("Int32RangeSelection_oneOf")
...
public class Int32RangeSelectionOneOf {
  ...
  public Int32RangeSelectionOneOf() { 
  }

  public Int32RangeSelectionOneOf min(@jakarta.annotation.Nullable Integer min) {
    this.min = min;
    return this;
  }
  ...
  public Int32RangeSelectionOneOf max(@jakarta.annotation.Nullable Integer max) {
    this.max = max;
    return this;
  }
  ...
  /**
   * Return true if this Int32RangeSelection_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    Int32RangeSelectionOneOf int32RangeSelectionOneOf = (Int32RangeSelectionOneOf) o;
    return Objects.equals(this.min, int32RangeSelectionOneOf.min) &&
        Objects.equals(this.max, int32RangeSelectionOneOf.max);
  }
  ...
  public String toString() {
    ...
    sb.append("class Int32RangeSelectionOneOf {\n");
