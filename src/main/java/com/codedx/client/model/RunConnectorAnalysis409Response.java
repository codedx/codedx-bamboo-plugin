...
/**
 * RunConnectorAnalysis409Response
 */
@JsonPropertyOrder({
  RunConnectorAnalysis409Response.JSON_PROPERTY_ERROR,
  RunConnectorAnalysis409Response.JSON_PROPERTY_DETAIL
})
@JsonTypeName("runConnectorAnalysis_409_response")
...
public class RunConnectorAnalysis409Response {
  ...
  @jakarta.annotation.Nullable
  private BranchSyncConfigError detail;

  public RunConnectorAnalysis409Response() { 
  }

  public RunConnectorAnalysis409Response error(@jakarta.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public RunConnectorAnalysis409Response detail(@jakarta.annotation.Nullable BranchSyncConfigError detail) {
    this.detail = detail;
    return this;
  }
  ...
  public BranchSyncConfigError getDetail() {
    return detail;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DETAIL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDetail(@jakarta.annotation.Nullable BranchSyncConfigError detail) {
    this.detail = detail;
  }


  /**
   * Return true if this runConnectorAnalysis_409_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RunConnectorAnalysis409Response runConnectorAnalysis409Response = (RunConnectorAnalysis409Response) o;
    return Objects.equals(this.error, runConnectorAnalysis409Response.error) &&
        Objects.equals(this.detail, runConnectorAnalysis409Response.detail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(error, detail);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RunConnectorAnalysis409Response {\n");
