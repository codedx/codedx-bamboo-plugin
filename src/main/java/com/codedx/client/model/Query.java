...
@JsonPropertyOrder({
  ...
  Query.JSON_PROPERTY_SORT,
  Query.JSON_PROPERTY_PAGINATION
})
...
public class Query {
  ...
  public Query filter(@jakarta.annotation.Nullable Filter filter) {
    this.filter = filter;
    return this;
  }
  ...
  public Query sort(@jakarta.annotation.Nullable Sort sort) {
    this.sort = sort;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SORT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSort(@jakarta.annotation.Nullable Sort sort) {
    this.sort = sort;
  }


  public Query pagination(@jakarta.annotation.Nullable Pagination pagination) {
