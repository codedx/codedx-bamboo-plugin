...
/**
 * Indicates a &#39;dynamic&#39; options provider, where options must be loaded via an API call associated with the corresponding form specifier
 */
@JsonPropertyOrder({
  InputFieldOptionsProviderOneOf1.JSON_PROPERTY_TYPE,
  InputFieldOptionsProviderOneOf1.JSON_PROPERTY_PLACEHOLDERS,
  InputFieldOptionsProviderOneOf1.JSON_PROPERTY_REQUIREMENTS
})
@JsonTypeName("InputField_optionsProvider_oneOf_1")
...
public class InputFieldOptionsProviderOneOf1 {
  /**
   * Gets or Sets type
   */
  ...
  @jakarta.annotation.Nonnull
  private RequiredFields requirements;

  public InputFieldOptionsProviderOneOf1() { 
  }

  public InputFieldOptionsProviderOneOf1 type(@jakarta.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public InputFieldOptionsProviderOneOf1 placeholders(@jakarta.annotation.Nonnull String placeholders) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PLACEHOLDERS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPlaceholders(@jakarta.annotation.Nonnull String placeholders) {
    this.placeholders = placeholders;
  }


  public InputFieldOptionsProviderOneOf1 requirements(@jakarta.annotation.Nonnull RequiredFields requirements) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_REQUIREMENTS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public RequiredFields getRequirements() {
    return requirements;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_REQUIREMENTS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRequirements(@jakarta.annotation.Nonnull RequiredFields requirements) {
    this.requirements = requirements;
  }


  /**
   * Return true if this InputField_optionsProvider_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    InputFieldOptionsProviderOneOf1 inputFieldOptionsProviderOneOf1 = (InputFieldOptionsProviderOneOf1) o;
    return Objects.equals(this.type, inputFieldOptionsProviderOneOf1.type) &&
        Objects.equals(this.placeholders, inputFieldOptionsProviderOneOf1.placeholders) &&
        Objects.equals(this.requirements, inputFieldOptionsProviderOneOf1.requirements);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, placeholders, requirements);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InputFieldOptionsProviderOneOf1 {\n");
