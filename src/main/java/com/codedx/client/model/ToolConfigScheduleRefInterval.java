...
import com.codedx.client.model.DailyUpdateSetting;
import com.codedx.client.model.FixedUpdateSetting;
import com.codedx.client.model.WeeklyUpdateSetting;
...
@JsonDeserialize(using = ToolConfigScheduleRefInterval.ToolConfigScheduleRefIntervalDeserializer.class)
@JsonSerialize(using = ToolConfigScheduleRefInterval.ToolConfigScheduleRefIntervalSerializer.class)
public class ToolConfigScheduleRefInterval extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ToolConfigScheduleRefInterval.class.getName());

    public static class ToolConfigScheduleRefIntervalSerializer extends StdSerializer<ToolConfigScheduleRefInterval> {
        public ToolConfigScheduleRefIntervalSerializer(Class<ToolConfigScheduleRefInterval> t) {
            super(t);
        }

        public ToolConfigScheduleRefIntervalSerializer() {
            this(null);
        }

        @Override
        public void serialize(ToolConfigScheduleRefInterval value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ToolConfigScheduleRefIntervalDeserializer extends StdDeserializer<ToolConfigScheduleRefInterval> {
        public ToolConfigScheduleRefIntervalDeserializer() {
            this(ToolConfigScheduleRefInterval.class);
        }

        public ToolConfigScheduleRefIntervalDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ToolConfigScheduleRefInterval deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize FixedUpdateSetting
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(FixedUpdateSetting.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'FixedUpdateSetting'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FixedUpdateSetting'", e);
            }

            // deserialize DailyUpdateSetting
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(DailyUpdateSetting.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'DailyUpdateSetting'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'DailyUpdateSetting'", e);
            }

            // deserialize WeeklyUpdateSetting
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(WeeklyUpdateSetting.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'WeeklyUpdateSetting'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'WeeklyUpdateSetting'", e);
            }
            ...
            if (match == 1) {
                ToolConfigScheduleRefInterval ret = new ToolConfigScheduleRefInterval();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ToolConfigScheduleRefInterval: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ToolConfigScheduleRefInterval getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ToolConfigScheduleRefInterval cannot be null");
        }
    }
    ...
    public ToolConfigScheduleRefInterval() {
        super("oneOf", Boolean.FALSE);
    }

    public ToolConfigScheduleRefInterval(FixedUpdateSetting o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ToolConfigScheduleRefInterval(DailyUpdateSetting o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ToolConfigScheduleRefInterval(WeeklyUpdateSetting o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ToolConfigScheduleRefInterval(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("DailyUpdateSetting", new GenericType<DailyUpdateSetting>() {
        });
        schemas.put("FixedUpdateSetting", new GenericType<FixedUpdateSetting>() {
        });
        schemas.put("WeeklyUpdateSetting", new GenericType<WeeklyUpdateSetting>() {
        });
        JSON.registerDescendants(ToolConfigScheduleRefInterval.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return ToolConfigScheduleRefInterval.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * Boolean, DailyUpdateSetting, FixedUpdateSetting, WeeklyUpdateSetting
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(FixedUpdateSetting.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(DailyUpdateSetting.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(WeeklyUpdateSetting.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be Boolean, DailyUpdateSetting, FixedUpdateSetting, WeeklyUpdateSetting");
    }
     ...
     * Boolean, DailyUpdateSetting, FixedUpdateSetting, WeeklyUpdateSetting
     *
     * @return The actual instance (Boolean, DailyUpdateSetting, FixedUpdateSetting, WeeklyUpdateSetting)
     */
    @Override
    ...
    /**
     * Get the actual instance of `FixedUpdateSetting`. If the actual instance is not `FixedUpdateSetting`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FixedUpdateSetting`
     * @throws ClassCastException if the instance is not `FixedUpdateSetting`
     */
    public FixedUpdateSetting getFixedUpdateSetting() throws ClassCastException {
        return (FixedUpdateSetting)super.getActualInstance();
    }

    /**
     * Get the actual instance of `DailyUpdateSetting`. If the actual instance is not `DailyUpdateSetting`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `DailyUpdateSetting`
     * @throws ClassCastException if the instance is not `DailyUpdateSetting`
     */
    public DailyUpdateSetting getDailyUpdateSetting() throws ClassCastException {
        return (DailyUpdateSetting)super.getActualInstance();
    }

    /**
     * Get the actual instance of `WeeklyUpdateSetting`. If the actual instance is not `WeeklyUpdateSetting`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `WeeklyUpdateSetting`
     * @throws ClassCastException if the instance is not `WeeklyUpdateSetting`
     */
    public WeeklyUpdateSetting getWeeklyUpdateSetting() throws ClassCastException {
        return (WeeklyUpdateSetting)super.getActualInstance();
    }
