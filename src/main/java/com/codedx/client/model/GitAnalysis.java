 ...
 */
@JsonPropertyOrder({
  GitAnalysis.JSON_PROPERTY_ANALYSIS_ID,
  GitAnalysis.JSON_PROPERTY_JOB_ID
})
...
public class GitAnalysis {
  public static final String JSON_PROPERTY_ANALYSIS_ID = "analysisId";
  private JsonNullable<Integer> analysisId = JsonNullable.<Integer>undefined();
  ...
  public GitAnalysis analysisId(@jakarta.annotation.Nullable Integer analysisId) {
    this.analysisId = JsonNullable.<Integer>of(analysisId);
    return this;
  }
  ...
  public Integer getAnalysisId() {
        return analysisId.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_ANALYSIS_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Integer> getAnalysisId_JsonNullable() {
    return analysisId;
  }
  
  @JsonProperty(JSON_PROPERTY_ANALYSIS_ID)
  public void setAnalysisId_JsonNullable(JsonNullable<Integer> analysisId) {
    this.analysisId = analysisId;
  }

  public void setAnalysisId(@jakarta.annotation.Nullable Integer analysisId) {
    this.analysisId = JsonNullable.<Integer>of(analysisId);
  }


  public GitAnalysis jobId(@jakarta.annotation.Nullable String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  /**
   * Return true if this GitAnalysis object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GitAnalysis gitAnalysis = (GitAnalysis) o;
    return equalsNullable(this.analysisId, gitAnalysis.analysisId) &&
        Objects.equals(this.jobId, gitAnalysis.jobId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(analysisId), jobId);
  }
