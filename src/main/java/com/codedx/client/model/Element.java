...
@JsonPropertyOrder({
  ...
  Element.JSON_PROPERTY_SHORT_NAME,
...
public class Element {
  ...
  public Element name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Element shortName(@jakarta.annotation.Nullable String shortName) {
  ...
  public Element type(@jakarta.annotation.Nullable ElementType type) {
    this.type = type;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setType(@jakarta.annotation.Nullable ElementType type) {
    this.type = type;
  }
