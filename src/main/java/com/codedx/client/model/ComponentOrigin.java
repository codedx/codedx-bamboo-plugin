...
import com.codedx.client.model.RiskCounts;
 ...
 */
@JsonPropertyOrder({
  ComponentOrigin.JSON_PROPERTY_FORGE,
  ComponentOrigin.JSON_PROPERTY_IDENTIFIER,
  ComponentOrigin.JSON_PROPERTY_PACKAGE_URL,
  ComponentOrigin.JSON_PROPERTY_RISK_COUNTS,
  ComponentOrigin.JSON_PROPERTY_UPGRADE_GUIDANCE
})
...
public class ComponentOrigin {
  public static final String JSON_PROPERTY_FORGE = "forge";
  ...
  public static final String JSON_PROPERTY_RISK_COUNTS = "riskCounts";
  @jakarta.annotation.Nullable
  private RiskCounts riskCounts;

  public static final String JSON_PROPERTY_UPGRADE_GUIDANCE = "upgradeGuidance";
  private JsonNullable<String> upgradeGuidance = JsonNullable.<String>undefined();

  public ComponentOrigin() { 
  }

  public ComponentOrigin forge(@jakarta.annotation.Nullable String forge) {
    this.forge = forge;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FORGE, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_FORGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setForge(@jakarta.annotation.Nullable String forge) {
    this.forge = forge;
  }


  public ComponentOrigin identifier(@jakarta.annotation.Nullable String identifier) {
  ...
  public ComponentOrigin packageUrl(@jakarta.annotation.Nullable String packageUrl) {
    this.packageUrl = JsonNullable.<String>of(packageUrl);
    return this;
  }
  ...
  public String getPackageUrl() {
        return packageUrl.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_PACKAGE_URL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getPackageUrl_JsonNullable() {
    return packageUrl;
  }
  
  @JsonProperty(JSON_PROPERTY_PACKAGE_URL)
  public void setPackageUrl_JsonNullable(JsonNullable<String> packageUrl) {
  ...
  public ComponentOrigin riskCounts(@jakarta.annotation.Nullable RiskCounts riskCounts) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RISK_COUNTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public RiskCounts getRiskCounts() {
    return riskCounts;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RISK_COUNTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRiskCounts(@jakarta.annotation.Nullable RiskCounts riskCounts) {
    this.riskCounts = riskCounts;
  }


  public ComponentOrigin upgradeGuidance(@jakarta.annotation.Nullable String upgradeGuidance) {
    this.upgradeGuidance = JsonNullable.<String>of(upgradeGuidance);
    return this;
  }
  ...
  public String getUpgradeGuidance() {
        return upgradeGuidance.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_UPGRADE_GUIDANCE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getUpgradeGuidance_JsonNullable() {
    return upgradeGuidance;
  }
  
  @JsonProperty(JSON_PROPERTY_UPGRADE_GUIDANCE)
  public void setUpgradeGuidance_JsonNullable(JsonNullable<String> upgradeGuidance) {
    this.upgradeGuidance = upgradeGuidance;
  }

  public void setUpgradeGuidance(@jakarta.annotation.Nullable String upgradeGuidance) {
    this.upgradeGuidance = JsonNullable.<String>of(upgradeGuidance);
  }


  /**
   * Return true if this ComponentOrigin object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ComponentOrigin componentOrigin = (ComponentOrigin) o;
    return Objects.equals(this.forge, componentOrigin.forge) &&
        Objects.equals(this.identifier, componentOrigin.identifier) &&
        equalsNullable(this.packageUrl, componentOrigin.packageUrl) &&
        Objects.equals(this.riskCounts, componentOrigin.riskCounts) &&
        equalsNullable(this.upgradeGuidance, componentOrigin.upgradeGuidance);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(forge, identifier, hashCodeNullable(packageUrl), riskCounts, hashCodeNullable(upgradeGuidance));
  }
  ...
  public String toString() {
    ...
    sb.append("class ComponentOrigin {\n");
    sb.append("    forge: ").append(toIndentedString(forge)).append("\n");
    ...
    sb.append("    upgradeGuidance: ").append(toIndentedString(upgradeGuidance)).append("\n");
    sb.append("}");
    return sb.toString();
  }
