...
import com.codedx.client.model.Int32RangeSelection;
...
/**
 * PredictedStatusSelection
 */
@JsonPropertyOrder({
  PredictedStatusSelection.JSON_PROPERTY_PREDICTED_STATUSES,
  PredictedStatusSelection.JSON_PROPERTY_CONFIDENCE
})
...
public class PredictedStatusSelection {
  public static final String JSON_PROPERTY_PREDICTED_STATUSES = "predictedStatuses";
  @jakarta.annotation.Nullable
  private List<String> predictedStatuses = new ArrayList<>();

  public static final String JSON_PROPERTY_CONFIDENCE = "confidence";
  @jakarta.annotation.Nullable
  private Int32RangeSelection confidence;

  public PredictedStatusSelection() { 
  }

  public PredictedStatusSelection predictedStatuses(@jakarta.annotation.Nullable List<String> predictedStatuses) {
    this.predictedStatuses = predictedStatuses;
    return this;
  }

  public PredictedStatusSelection addPredictedStatusesItem(String predictedStatusesItem) {
    if (this.predictedStatuses == null) {
      this.predictedStatuses = new ArrayList<>();
    }
    this.predictedStatuses.add(predictedStatusesItem);
    return this;
  }

  /**
   * Get predictedStatuses
   * @return predictedStatuses
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PREDICTED_STATUSES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<String> getPredictedStatuses() {
    return predictedStatuses;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PREDICTED_STATUSES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPredictedStatuses(@jakarta.annotation.Nullable List<String> predictedStatuses) {
    this.predictedStatuses = predictedStatuses;
  }


  public PredictedStatusSelection confidence(@jakarta.annotation.Nullable Int32RangeSelection confidence) {
  ...
  public Int32RangeSelection getConfidence() {
    return confidence;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONFIDENCE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConfidence(@jakarta.annotation.Nullable Int32RangeSelection confidence) {
    this.confidence = confidence;
  }


  /**
   * Return true if this PredictedStatusSelection object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PredictedStatusSelection predictedStatusSelection = (PredictedStatusSelection) o;
    return Objects.equals(this.predictedStatuses, predictedStatusSelection.predictedStatuses) &&
        Objects.equals(this.confidence, predictedStatusSelection.confidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(predictedStatuses, confidence);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PredictedStatusSelection {\n");
    sb.append("    predictedStatuses: ").append(toIndentedString(predictedStatuses)).append("\n");
