 ...
 */
@JsonPropertyOrder({
  GroupedCount.JSON_PROPERTY_ID,
  GroupedCount.JSON_PROPERTY_IS_SYNTHETIC,
  GroupedCount.JSON_PROPERTY_NAME,
  GroupedCount.JSON_PROPERTY_RANK,
  GroupedCount.JSON_PROPERTY_COUNT,
  GroupedCount.JSON_PROPERTY_CHILDREN
})
...
public class GroupedCount {
  ...
  public static final String JSON_PROPERTY_IS_SYNTHETIC = "isSynthetic";
  @jakarta.annotation.Nullable
  ...
  @jakarta.annotation.Nullable
  private List<GroupedCount> children = new ArrayList<>();

  public GroupedCount() { 
  }

  public GroupedCount id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public GroupedCount isSynthetic(@jakarta.annotation.Nullable Boolean isSynthetic) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_SYNTHETIC, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_SYNTHETIC, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsSynthetic(@jakarta.annotation.Nullable Boolean isSynthetic) {
    this.isSynthetic = isSynthetic;
  }


  public GroupedCount name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GroupedCount rank(@jakarta.annotation.Nullable Integer rank) {
    this.rank = rank;
    return this;
  }
  ...
  public GroupedCount count(@jakarta.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public GroupedCount children(@jakarta.annotation.Nullable List<GroupedCount> children) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CHILDREN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChildren(@jakarta.annotation.Nullable List<GroupedCount> children) {
    this.children = children;
  }


  /**
   * Return true if this GroupedCount object is equal to o.
   */
  @Override
