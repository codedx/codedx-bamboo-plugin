...
import com.codedx.client.model.RequiredFieldsOneOf;
import com.codedx.client.model.RequiredFieldsOneOf1;
...
@JsonDeserialize(using = RequiredFields.RequiredFieldsDeserializer.class)
@JsonSerialize(using = RequiredFields.RequiredFieldsSerializer.class)
public class RequiredFields extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(RequiredFields.class.getName());

    public static class RequiredFieldsSerializer extends StdSerializer<RequiredFields> {
        public RequiredFieldsSerializer(Class<RequiredFields> t) {
            super(t);
        }

        public RequiredFieldsSerializer() {
            this(null);
        }

        @Override
        public void serialize(RequiredFields value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class RequiredFieldsDeserializer extends StdDeserializer<RequiredFields> {
        public RequiredFieldsDeserializer() {
            this(RequiredFields.class);
        }

        public RequiredFieldsDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public RequiredFields deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize RequiredFieldsOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(RequiredFieldsOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'RequiredFieldsOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'RequiredFieldsOneOf'", e);
            }

            // deserialize RequiredFieldsOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(RequiredFieldsOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'RequiredFieldsOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'RequiredFieldsOneOf1'", e);
            }

            if (match == 1) {
                RequiredFields ret = new RequiredFields();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for RequiredFields: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public RequiredFields getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "RequiredFields cannot be null");
        }
    }
    ...
    public RequiredFields(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RequiredFields(RequiredFieldsOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RequiredFields(RequiredFieldsOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("RequiredFieldsOneOf", new GenericType<RequiredFieldsOneOf>() {
        });
        schemas.put("RequiredFieldsOneOf1", new GenericType<RequiredFieldsOneOf1>() {
        });
        schemas.put("String", new GenericType<String>() {
        });
        JSON.registerDescendants(RequiredFields.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return RequiredFields.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * RequiredFieldsOneOf, RequiredFieldsOneOf1, String
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(RequiredFieldsOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(RequiredFieldsOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be RequiredFieldsOneOf, RequiredFieldsOneOf1, String");
    }
     ...
     * RequiredFieldsOneOf, RequiredFieldsOneOf1, String
     *
     * @return The actual instance (RequiredFieldsOneOf, RequiredFieldsOneOf1, String)
     */
    @Override
    ...
    /**
     * Get the actual instance of `RequiredFieldsOneOf`. If the actual instance is not `RequiredFieldsOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `RequiredFieldsOneOf`
     * @throws ClassCastException if the instance is not `RequiredFieldsOneOf`
     */
    public RequiredFieldsOneOf getRequiredFieldsOneOf() throws ClassCastException {
        return (RequiredFieldsOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `RequiredFieldsOneOf1`. If the actual instance is not `RequiredFieldsOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `RequiredFieldsOneOf1`
     * @throws ClassCastException if the instance is not `RequiredFieldsOneOf1`
     */
    public RequiredFieldsOneOf1 getRequiredFieldsOneOf1() throws ClassCastException {
        return (RequiredFieldsOneOf1)super.getActualInstance();
    }
