...
import com.codedx.client.model.DashboardAnalysisResult;
...
/**
 * DashboardRecentAnalysisStats
 */
@JsonPropertyOrder({
  DashboardRecentAnalysisStats.JSON_PROPERTY_LATEST_SUCCESS,
  DashboardRecentAnalysisStats.JSON_PROPERTY_LATEST_FAILURE,
  DashboardRecentAnalysisStats.JSON_PROPERTY_PAST1_WEEK_COUNT,
  DashboardRecentAnalysisStats.JSON_PROPERTY_PAST4_WEEK_COUNT,
  DashboardRecentAnalysisStats.JSON_PROPERTY_PAST3_MONTH_COUNT
})
...
public class DashboardRecentAnalysisStats {
  public static final String JSON_PROPERTY_LATEST_SUCCESS = "latestSuccess";
  @jakarta.annotation.Nullable
  private DashboardAnalysisResult latestSuccess;

  public static final String JSON_PROPERTY_LATEST_FAILURE = "latestFailure";
  @jakarta.annotation.Nullable
  private DashboardAnalysisResult latestFailure;

  public static final String JSON_PROPERTY_PAST1_WEEK_COUNT = "past1WeekCount";
  @jakarta.annotation.Nonnull
  private Integer past1WeekCount;

  public static final String JSON_PROPERTY_PAST4_WEEK_COUNT = "past4WeekCount";
  @jakarta.annotation.Nonnull
  private Integer past4WeekCount;

  public static final String JSON_PROPERTY_PAST3_MONTH_COUNT = "past3MonthCount";
  @jakarta.annotation.Nonnull
  private Integer past3MonthCount;

  public DashboardRecentAnalysisStats() { 
  }

  public DashboardRecentAnalysisStats latestSuccess(@jakarta.annotation.Nullable DashboardAnalysisResult latestSuccess) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LATEST_SUCCESS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public DashboardAnalysisResult getLatestSuccess() {
    return latestSuccess;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_LATEST_SUCCESS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLatestSuccess(@jakarta.annotation.Nullable DashboardAnalysisResult latestSuccess) {
    this.latestSuccess = latestSuccess;
  }


  public DashboardRecentAnalysisStats latestFailure(@jakarta.annotation.Nullable DashboardAnalysisResult latestFailure) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_LATEST_FAILURE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public DashboardAnalysisResult getLatestFailure() {
    return latestFailure;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_LATEST_FAILURE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLatestFailure(@jakarta.annotation.Nullable DashboardAnalysisResult latestFailure) {
    this.latestFailure = latestFailure;
  }


  public DashboardRecentAnalysisStats past1WeekCount(@jakarta.annotation.Nonnull Integer past1WeekCount) {
    this.past1WeekCount = past1WeekCount;
    return this;
  }
   ...
   * Get past1WeekCount
   * minimum: 0
   * @return past1WeekCount
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_PAST1_WEEK_COUNT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Integer getPast1WeekCount() {
    return past1WeekCount;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PAST1_WEEK_COUNT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPast1WeekCount(@jakarta.annotation.Nonnull Integer past1WeekCount) {
    this.past1WeekCount = past1WeekCount;
  }


  public DashboardRecentAnalysisStats past4WeekCount(@jakarta.annotation.Nonnull Integer past4WeekCount) {
    this.past4WeekCount = past4WeekCount;
    return this;
  }
   ...
   * Get past4WeekCount
   * minimum: 0
   * @return past4WeekCount
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_PAST4_WEEK_COUNT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Integer getPast4WeekCount() {
    return past4WeekCount;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PAST4_WEEK_COUNT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPast4WeekCount(@jakarta.annotation.Nonnull Integer past4WeekCount) {
    this.past4WeekCount = past4WeekCount;
  }


  public DashboardRecentAnalysisStats past3MonthCount(@jakarta.annotation.Nonnull Integer past3MonthCount) {
    this.past3MonthCount = past3MonthCount;
    return this;
  }
   ...
   * Get past3MonthCount
   * minimum: 0
   * @return past3MonthCount
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_PAST3_MONTH_COUNT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Integer getPast3MonthCount() {
    return past3MonthCount;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PAST3_MONTH_COUNT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPast3MonthCount(@jakarta.annotation.Nonnull Integer past3MonthCount) {
    this.past3MonthCount = past3MonthCount;
  }


  /**
   * Return true if this DashboardRecentAnalysisStats object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardRecentAnalysisStats dashboardRecentAnalysisStats = (DashboardRecentAnalysisStats) o;
    return Objects.equals(this.latestSuccess, dashboardRecentAnalysisStats.latestSuccess) &&
        Objects.equals(this.latestFailure, dashboardRecentAnalysisStats.latestFailure) &&
        Objects.equals(this.past1WeekCount, dashboardRecentAnalysisStats.past1WeekCount) &&
        Objects.equals(this.past4WeekCount, dashboardRecentAnalysisStats.past4WeekCount) &&
        Objects.equals(this.past3MonthCount, dashboardRecentAnalysisStats.past3MonthCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(latestSuccess, latestFailure, past1WeekCount, past4WeekCount, past3MonthCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardRecentAnalysisStats {\n");
    sb.append("    latestSuccess: ").append(toIndentedString(latestSuccess)).append("\n");
    sb.append("    latestFailure: ").append(toIndentedString(latestFailure)).append("\n");
    sb.append("    past1WeekCount: ").append(toIndentedString(past1WeekCount)).append("\n");
    sb.append("    past4WeekCount: ").append(toIndentedString(past4WeekCount)).append("\n");
    sb.append("    past3MonthCount: ").append(toIndentedString(past3MonthCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }
