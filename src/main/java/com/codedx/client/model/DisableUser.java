 ...
 */
@JsonPropertyOrder({
  DisableUser.JSON_PROPERTY_IS_ENABLED,
  DisableUser.JSON_PROPERTY_IS_ADMIN
})
...
public class DisableUser {
  ...
  public DisableUser isEnabled(@jakarta.annotation.Nullable Boolean isEnabled) {
  ...
  public DisableUser isAdmin(@jakarta.annotation.Nullable Boolean isAdmin) {
  ...
  /**
   * Return true if this DisableUser object is equal to o.
   */
  @Override
