...
import com.codedx.client.model.BranchSpecifierOneOf;
import com.codedx.client.model.BranchSpecifierOneOfParent;
...
@JsonDeserialize(using = BranchSpecifier.BranchSpecifierDeserializer.class)
@JsonSerialize(using = BranchSpecifier.BranchSpecifierSerializer.class)
public class BranchSpecifier extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BranchSpecifier.class.getName());

    public static class BranchSpecifierSerializer extends StdSerializer<BranchSpecifier> {
        public BranchSpecifierSerializer(Class<BranchSpecifier> t) {
            super(t);
        }

        public BranchSpecifierSerializer() {
            this(null);
        }

        @Override
        public void serialize(BranchSpecifier value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class BranchSpecifierDeserializer extends StdDeserializer<BranchSpecifier> {
        public BranchSpecifierDeserializer() {
            this(BranchSpecifier.class);
        }

        public BranchSpecifierDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public BranchSpecifier deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize BranchSpecifierOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(BranchSpecifierOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'BranchSpecifierOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'BranchSpecifierOneOf'", e);
            }

            if (match == 1) {
                BranchSpecifier ret = new BranchSpecifier();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for BranchSpecifier: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public BranchSpecifier getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "BranchSpecifier cannot be null");
        }
    }
    ...
    public BranchSpecifier() {
        super("oneOf", Boolean.FALSE);
    }

    public BranchSpecifier(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BranchSpecifier(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BranchSpecifier(BranchSpecifierOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("BranchSpecifierOneOf", new GenericType<BranchSpecifierOneOf>() {
        });
        schemas.put("String", new GenericType<String>() {
        });
        JSON.registerDescendants(BranchSpecifier.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return BranchSpecifier.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * BigDecimal, BranchSpecifierOneOf, String
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(BranchSpecifierOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be BigDecimal, BranchSpecifierOneOf, String");
    }
     ...
     * BigDecimal, BranchSpecifierOneOf, String
     *
     * @return The actual instance (BigDecimal, BranchSpecifierOneOf, String)
     */
    @Override
    ...
    /**
     * Get the actual instance of `BranchSpecifierOneOf`. If the actual instance is not `BranchSpecifierOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `BranchSpecifierOneOf`
     * @throws ClassCastException if the instance is not `BranchSpecifierOneOf`
     */
    public BranchSpecifierOneOf getBranchSpecifierOneOf() throws ClassCastException {
        return (BranchSpecifierOneOf)super.getActualInstance();
    }
