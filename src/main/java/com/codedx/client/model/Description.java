...
@JsonPropertyOrder({
  ...
  Description.JSON_PROPERTY_CONTENT
})
...
public class Description {
  ...
  public Description format(@jakarta.annotation.Nullable DescriptionFormat format) {
    this.format = format;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FORMAT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFormat(@jakarta.annotation.Nullable DescriptionFormat format) {
    this.format = format;
  }


  public Description content(@jakarta.annotation.Nullable String content) {
