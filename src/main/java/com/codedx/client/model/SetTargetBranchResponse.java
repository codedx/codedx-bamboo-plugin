...
/**
 * SetTargetBranchResponse
 */
@JsonPropertyOrder({
  SetTargetBranchResponse.JSON_PROPERTY_CONNECTOR_BINDINGS,
  SetTargetBranchResponse.JSON_PROPERTY_INPUTS,
  SetTargetBranchResponse.JSON_PROPERTY_DYNAMIC_TOOLS,
  SetTargetBranchResponse.JSON_PROPERTY_TOOL_CONNECTORS
})
...
public class SetTargetBranchResponse {
  public static final String JSON_PROPERTY_CONNECTOR_BINDINGS = "connectorBindings";
  @jakarta.annotation.Nullable
  private List<DisplayTagState> connectorBindings = new ArrayList<>();
  ...
  public SetTargetBranchResponse() { 
  }

  public SetTargetBranchResponse connectorBindings(@jakarta.annotation.Nullable List<DisplayTagState> connectorBindings) {
    this.connectorBindings = connectorBindings;
    return this;
  }

  public SetTargetBranchResponse addConnectorBindingsItem(DisplayTagState connectorBindingsItem) {
    if (this.connectorBindings == null) {
      this.connectorBindings = new ArrayList<>();
    }
    this.connectorBindings.add(connectorBindingsItem);
    return this;
  }

  /**
   * An array representing any Connector Bindings configured on the related project which also enabled the &#39;Available During Analysis&#39; flag
   * @return connectorBindings
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONNECTOR_BINDINGS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<DisplayTagState> getConnectorBindings() {
    return connectorBindings;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONNECTOR_BINDINGS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConnectorBindings(@jakarta.annotation.Nullable List<DisplayTagState> connectorBindings) {
    this.connectorBindings = connectorBindings;
  }


  public SetTargetBranchResponse inputs(@jakarta.annotation.Nullable Map<String, Object> inputs) {
    this.inputs = inputs;
    return this;
  }

  public SetTargetBranchResponse putInputsItem(String key, Object inputsItem) {
    if (this.inputs == null) {
  ...
  /**
   * An object containing objects that describe the items being analyzed.
   * @return inputs
   */
  @jakarta.annotation.Nullable
  ...
  public SetTargetBranchResponse dynamicTools(@jakarta.annotation.Nullable List<DynamicAddInToolDisplayTag> dynamicTools) {
    this.dynamicTools = dynamicTools;
    return this;
  }

  public SetTargetBranchResponse addDynamicToolsItem(DynamicAddInToolDisplayTag dynamicToolsItem) {
  ...
  public SetTargetBranchResponse toolConnectors(@jakarta.annotation.Nullable List<DisplayTagState> toolConnectors) {
    this.toolConnectors = toolConnectors;
    return this;
  }

  public SetTargetBranchResponse addToolConnectorsItem(DisplayTagState toolConnectorsItem) {
  ...
  /**
   * Return true if this SetTargetBranchResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SetTargetBranchResponse setTargetBranchResponse = (SetTargetBranchResponse) o;
    return Objects.equals(this.connectorBindings, setTargetBranchResponse.connectorBindings) &&
        Objects.equals(this.inputs, setTargetBranchResponse.inputs) &&
        Objects.equals(this.dynamicTools, setTargetBranchResponse.dynamicTools) &&
        Objects.equals(this.toolConnectors, setTargetBranchResponse.toolConnectors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectorBindings, inputs, dynamicTools, toolConnectors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetTargetBranchResponse {\n");
    sb.append("    connectorBindings: ").append(toIndentedString(connectorBindings)).append("\n");
