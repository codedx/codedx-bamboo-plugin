 ...
 */
@JsonPropertyOrder({
  ManualResultResponse.JSON_PROPERTY_RESULT_ID,
  ManualResultResponse.JSON_PROPERTY_FINDING_IDS
})
...
public class ManualResultResponse {
  ...
  public static final String JSON_PROPERTY_FINDING_IDS = "findingIds";
  @jakarta.annotation.Nullable
  private List<Integer> findingIds = new ArrayList<>();

  public ManualResultResponse() { 
  }

  public ManualResultResponse resultId(@jakarta.annotation.Nullable Integer resultId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RESULT_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResultId(@jakarta.annotation.Nullable Integer resultId) {
    this.resultId = resultId;
  }


  public ManualResultResponse findingIds(@jakarta.annotation.Nullable List<Integer> findingIds) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FINDING_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_FINDING_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFindingIds(@jakarta.annotation.Nullable List<Integer> findingIds) {
    this.findingIds = findingIds;
  }


  /**
   * Return true if this ManualResultResponse object is equal to o.
   */
  @Override
