...
@JsonPropertyOrder({
  ...
  Rule.JSON_PROPERTY_RULE_SET,
  Rule.JSON_PROPERTY_DESCRIPTOR,
  Rule.JSON_PROPERTY_CRITERIA
})
...
public class Rule {
  ...
  public Rule id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Rule ruleSet(@jakarta.annotation.Nullable RuleSet ruleSet) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RULE_SET, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_RULE_SET, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRuleSet(@jakarta.annotation.Nullable RuleSet ruleSet) {
    this.ruleSet = ruleSet;
  }


  public Rule descriptor(@jakarta.annotation.Nullable RuleDescriptor descriptor) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DESCRIPTOR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDescriptor(@jakarta.annotation.Nullable RuleDescriptor descriptor) {
    this.descriptor = descriptor;
  }


  public Rule criteria(@jakarta.annotation.Nullable List<RuleCriteria> criteria) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CRITERIA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCriteria(@jakarta.annotation.Nullable List<RuleCriteria> criteria) {
    this.criteria = criteria;
  }
