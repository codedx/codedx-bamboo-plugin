 ...
 */
@JsonPropertyOrder({
  ImportNewProject.JSON_PROPERTY_NAME,
  ImportNewProject.JSON_PROPERTY_BRANCH,
  ImportNewProject.JSON_PROPERTY_PARENT_ID,
  ImportNewProject.JSON_PROPERTY_NEW_PARENTS
})
...
public class ImportNewProject {
  ...
  public static final String JSON_PROPERTY_NEW_PARENTS = "newParents";
  @jakarta.annotation.Nullable
  private List<String> newParents = new ArrayList<>();

  public ImportNewProject() { 
  }

  public ImportNewProject name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ImportNewProject branch(@jakarta.annotation.Nullable String branch) {
    this.branch = branch;
    return this;
  }
  ...
  public ImportNewProject parentId(@jakarta.annotation.Nullable Integer parentId) {
  ...
  public ImportNewProject newParents(@jakarta.annotation.Nullable List<String> newParents) {
    this.newParents = newParents;
    return this;
  }

  public ImportNewProject addNewParentsItem(String newParentsItem) {
    if (this.newParents == null) {
      this.newParents = new ArrayList<>();
    }
    this.newParents.add(newParentsItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_NEW_PARENTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<String> getNewParents() {
    return newParents;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_NEW_PARENTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNewParents(@jakarta.annotation.Nullable List<String> newParents) {
    this.newParents = newParents;
  }


  /**
   * Return true if this ImportNewProject object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ImportNewProject importNewProject = (ImportNewProject) o;
    return Objects.equals(this.name, importNewProject.name) &&
        Objects.equals(this.branch, importNewProject.branch) &&
        Objects.equals(this.parentId, importNewProject.parentId) &&
        Objects.equals(this.newParents, importNewProject.newParents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, branch, parentId, newParents);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportNewProject {\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    branch: ").append(toIndentedString(branch)).append("\n");
    sb.append("    parentId: ").append(toIndentedString(parentId)).append("\n");
    sb.append("    newParents: ").append(toIndentedString(newParents)).append("\n");
    sb.append("}");
    return sb.toString();
  }
