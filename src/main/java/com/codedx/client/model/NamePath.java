...
@JsonDeserialize(using = NamePath.NamePathDeserializer.class)
@JsonSerialize(using = NamePath.NamePathSerializer.class)
public class NamePath extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(NamePath.class.getName());

    public static class NamePathSerializer extends StdSerializer<NamePath> {
        public NamePathSerializer(Class<NamePath> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(NamePath value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class NamePathDeserializer extends StdDeserializer<NamePath> {
        public NamePathDeserializer() {
            this(NamePath.class);
        }

        public NamePathDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public NamePath deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                NamePath ret = new NamePath();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for NamePath: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public NamePath getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "NamePath cannot be null");
        }
    }
    ...
    public NamePath(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public NamePath(List o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(NamePath.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return NamePath.schemas;
    }
