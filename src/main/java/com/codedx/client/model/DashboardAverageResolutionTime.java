...
import com.codedx.client.model.DashboardAverageResolutionTimeStats;
 ...
 */
@JsonPropertyOrder({
  DashboardAverageResolutionTime.JSON_PROPERTY_UNSPECIFIED,
  DashboardAverageResolutionTime.JSON_PROPERTY_INFO,
  DashboardAverageResolutionTime.JSON_PROPERTY_LOW,
  DashboardAverageResolutionTime.JSON_PROPERTY_MEDIUM,
  DashboardAverageResolutionTime.JSON_PROPERTY_HIGH,
  DashboardAverageResolutionTime.JSON_PROPERTY_CRITICAL
})
...
public class DashboardAverageResolutionTime {
  public static final String JSON_PROPERTY_UNSPECIFIED = "Unspecified";
  @jakarta.annotation.Nullable
  private DashboardAverageResolutionTimeStats unspecified;

  public static final String JSON_PROPERTY_INFO = "Info";
  @jakarta.annotation.Nullable
  private DashboardAverageResolutionTimeStats info;

  public static final String JSON_PROPERTY_LOW = "Low";
  @jakarta.annotation.Nullable
  private DashboardAverageResolutionTimeStats low;

  public static final String JSON_PROPERTY_MEDIUM = "Medium";
  @jakarta.annotation.Nullable
  private DashboardAverageResolutionTimeStats medium;

  public static final String JSON_PROPERTY_HIGH = "High";
  @jakarta.annotation.Nullable
  private DashboardAverageResolutionTimeStats high;

  public static final String JSON_PROPERTY_CRITICAL = "Critical";
  @jakarta.annotation.Nullable
  private DashboardAverageResolutionTimeStats critical;

  public DashboardAverageResolutionTime() { 
  }

  public DashboardAverageResolutionTime unspecified(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats unspecified) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_UNSPECIFIED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public DashboardAverageResolutionTimeStats getUnspecified() {
    return unspecified;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_UNSPECIFIED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUnspecified(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats unspecified) {
    this.unspecified = unspecified;
  }


  public DashboardAverageResolutionTime info(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats info) {
    this.info = info;
    return this;
  }
  ...
  public DashboardAverageResolutionTimeStats getInfo() {
    return info;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INFO, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInfo(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats info) {
    this.info = info;
  }


  public DashboardAverageResolutionTime low(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats low) {
    this.low = low;
    return this;
  }
  ...
  public DashboardAverageResolutionTimeStats getLow() {
    return low;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_LOW, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLow(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats low) {
    this.low = low;
  }


  public DashboardAverageResolutionTime medium(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats medium) {
    this.medium = medium;
    return this;
  }
  ...
  public DashboardAverageResolutionTimeStats getMedium() {
    return medium;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_MEDIUM, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMedium(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats medium) {
    this.medium = medium;
  }


  public DashboardAverageResolutionTime high(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats high) {
    this.high = high;
    return this;
  }
  ...
  public DashboardAverageResolutionTimeStats getHigh() {
    return high;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_HIGH, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHigh(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats high) {
    this.high = high;
  }


  public DashboardAverageResolutionTime critical(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats critical) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CRITICAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public DashboardAverageResolutionTimeStats getCritical() {
    return critical;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CRITICAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCritical(@jakarta.annotation.Nullable DashboardAverageResolutionTimeStats critical) {
    this.critical = critical;
  }


  /**
   * Return true if this DashboardAverageResolutionTime object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardAverageResolutionTime dashboardAverageResolutionTime = (DashboardAverageResolutionTime) o;
    return Objects.equals(this.unspecified, dashboardAverageResolutionTime.unspecified) &&
        Objects.equals(this.info, dashboardAverageResolutionTime.info) &&
        Objects.equals(this.low, dashboardAverageResolutionTime.low) &&
        Objects.equals(this.medium, dashboardAverageResolutionTime.medium) &&
        Objects.equals(this.high, dashboardAverageResolutionTime.high) &&
        Objects.equals(this.critical, dashboardAverageResolutionTime.critical);
  }

  @Override
  public int hashCode() {
    return Objects.hash(unspecified, info, low, medium, high, critical);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DashboardAverageResolutionTime {\n");
