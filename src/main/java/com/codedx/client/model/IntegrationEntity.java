...
/**
 * An integration entity consists of a name, a mapping of keys and values corresponding to fields that are relevant to that entity, and relevant identifying information.
 */
@JsonPropertyOrder({
  IntegrationEntity.JSON_PROPERTY_NAME,
  IntegrationEntity.JSON_PROPERTY_VALUES,
  IntegrationEntity.JSON_PROPERTY_ENTITY_ID,
  IntegrationEntity.JSON_PROPERTY_ENTITY_TYPE,
  IntegrationEntity.JSON_PROPERTY_IDENTIFIER_ID
})
...
public class IntegrationEntity {
  ...
  public static final String JSON_PROPERTY_IDENTIFIER_ID = "identifierId";
  @jakarta.annotation.Nullable
  ...
  public IntegrationEntity name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public IntegrationEntity values(@jakarta.annotation.Nullable Map<String, String> values) {
    this.values = values;
    return this;
  }

  public IntegrationEntity putValuesItem(String key, String valuesItem) {
    if (this.values == null) {
  ...
  /**
   * A mapping of keys and values corresponding to fields that are relevant to the entity.
   * @return values
   */
  @jakarta.annotation.Nullable
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValues(@jakarta.annotation.Nullable Map<String, String> values) {
    this.values = values;
  }


  public IntegrationEntity entityId(@jakarta.annotation.Nullable Integer entityId) {
  ...
  public IntegrationEntity entityType(@jakarta.annotation.Nullable EntityTypeEnum entityType) {
  ...
  public IntegrationEntity identifierId(@jakarta.annotation.Nullable Integer identifierId) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IDENTIFIER_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IDENTIFIER_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIdentifierId(@jakarta.annotation.Nullable Integer identifierId) {
    this.identifierId = identifierId;
  }


  /**
   * Return true if this IntegrationEntity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, integrationEntity.name) &&
        Objects.equals(this.values, integrationEntity.values) &&
        Objects.equals(this.entityId, integrationEntity.entityId) &&
        Objects.equals(this.entityType, integrationEntity.entityType) &&
        Objects.equals(this.identifierId, integrationEntity.identifierId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, values, entityId, entityType, identifierId);
  }
