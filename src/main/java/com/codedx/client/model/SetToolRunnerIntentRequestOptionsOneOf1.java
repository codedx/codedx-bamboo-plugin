...
/**
 * Black Duck SCA Options
 */
@JsonPropertyOrder({
  SetToolRunnerIntentRequestOptionsOneOf1.JSON_PROPERTY_STORAGE_ID,
  SetToolRunnerIntentRequestOptionsOneOf1.JSON_PROPERTY_VERSION
})
@JsonTypeName("setToolRunnerIntent_request_options_oneOf_1")
...
public class SetToolRunnerIntentRequestOptionsOneOf1 {
  ...
  public SetToolRunnerIntentRequestOptionsOneOf1() { 
  }

  public SetToolRunnerIntentRequestOptionsOneOf1 storageId(@jakarta.annotation.Nullable String storageId) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_STORAGE_ID, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_STORAGE_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStorageId(@jakarta.annotation.Nullable String storageId) {
    this.storageId = storageId;
  }


  public SetToolRunnerIntentRequestOptionsOneOf1 version(@jakarta.annotation.Nullable String version) {
  ...
  /**
   * Return true if this setToolRunnerIntent_request_options_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SetToolRunnerIntentRequestOptionsOneOf1 setToolRunnerIntentRequestOptionsOneOf1 = (SetToolRunnerIntentRequestOptionsOneOf1) o;
    return Objects.equals(this.storageId, setToolRunnerIntentRequestOptionsOneOf1.storageId) &&
        Objects.equals(this.version, setToolRunnerIntentRequestOptionsOneOf1.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(storageId, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SetToolRunnerIntentRequestOptionsOneOf1 {\n");
