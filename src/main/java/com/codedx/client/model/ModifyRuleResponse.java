 ...
 */
@JsonPropertyOrder({
  ModifyRuleResponse.JSON_PROPERTY_ID,
  ModifyRuleResponse.JSON_PROPERTY_NAME,
  ModifyRuleResponse.JSON_PROPERTY_SEVERITY,
  ModifyRuleResponse.JSON_PROPERTY_CWE,
  ModifyRuleResponse.JSON_PROPERTY_DESCRIPTION,
  ModifyRuleResponse.JSON_PROPERTY_GROUP
})
...
public class ModifyRuleResponse {
  ...
  public ModifyRuleResponse id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ModifyRuleResponse name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ModifyRuleResponse severity(@jakarta.annotation.Nullable Severity severity) {
  ...
  public ModifyRuleResponse cwe(@jakarta.annotation.Nullable Cwe cwe) {
    this.cwe = cwe;
    return this;
  }
  ...
  public ModifyRuleResponse description(@jakarta.annotation.Nullable Description description) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DESCRIPTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDescription(@jakarta.annotation.Nullable Description description) {
    this.description = description;
  }


  public ModifyRuleResponse group(@jakarta.annotation.Nullable RuleGroup group) {
    this.group = group;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_GROUP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGroup(@jakarta.annotation.Nullable RuleGroup group) {
    this.group = group;
  }


  /**
   * Return true if this ModifyRuleResponse object is equal to o.
   */
  @Override
