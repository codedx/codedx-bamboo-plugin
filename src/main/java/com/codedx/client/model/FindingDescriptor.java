 ...
 */
@JsonPropertyOrder({
  FindingDescriptor.JSON_PROPERTY_ID,
  FindingDescriptor.JSON_PROPERTY_CODE,
  FindingDescriptor.JSON_PROPERTY_NAME,
  FindingDescriptor.JSON_PROPERTY_TYPE,
  FindingDescriptor.JSON_PROPERTY_CWE,
  FindingDescriptor.JSON_PROPERTY_HIERARCHY
})
...
public class FindingDescriptor {
  ...
  public FindingDescriptor() { 
  }

  public FindingDescriptor id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public FindingDescriptor code(@jakarta.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public FindingDescriptor name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public FindingDescriptor type(@jakarta.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public FindingDescriptor cwe(@jakarta.annotation.Nullable Cwe cwe) {
    this.cwe = cwe;
    return this;
  }
  ...
  public FindingDescriptor hierarchy(@jakarta.annotation.Nullable List<String> hierarchy) {
  ...
  @JsonProperty(value = JSON_PROPERTY_HIERARCHY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHierarchy(@jakarta.annotation.Nullable List<String> hierarchy) {
    this.hierarchy = hierarchy;
  }


  /**
   * Return true if this FindingDescriptor object is equal to o.
   */
  @Override
