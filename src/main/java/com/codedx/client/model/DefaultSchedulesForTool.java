...
import com.codedx.client.model.DefaultSchedulesForToolProjectDefaultsInner;
...
/**
 * DefaultSchedulesForTool
 */
@JsonPropertyOrder({
  DefaultSchedulesForTool.JSON_PROPERTY_GLOBAL_DEFAULT,
  DefaultSchedulesForTool.JSON_PROPERTY_TOOL_DEFAULT,
  DefaultSchedulesForTool.JSON_PROPERTY_PROJECT_DEFAULTS
})
...
public class DefaultSchedulesForTool {
  public static final String JSON_PROPERTY_GLOBAL_DEFAULT = "globalDefault";
  @jakarta.annotation.Nullable
  private Integer globalDefault;

  public static final String JSON_PROPERTY_TOOL_DEFAULT = "toolDefault";
  @jakarta.annotation.Nullable
  private Integer toolDefault;

  public static final String JSON_PROPERTY_PROJECT_DEFAULTS = "projectDefaults";
  @jakarta.annotation.Nullable
  private List<DefaultSchedulesForToolProjectDefaultsInner> projectDefaults = new ArrayList<>();

  public DefaultSchedulesForTool() { 
  }

  public DefaultSchedulesForTool globalDefault(@jakarta.annotation.Nullable Integer globalDefault) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_GLOBAL_DEFAULT, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_GLOBAL_DEFAULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGlobalDefault(@jakarta.annotation.Nullable Integer globalDefault) {
    this.globalDefault = globalDefault;
  }


  public DefaultSchedulesForTool toolDefault(@jakarta.annotation.Nullable Integer toolDefault) {
    this.toolDefault = toolDefault;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_TOOL_DEFAULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getToolDefault() {
    return toolDefault;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TOOL_DEFAULT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setToolDefault(@jakarta.annotation.Nullable Integer toolDefault) {
    this.toolDefault = toolDefault;
  }


  public DefaultSchedulesForTool projectDefaults(@jakarta.annotation.Nullable List<DefaultSchedulesForToolProjectDefaultsInner> projectDefaults) {
    this.projectDefaults = projectDefaults;
    return this;
  }

  public DefaultSchedulesForTool addProjectDefaultsItem(DefaultSchedulesForToolProjectDefaultsInner projectDefaultsItem) {
    if (this.projectDefaults == null) {
      this.projectDefaults = new ArrayList<>();
    }
    this.projectDefaults.add(projectDefaultsItem);
    return this;
  }

  /**
   * An array of objects containing the project default Schedule IDs and the Project, Project Entity, and Connection Entity IDs
   * @return projectDefaults
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PROJECT_DEFAULTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<DefaultSchedulesForToolProjectDefaultsInner> getProjectDefaults() {
    return projectDefaults;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT_DEFAULTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjectDefaults(@jakarta.annotation.Nullable List<DefaultSchedulesForToolProjectDefaultsInner> projectDefaults) {
    this.projectDefaults = projectDefaults;
  }


  /**
   * Return true if this DefaultSchedulesForTool object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DefaultSchedulesForTool defaultSchedulesForTool = (DefaultSchedulesForTool) o;
    return Objects.equals(this.globalDefault, defaultSchedulesForTool.globalDefault) &&
        Objects.equals(this.toolDefault, defaultSchedulesForTool.toolDefault) &&
        Objects.equals(this.projectDefaults, defaultSchedulesForTool.projectDefaults);
  }

  @Override
  public int hashCode() {
    return Objects.hash(globalDefault, toolDefault, projectDefaults);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DefaultSchedulesForTool {\n");
    sb.append("    globalDefault: ").append(toIndentedString(globalDefault)).append("\n");
    sb.append("    toolDefault: ").append(toIndentedString(toolDefault)).append("\n");
    sb.append("    projectDefaults: ").append(toIndentedString(projectDefaults)).append("\n");
    sb.append("}");
    return sb.toString();
  }
