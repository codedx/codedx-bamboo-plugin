...
/**
 * ConnectorValidationTokens
 */
@JsonPropertyOrder({
  ConnectorValidationTokens.JSON_PROPERTY_CONNECTION,
  ConnectorValidationTokens.JSON_PROPERTY_PROJECT,
  ConnectorValidationTokens.JSON_PROPERTY_VERSION
})
...
public class ConnectorValidationTokens {
  public static final String JSON_PROPERTY_CONNECTION = "connection";
  private JsonNullable<String> connection = JsonNullable.<String>undefined();
  ...
  public ConnectorValidationTokens() { 
  }

  public ConnectorValidationTokens connection(@jakarta.annotation.Nullable String connection) {
    this.connection = JsonNullable.<String>of(connection);
    return this;
  }

  /**
   * A validation token previously returned by the tool connector form validation endpoint. May be omitted when not attempting to change values in the Connection form
   * @return connection
   */
  ...
  public JsonNullable<String> getConnection_JsonNullable() {
    return connection;
  }
  
  @JsonProperty(JSON_PROPERTY_CONNECTION)
  public void setConnection_JsonNullable(JsonNullable<String> connection) {
  ...
  public ConnectorValidationTokens project(@jakarta.annotation.Nullable String project) {
    this.project = JsonNullable.<String>of(project);
    return this;
  }

  /**
   * A validation token previously returned by the tool connector form validation endpoint. May be omitted when not attempting to change values in the Project form
   * @return project
   */
  @jakarta.annotation.Nullable
  @JsonIgnore
  ...
  public ConnectorValidationTokens version(@jakarta.annotation.Nullable String version) {
    this.version = JsonNullable.<String>of(version);
    return this;
  }

  /**
   * A validation token previously returned by the tool connector form validation endpoint. May be omitted when not attempting to change values in the Version form, or if the affected entity is has &#x60;useDynamicVersion&#x60; set
   * @return version
   */
  @jakarta.annotation.Nullable
  @JsonIgnore
  ...
  /**
   * Return true if this ConnectorValidationTokens object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ConnectorValidationTokens connectorValidationTokens = (ConnectorValidationTokens) o;
    return equalsNullable(this.connection, connectorValidationTokens.connection) &&
        equalsNullable(this.project, connectorValidationTokens.project) &&
        equalsNullable(this.version, connectorValidationTokens.version);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(connection), hashCodeNullable(project), hashCodeNullable(version));
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectorValidationTokens {\n");
