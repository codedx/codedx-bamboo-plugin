...
/**
 * XML report form values
 */
@JsonPropertyOrder({
  CreateReportTemplateRequestFormValuesOneOf3.JSON_PROPERTY_STANDARDS,
  CreateReportTemplateRequestFormValuesOneOf3.JSON_PROPERTY_SOURCE_SNIPPETS,
  CreateReportTemplateRequestFormValuesOneOf3.JSON_PROPERTY_RULE_DESCRIPTIONS
})
@JsonTypeName("createReportTemplate_request_formValues_oneOf_3")
...
public class CreateReportTemplateRequestFormValuesOneOf3 {
  public static final String JSON_PROPERTY_STANDARDS = "standards";
  @jakarta.annotation.Nullable
  private Boolean standards;

  public static final String JSON_PROPERTY_SOURCE_SNIPPETS = "source-snippets";
  @jakarta.annotation.Nullable
  private Boolean sourceSnippets;

  public static final String JSON_PROPERTY_RULE_DESCRIPTIONS = "rule-descriptions";
  @jakarta.annotation.Nullable
  private Boolean ruleDescriptions;

  public CreateReportTemplateRequestFormValuesOneOf3() { 
  }

  public CreateReportTemplateRequestFormValuesOneOf3 standards(@jakarta.annotation.Nullable Boolean standards) {
  ...
  public CreateReportTemplateRequestFormValuesOneOf3 sourceSnippets(@jakarta.annotation.Nullable Boolean sourceSnippets) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SOURCE_SNIPPETS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getSourceSnippets() {
    return sourceSnippets;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SOURCE_SNIPPETS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSourceSnippets(@jakarta.annotation.Nullable Boolean sourceSnippets) {
    this.sourceSnippets = sourceSnippets;
  }


  public CreateReportTemplateRequestFormValuesOneOf3 ruleDescriptions(@jakarta.annotation.Nullable Boolean ruleDescriptions) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RULE_DESCRIPTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getRuleDescriptions() {
    return ruleDescriptions;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RULE_DESCRIPTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRuleDescriptions(@jakarta.annotation.Nullable Boolean ruleDescriptions) {
    this.ruleDescriptions = ruleDescriptions;
  }


  /**
   * Return true if this createReportTemplate_request_formValues_oneOf_3 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateReportTemplateRequestFormValuesOneOf3 createReportTemplateRequestFormValuesOneOf3 = (CreateReportTemplateRequestFormValuesOneOf3) o;
    return Objects.equals(this.standards, createReportTemplateRequestFormValuesOneOf3.standards) &&
        Objects.equals(this.sourceSnippets, createReportTemplateRequestFormValuesOneOf3.sourceSnippets) &&
        Objects.equals(this.ruleDescriptions, createReportTemplateRequestFormValuesOneOf3.ruleDescriptions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(standards, sourceSnippets, ruleDescriptions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateReportTemplateRequestFormValuesOneOf3 {\n");
    sb.append("    standards: ").append(toIndentedString(standards)).append("\n");
    sb.append("    sourceSnippets: ").append(toIndentedString(sourceSnippets)).append("\n");
    sb.append("    ruleDescriptions: ").append(toIndentedString(ruleDescriptions)).append("\n");
    sb.append("}");
    return sb.toString();
  }
