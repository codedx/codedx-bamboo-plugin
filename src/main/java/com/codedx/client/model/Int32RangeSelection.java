...
import com.codedx.client.model.Int32RangeSelectionOneOf;
import com.codedx.client.model.Int32RangeSelectionOneOf1;
import com.codedx.client.model.Int32RangeSelectionOneOf2;
...
@JsonDeserialize(using = Int32RangeSelection.Int32RangeSelectionDeserializer.class)
@JsonSerialize(using = Int32RangeSelection.Int32RangeSelectionSerializer.class)
public class Int32RangeSelection extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Int32RangeSelection.class.getName());

    public static class Int32RangeSelectionSerializer extends StdSerializer<Int32RangeSelection> {
        public Int32RangeSelectionSerializer(Class<Int32RangeSelection> t) {
            super(t);
        }

        public Int32RangeSelectionSerializer() {
            this(null);
        }

        @Override
        public void serialize(Int32RangeSelection value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class Int32RangeSelectionDeserializer extends StdDeserializer<Int32RangeSelection> {
        public Int32RangeSelectionDeserializer() {
            this(Int32RangeSelection.class);
        }

        public Int32RangeSelectionDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public Int32RangeSelection deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = ctxt.readTree(jp);
            Object deserialized = null;
            boolean typeCoercion = ctxt.isEnabled(MapperFeature.ALLOW_COERCION_OF_SCALARS);
            int match = 0;
            JsonToken token = tree.traverse(jp.getCodec()).nextToken();
            // deserialize Int32RangeSelectionOneOf
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(Int32RangeSelectionOneOf.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'Int32RangeSelectionOneOf'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'Int32RangeSelectionOneOf'", e);
            }

            // deserialize Int32RangeSelectionOneOf1
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(Int32RangeSelectionOneOf1.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'Int32RangeSelectionOneOf1'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'Int32RangeSelectionOneOf1'", e);
            }

            // deserialize Int32RangeSelectionOneOf2
            try {
                boolean attemptParsing = true;
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(Int32RangeSelectionOneOf2.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'Int32RangeSelectionOneOf2'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'Int32RangeSelectionOneOf2'", e);
            }

            if (match == 1) {
                Int32RangeSelection ret = new Int32RangeSelection();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for Int32RangeSelection: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public Int32RangeSelection getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "Int32RangeSelection cannot be null");
        }
    }
    ...
    public Int32RangeSelection() {
        super("oneOf", Boolean.FALSE);
    }

    public Int32RangeSelection(Int32RangeSelectionOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Int32RangeSelection(Int32RangeSelectionOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Int32RangeSelection(Int32RangeSelectionOneOf2 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("Int32RangeSelectionOneOf", new GenericType<Int32RangeSelectionOneOf>() {
        });
        schemas.put("Int32RangeSelectionOneOf1", new GenericType<Int32RangeSelectionOneOf1>() {
        });
        schemas.put("Int32RangeSelectionOneOf2", new GenericType<Int32RangeSelectionOneOf2>() {
        });
        JSON.registerDescendants(Int32RangeSelection.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return Int32RangeSelection.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * Int32RangeSelectionOneOf, Int32RangeSelectionOneOf1, Int32RangeSelectionOneOf2
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(Int32RangeSelectionOneOf.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(Int32RangeSelectionOneOf1.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(Int32RangeSelectionOneOf2.class, instance, new HashSet<>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Int32RangeSelectionOneOf, Int32RangeSelectionOneOf1, Int32RangeSelectionOneOf2");
    }
     ...
     * Int32RangeSelectionOneOf, Int32RangeSelectionOneOf1, Int32RangeSelectionOneOf2
     *
     * @return The actual instance (Int32RangeSelectionOneOf, Int32RangeSelectionOneOf1, Int32RangeSelectionOneOf2)
     */
    @Override
    ...
    /**
     * Get the actual instance of `Int32RangeSelectionOneOf`. If the actual instance is not `Int32RangeSelectionOneOf`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Int32RangeSelectionOneOf`
     * @throws ClassCastException if the instance is not `Int32RangeSelectionOneOf`
     */
    public Int32RangeSelectionOneOf getInt32RangeSelectionOneOf() throws ClassCastException {
        return (Int32RangeSelectionOneOf)super.getActualInstance();
    }

    /**
     * Get the actual instance of `Int32RangeSelectionOneOf1`. If the actual instance is not `Int32RangeSelectionOneOf1`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Int32RangeSelectionOneOf1`
     * @throws ClassCastException if the instance is not `Int32RangeSelectionOneOf1`
     */
    public Int32RangeSelectionOneOf1 getInt32RangeSelectionOneOf1() throws ClassCastException {
        return (Int32RangeSelectionOneOf1)super.getActualInstance();
    }

    /**
     * Get the actual instance of `Int32RangeSelectionOneOf2`. If the actual instance is not `Int32RangeSelectionOneOf2`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Int32RangeSelectionOneOf2`
     * @throws ClassCastException if the instance is not `Int32RangeSelectionOneOf2`
     */
    public Int32RangeSelectionOneOf2 getInt32RangeSelectionOneOf2() throws ClassCastException {
        return (Int32RangeSelectionOneOf2)super.getActualInstance();
    }
