...
@JsonPropertyOrder({
  ...
  EntityRef.JSON_PROPERTY_IS_TOOL_DEFAULT
})
...
public class EntityRef {
  ...
  public EntityRef id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public EntityRef isToolDefault(@jakarta.annotation.Nullable Boolean isToolDefault) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, entityRef.id) &&
        ...
        Objects.equals(this.isToolDefault, entityRef.isToolDefault);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, isToolDefault);
  }
