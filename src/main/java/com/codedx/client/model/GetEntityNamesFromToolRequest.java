...
/**
 * GetEntityNamesFromToolRequest
 */
@JsonPropertyOrder({
  GetEntityNamesFromToolRequest.JSON_PROPERTY_PROJECT,
  GetEntityNamesFromToolRequest.JSON_PROPERTY_VERSION,
  GetEntityNamesFromToolRequest.JSON_PROPERTY_CONFIG
})
@JsonTypeName("getEntityNamesFromTool_request")
...
public class GetEntityNamesFromToolRequest {
  ...
  @jakarta.annotation.Nullable
  private ApiConfigValues config;

  public GetEntityNamesFromToolRequest() { 
  }

  public GetEntityNamesFromToolRequest project(@jakarta.annotation.Nullable Boolean project) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProject(@jakarta.annotation.Nullable Boolean project) {
    this.project = project;
  }


  public GetEntityNamesFromToolRequest version(@jakarta.annotation.Nullable Boolean version) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VERSION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVersion(@jakarta.annotation.Nullable Boolean version) {
    this.version = version;
  }


  public GetEntityNamesFromToolRequest config(@jakarta.annotation.Nullable ApiConfigValues config) {
    this.config = config;
    return this;
  }
  ...
  public ApiConfigValues getConfig() {
    return config;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONFIG, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConfig(@jakarta.annotation.Nullable ApiConfigValues config) {
    this.config = config;
  }


  /**
   * Return true if this getEntityNamesFromTool_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetEntityNamesFromToolRequest getEntityNamesFromToolRequest = (GetEntityNamesFromToolRequest) o;
    return Objects.equals(this.project, getEntityNamesFromToolRequest.project) &&
        Objects.equals(this.version, getEntityNamesFromToolRequest.version) &&
        Objects.equals(this.config, getEntityNamesFromToolRequest.config);
  }

  @Override
  public int hashCode() {
    return Objects.hash(project, version, config);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetEntityNamesFromToolRequest {\n");
