...
/**
 * A statement that all of the inner expressions should be true
 */
@JsonPropertyOrder({
  FormStateExpressionOneOf2.JSON_PROPERTY_ALL_OF
})
@JsonTypeName("FormStateExpression_oneOf_2")
...
public class FormStateExpressionOneOf2 {
  public static final String JSON_PROPERTY_ALL_OF = "allOf";
  @jakarta.annotation.Nullable
  private List<FormStateExpression> allOf = new ArrayList<>();

  public FormStateExpressionOneOf2() { 
  }

  public FormStateExpressionOneOf2 allOf(@jakarta.annotation.Nullable List<FormStateExpression> allOf) {
    this.allOf = allOf;
    return this;
  }

  public FormStateExpressionOneOf2 addAllOfItem(FormStateExpression allOfItem) {
    if (this.allOf == null) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ALL_OF, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<FormStateExpression> getAllOf() {
    return allOf;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ALL_OF, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAllOf(@jakarta.annotation.Nullable List<FormStateExpression> allOf) {
    this.allOf = allOf;
  }


  /**
   * Return true if this FormStateExpression_oneOf_2 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FormStateExpressionOneOf2 formStateExpressionOneOf2 = (FormStateExpressionOneOf2) o;
    return Objects.equals(this.allOf, formStateExpressionOneOf2.allOf);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormStateExpressionOneOf2 {\n");
