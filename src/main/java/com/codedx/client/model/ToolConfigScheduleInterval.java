...
@JsonDeserialize(using = ToolConfigScheduleInterval.ToolConfigScheduleIntervalDeserializer.class)
@JsonSerialize(using = ToolConfigScheduleInterval.ToolConfigScheduleIntervalSerializer.class)
public class ToolConfigScheduleInterval extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ToolConfigScheduleInterval.class.getName());

    public static class ToolConfigScheduleIntervalSerializer extends StdSerializer<ToolConfigScheduleInterval> {
        public ToolConfigScheduleIntervalSerializer(Class<ToolConfigScheduleInterval> t) {
            super(t);
        }

        public ToolConfigScheduleIntervalSerializer() {
            this(null);
        }

        @Override
        public void serialize(ToolConfigScheduleInterval value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ToolConfigScheduleIntervalDeserializer extends StdDeserializer<ToolConfigScheduleInterval> {
        public ToolConfigScheduleIntervalDeserializer() {
            this(ToolConfigScheduleInterval.class);
        }

        public ToolConfigScheduleIntervalDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ToolConfigScheduleInterval deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                ToolConfigScheduleInterval ret = new ToolConfigScheduleInterval();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ToolConfigScheduleInterval: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public ToolConfigScheduleInterval getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ToolConfigScheduleInterval cannot be null");
        }
    }
    ...
    public ToolConfigScheduleInterval() {
        super("oneOf", Boolean.FALSE);
    }

    public ToolConfigScheduleInterval(FixedUpdateSetting o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ToolConfigScheduleInterval(DailyUpdateSetting o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ToolConfigScheduleInterval(WeeklyUpdateSetting o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ToolConfigScheduleInterval.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType<?>> getSchemas() {
        return ToolConfigScheduleInterval.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * DailyUpdateSetting, FixedUpdateSetting, WeeklyUpdateSetting
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be DailyUpdateSetting, FixedUpdateSetting, WeeklyUpdateSetting");
    }
     ...
     * DailyUpdateSetting, FixedUpdateSetting, WeeklyUpdateSetting
     *
     * @return The actual instance (DailyUpdateSetting, FixedUpdateSetting, WeeklyUpdateSetting)
     */
    @Override
