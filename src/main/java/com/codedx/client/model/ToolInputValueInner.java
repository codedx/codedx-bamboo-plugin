 ...
 */
@JsonPropertyOrder({
  ToolInputValueInner.JSON_PROPERTY_ID,
  ToolInputValueInner.JSON_PROPERTY_NAME
})
@JsonTypeName("ToolInput_value_inner")
...
public class ToolInputValueInner {
  ...
  public ToolInputValueInner() { 
  }

  public ToolInputValueInner id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }

  /**
   * The input files that were passed to this tool.
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public ToolInputValueInner name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }

  /**
   * The name of the input file passed to this tool.
   * @return name
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this ToolInput_value_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ToolInputValueInner toolInputValueInner = (ToolInputValueInner) o;
    return Objects.equals(this.id, toolInputValueInner.id) &&
        Objects.equals(this.name, toolInputValueInner.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ToolInputValueInner {\n");
