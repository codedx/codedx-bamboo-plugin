...
@JsonPropertyOrder({
  ...
  FullRole.JSON_PROPERTY_IS_BUILT_IN,
  FullRole.JSON_PROPERTY_PERMISSIONS
})
...
public class FullRole {
  ...
  public FullRole name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public FullRole id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public FullRole isBuiltIn(@jakarta.annotation.Nullable Boolean isBuiltIn) {
    this.isBuiltIn = isBuiltIn;
    return this;
  }

  /**
   * Whether or not the role is a built-in role.
   * @return isBuiltIn
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_BUILT_IN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_BUILT_IN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsBuiltIn(@jakarta.annotation.Nullable Boolean isBuiltIn) {
    this.isBuiltIn = isBuiltIn;
  }


  public FullRole permissions(@jakarta.annotation.Nullable List<String> permissions) {
    this.permissions = permissions;
    return this;
  }

  public FullRole addPermissionsItem(String permissionsItem) {
  ...
  /**
   * Return true if this FullRole object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, fullRole.name) &&
        Objects.equals(this.id, fullRole.id) &&
        Objects.equals(this.isBuiltIn, fullRole.isBuiltIn) &&
        Objects.equals(this.permissions, fullRole.permissions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, id, isBuiltIn, permissions);
  }
