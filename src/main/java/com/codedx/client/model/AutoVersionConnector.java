...
/**
 * AutoVersionConnector
 */
@JsonPropertyOrder({
  AutoVersionConnector.JSON_PROPERTY_TOOL_ID,
  AutoVersionConnector.JSON_PROPERTY_PROJECT_ID,
  AutoVersionConnector.JSON_PROPERTY_CONNECTION_ENTITY_ID,
  AutoVersionConnector.JSON_PROPERTY_OPTION_ENTITY_ID,
  AutoVersionConnector.JSON_PROPERTY_PROJECT_ENTITY,
  AutoVersionConnector.JSON_PROPERTY_ENABLED
})
...
public class AutoVersionConnector {
  ...
  @jakarta.annotation.Nullable
  private Integer projectEntity;

  public static final String JSON_PROPERTY_ENABLED = "enabled";
  @jakarta.annotation.Nullable
  private Boolean enabled;

  public AutoVersionConnector() { 
  }

  public AutoVersionConnector toolId(@jakarta.annotation.Nullable Integer toolId) {
    this.toolId = toolId;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_TOOL_ID, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_TOOL_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setToolId(@jakarta.annotation.Nullable Integer toolId) {
    this.toolId = toolId;
  }


  public AutoVersionConnector projectId(@jakarta.annotation.Nullable Integer projectId) {
  ...
  public AutoVersionConnector connectionEntityId(@jakarta.annotation.Nullable Integer connectionEntityId) {
  ...
  public AutoVersionConnector optionEntityId(@jakarta.annotation.Nullable Integer optionEntityId) {
  ...
  public AutoVersionConnector projectEntity(@jakarta.annotation.Nullable Integer projectEntity) {
  ...
  public Integer getProjectEntity() {
    return projectEntity;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECT_ENTITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjectEntity(@jakarta.annotation.Nullable Integer projectEntity) {
    this.projectEntity = projectEntity;
  }


  public AutoVersionConnector enabled(@jakarta.annotation.Nullable Boolean enabled) {
  ...
  /**
   * Return true if this AutoVersionConnector object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AutoVersionConnector autoVersionConnector = (AutoVersionConnector) o;
    return Objects.equals(this.toolId, autoVersionConnector.toolId) &&
        Objects.equals(this.projectId, autoVersionConnector.projectId) &&
        Objects.equals(this.connectionEntityId, autoVersionConnector.connectionEntityId) &&
        Objects.equals(this.optionEntityId, autoVersionConnector.optionEntityId) &&
        Objects.equals(this.projectEntity, autoVersionConnector.projectEntity) &&
        Objects.equals(this.enabled, autoVersionConnector.enabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(toolId, projectId, connectionEntityId, optionEntityId, projectEntity, enabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AutoVersionConnector {\n");
