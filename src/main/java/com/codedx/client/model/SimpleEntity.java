 ...
 */
@JsonPropertyOrder({
  SimpleEntity.JSON_PROPERTY_ID,
  SimpleEntity.JSON_PROPERTY_NAME
})
...
public class SimpleEntity {
  ...
  public SimpleEntity id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SimpleEntity name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, simpleEntity.id) &&
        Objects.equals(this.name, simpleEntity.name);
  }
