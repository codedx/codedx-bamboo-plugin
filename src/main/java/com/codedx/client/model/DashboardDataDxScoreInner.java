...
import com.codedx.client.model.DashboardDxScore;
...
/**
 * DashboardDataDxScoreInner
 */
@JsonPropertyOrder({
  DashboardDataDxScoreInner.JSON_PROPERTY_DATE,
  DashboardDataDxScoreInner.JSON_PROPERTY_DATA
})
@JsonTypeName("DashboardData_dxScore_inner")
...
public class DashboardDataDxScoreInner {
  ...
  @jakarta.annotation.Nullable
  private DashboardDxScore data;

  public DashboardDataDxScoreInner() { 
  }

  public DashboardDataDxScoreInner date(@jakarta.annotation.Nullable OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public DashboardDataDxScoreInner data(@jakarta.annotation.Nullable DashboardDxScore data) {
    this.data = data;
    return this;
  }
  ...
  public DashboardDxScore getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable DashboardDxScore data) {
    this.data = data;
  }


  /**
   * Return true if this DashboardData_dxScore_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardDataDxScoreInner dashboardDataDxScoreInner = (DashboardDataDxScoreInner) o;
    return Objects.equals(this.date, dashboardDataDxScoreInner.date) &&
        Objects.equals(this.data, dashboardDataDxScoreInner.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardDataDxScoreInner {\n");
