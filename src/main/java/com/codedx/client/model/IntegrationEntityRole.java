...
/**
 * A role associated with an integration entity. May be &#x60;\&quot;view\&quot;&#x60;, &#x60;\&quot;edit\&quot;&#x60;, or &#x60;null&#x60;. A user with the &#x60;\&quot;view\&quot;&#x60; role has read-only access to the details of the integration entity. A user with the &#x60;\&quot;edit\&quot;&#x60; role has full access to the integration entity, including the ability to rename, overwrite, delete, and manage permissions for that integration entity. A user with a &#x60;null&#x60; role does not have access to the integration entity.
 */
public enum IntegrationEntityRole {
  ...
  IntegrationEntityRole(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static IntegrationEntityRole fromValue(String value) {
    for (IntegrationEntityRole b : IntegrationEntityRole.values()) {
