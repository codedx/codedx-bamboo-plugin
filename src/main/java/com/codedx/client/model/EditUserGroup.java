 ...
 */
@JsonPropertyOrder({
  EditUserGroup.JSON_PROPERTY_NAME,
  EditUserGroup.JSON_PROPERTY_PARENT_ID
})
...
public class EditUserGroup {
  ...
  public EditUserGroup name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EditUserGroup parentId(@jakarta.annotation.Nullable Integer parentId) {
  ...
  /**
   * Return true if this EditUserGroup object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EditUserGroup editUserGroup = (EditUserGroup) o;
    return Objects.equals(this.name, editUserGroup.name) &&
        Objects.equals(this.parentId, editUserGroup.parentId);
  }
