...
/**
 * ToolConnectorValueInner
 */
@JsonPropertyOrder({
  ToolConnectorValueInner.JSON_PROPERTY_ID,
  ToolConnectorValueInner.JSON_PROPERTY_CONFIG_NAME
})
@JsonTypeName("ToolConnector_value_inner")
...
public class ToolConnectorValueInner {
  ...
  public ToolConnectorValueInner() { 
  }

  public ToolConnectorValueInner id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }

  /**
   * The id of the output file produced by this connector during this analysis.
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public ToolConnectorValueInner configName(@jakarta.annotation.Nullable String configName) {
    this.configName = configName;
    return this;
  }

  /**
   * The name of the connector configuration run during this analysis.
   * @return configName
   */
  @jakarta.annotation.Nullable
  ...
  @JsonProperty(value = JSON_PROPERTY_CONFIG_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConfigName(@jakarta.annotation.Nullable String configName) {
    this.configName = configName;
  }


  /**
   * Return true if this ToolConnector_value_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ToolConnectorValueInner toolConnectorValueInner = (ToolConnectorValueInner) o;
    return Objects.equals(this.id, toolConnectorValueInner.id) &&
        Objects.equals(this.configName, toolConnectorValueInner.configName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, configName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ToolConnectorValueInner {\n");
