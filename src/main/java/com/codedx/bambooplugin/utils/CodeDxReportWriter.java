...
public class CodeDxReportWriter {
	...
	private String makeSeverityTableRows() {
		...
		sb.append(makeRow(CodeDxBuildStatistics.Group.SEVERITY, CodeDxConstants.CRITICAL))
			.append(makeRow(CodeDxBuildStatistics.Group.SEVERITY, CodeDxConstants.HIGH))
			.append(makeRow(CodeDxBuildStatistics.Group.SEVERITY, CodeDxConstants.MEDIUM))
			.append(makeRow(CodeDxBuildStatistics.Group.SEVERITY, CodeDxConstants.LOW))
			.append(makeRow(CodeDxBuildStatistics.Group.SEVERITY, CodeDxConstants.INFO))
			.append(makeRow(CodeDxBuildStatistics.Group.SEVERITY, CodeDxConstants.TOTAL));
	...
	private String makeStatusTableRows() {
		...
		sb.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.NEW))
			.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.FIXED))
			.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.MITIGATED))
			.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.IGNORED))
			.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.FALSE_POSITIVE))
			.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.UNRESOLVED))
			.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.ESCALATED))
			.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.ASSIGNED))
			.append(makeRow(CodeDxBuildStatistics.Group.STATUS, CodeDxConstants.TOTAL));

		return sb.toString();
	}

	private String makeRow(CodeDxBuildStatistics.Group group, String rowName) {
		List<GroupedCount> beforeCurrentAnalysis = new ArrayList<>();
		List<GroupedCount> afterCurrentAnalysis = new ArrayList<>();

		if (group == CodeDxBuildStatistics.Group.STATUS) {
		...
		} else if (group == CodeDxBuildStatistics.Group.SEVERITY) {
