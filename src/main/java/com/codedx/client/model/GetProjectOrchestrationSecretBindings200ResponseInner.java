...
/**
 * GetProjectOrchestrationSecretBindings200ResponseInner
 */
@JsonPropertyOrder({
  GetProjectOrchestrationSecretBindings200ResponseInner.JSON_PROPERTY_ID,
  GetProjectOrchestrationSecretBindings200ResponseInner.JSON_PROPERTY_NAME,
  GetProjectOrchestrationSecretBindings200ResponseInner.JSON_PROPERTY_ALLOWED_SECRETS
})
@JsonTypeName("getProjectOrchestrationSecretBindings_200_response_inner")
...
public class GetProjectOrchestrationSecretBindings200ResponseInner {
  ...
  public GetProjectOrchestrationSecretBindings200ResponseInner() { 
  }

  public GetProjectOrchestrationSecretBindings200ResponseInner id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }

  /**
   * ID of an Add-In Tool
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public GetProjectOrchestrationSecretBindings200ResponseInner name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }

  /**
   * Name of an Add-In Tool
   * @return name
   */
  @jakarta.annotation.Nullable
  ...
  public GetProjectOrchestrationSecretBindings200ResponseInner allowedSecrets(@jakarta.annotation.Nullable List<String> allowedSecrets) {
    this.allowedSecrets = allowedSecrets;
    return this;
  }

  public GetProjectOrchestrationSecretBindings200ResponseInner addAllowedSecretsItem(String allowedSecretsItem) {
  ...
  /**
   * A list of secret names that are currently assigned to the Add-In Tool
  ...
  /**
   * Return true if this getProjectOrchestrationSecretBindings_200_response_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetProjectOrchestrationSecretBindings200ResponseInner getProjectOrchestrationSecretBindings200ResponseInner = (GetProjectOrchestrationSecretBindings200ResponseInner) o;
    return Objects.equals(this.id, getProjectOrchestrationSecretBindings200ResponseInner.id) &&
        Objects.equals(this.name, getProjectOrchestrationSecretBindings200ResponseInner.name) &&
        Objects.equals(this.allowedSecrets, getProjectOrchestrationSecretBindings200ResponseInner.allowedSecrets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, allowedSecrets);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetProjectOrchestrationSecretBindings200ResponseInner {\n");
