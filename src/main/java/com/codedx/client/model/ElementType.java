 ...
 */
@JsonPropertyOrder({
  ElementType.JSON_PROPERTY_KEYWORD,
...
public class ElementType {
  ...
  public ElementType keyword(@jakarta.annotation.Nullable String keyword) {
  ...
  /**
   * Return true if this ElementType object is equal to o.
   */
  @Override
