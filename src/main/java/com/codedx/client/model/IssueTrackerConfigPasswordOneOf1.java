...
/**
 * IssueTrackerConfigPasswordOneOf1
 */
@JsonPropertyOrder({
  IssueTrackerConfigPasswordOneOf1.JSON_PROPERTY_SUBMITTED
})
@JsonTypeName("IssueTrackerConfigPassword_oneOf_1")
...
public class IssueTrackerConfigPasswordOneOf1 {
  public static final String JSON_PROPERTY_SUBMITTED = "submitted";
  @jakarta.annotation.Nullable
  private String submitted;

  public IssueTrackerConfigPasswordOneOf1() { 
  }

  public IssueTrackerConfigPasswordOneOf1 submitted(@jakarta.annotation.Nullable String submitted) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SUBMITTED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubmitted(@jakarta.annotation.Nullable String submitted) {
    this.submitted = submitted;
  }


  /**
   * Return true if this IssueTrackerConfigPassword_oneOf_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IssueTrackerConfigPasswordOneOf1 issueTrackerConfigPasswordOneOf1 = (IssueTrackerConfigPasswordOneOf1) o;
    return Objects.equals(this.submitted, issueTrackerConfigPasswordOneOf1.submitted);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssueTrackerConfigPasswordOneOf1 {\n");
