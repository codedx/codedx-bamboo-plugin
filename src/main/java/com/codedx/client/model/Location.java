 ...
 */
@JsonPropertyOrder({
  Location.JSON_PROPERTY_PATH,
  Location.JSON_PROPERTY_LINES,
  Location.JSON_PROPERTY_COLUMNS
})
...
public class Location {
  ...
  public Location path(@jakarta.annotation.Nullable Path path) {
    this.path = path;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PATH, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPath(@jakarta.annotation.Nullable Path path) {
    this.path = path;
  }


  public Location lines(@jakarta.annotation.Nullable LocationRange lines) {
    this.lines = lines;
    return this;
  }
  ...
  public Location columns(@jakarta.annotation.Nullable LocationRange columns) {
