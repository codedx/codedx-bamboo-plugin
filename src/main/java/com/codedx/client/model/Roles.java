 ...
 */
@JsonPropertyOrder({
  Roles.JSON_PROPERTY_READER,
  Roles.JSON_PROPERTY_UPDATER,
  Roles.JSON_PROPERTY_CREATOR,
  Roles.JSON_PROPERTY_MANAGER
})
...
public class Roles {
  ...
  public Roles reader(@jakarta.annotation.Nullable Boolean reader) {
    this.reader = reader;
    return this;
  }
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_READER, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_READER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReader(@jakarta.annotation.Nullable Boolean reader) {
    this.reader = reader;
  }


  public Roles updater(@jakarta.annotation.Nullable Boolean updater) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_UPDATER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_UPDATER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUpdater(@jakarta.annotation.Nullable Boolean updater) {
    this.updater = updater;
  }


  public Roles creator(@jakarta.annotation.Nullable Boolean creator) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CREATOR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCreator(@jakarta.annotation.Nullable Boolean creator) {
    this.creator = creator;
  }


  public Roles manager(@jakarta.annotation.Nullable Boolean manager) {
  ...
  @JsonProperty(value = JSON_PROPERTY_MANAGER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setManager(@jakarta.annotation.Nullable Boolean manager) {
    this.manager = manager;
  }
