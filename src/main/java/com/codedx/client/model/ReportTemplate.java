...
@JsonPropertyOrder({
  ...
  ReportTemplate.JSON_PROPERTY_OWNER,
  ReportTemplate.JSON_PROPERTY_DESCRIPTION,
  ReportTemplate.JSON_PROPERTY_SAVED_FILTER,
  ReportTemplate.JSON_PROPERTY_REPORT_TYPE,
  ReportTemplate.JSON_PROPERTY_SCHEDULE,
  ReportTemplate.JSON_PROPERTY_RECIPIENTS,
  ReportTemplate.JSON_PROPERTY_PROJECTS,
  ReportTemplate.JSON_PROPERTY_CAN_EDIT
})
...
public class ReportTemplate {
  ...
  public ReportTemplate id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ReportTemplate name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ReportTemplate owner(@jakarta.annotation.Nullable SimpleUser owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ReportTemplate description(@jakarta.annotation.Nullable String description) {
  ...
  public ReportTemplate savedFilter(@jakarta.annotation.Nullable ReportTemplateSavedFilter savedFilter) {
  ...
  public ReportTemplate reportType(@jakarta.annotation.Nullable ReportTypeEnum reportType) {
  ...
  public ReportTemplate schedule(@jakarta.annotation.Nullable Map<String, Object> schedule) {
    this.schedule = schedule;
    return this;
  }

  public ReportTemplate putScheduleItem(String key, Object scheduleItem) {
  ...
  public ReportTemplate recipients(@jakarta.annotation.Nullable List<String> recipients) {
    this.recipients = recipients;
    return this;
  }

  public ReportTemplate addRecipientsItem(String recipientsItem) {
  ...
  public ReportTemplate projects(@jakarta.annotation.Nullable List<Project> projects) {
    this.projects = projects;
    return this;
  }

  public ReportTemplate addProjectsItem(Project projectsItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROJECTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setProjects(@jakarta.annotation.Nullable List<Project> projects) {
    this.projects = projects;
  }


  public ReportTemplate canEdit(@jakarta.annotation.Nullable Boolean canEdit) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, reportTemplate.id) &&
        ...
        Objects.equals(this.owner, reportTemplate.owner) &&
        Objects.equals(this.description, reportTemplate.description) &&
        Objects.equals(this.savedFilter, reportTemplate.savedFilter) &&
        Objects.equals(this.reportType, reportTemplate.reportType) &&
        Objects.equals(this.schedule, reportTemplate.schedule) &&
        Objects.equals(this.recipients, reportTemplate.recipients) &&
        Objects.equals(this.projects, reportTemplate.projects) &&
        Objects.equals(this.canEdit, reportTemplate.canEdit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, owner, description, savedFilter, reportType, schedule, recipients, projects, canEdit);
  }
