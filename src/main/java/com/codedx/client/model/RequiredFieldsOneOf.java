...
/**
 * A set of fields, all of which are required
 */
@JsonPropertyOrder({
  RequiredFieldsOneOf.JSON_PROPERTY_ALL_OF
})
@JsonTypeName("RequiredFields_oneOf")
...
public class RequiredFieldsOneOf {
  public static final String JSON_PROPERTY_ALL_OF = "allOf";
  @jakarta.annotation.Nonnull
  private List<RequiredFields> allOf = new ArrayList<>();

  public RequiredFieldsOneOf() { 
  }

  public RequiredFieldsOneOf allOf(@jakarta.annotation.Nonnull List<RequiredFields> allOf) {
    this.allOf = allOf;
    return this;
  }

  public RequiredFieldsOneOf addAllOfItem(RequiredFields allOfItem) {
    if (this.allOf == null) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_ALL_OF, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<RequiredFields> getAllOf() {
    return allOf;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ALL_OF, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAllOf(@jakarta.annotation.Nonnull List<RequiredFields> allOf) {
    this.allOf = allOf;
  }


  /**
   * Return true if this RequiredFields_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RequiredFieldsOneOf requiredFieldsOneOf = (RequiredFieldsOneOf) o;
    return Objects.equals(this.allOf, requiredFieldsOneOf.allOf);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequiredFieldsOneOf {\n");
