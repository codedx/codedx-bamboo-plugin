 ...
 */
@JsonPropertyOrder({
  Standard.JSON_PROPERTY_COUNT_BY,
  Standard.JSON_PROPERTY_NAME,
  Standard.JSON_PROPERTY_FILTER_KEY,
  Standard.JSON_PROPERTY_TYPE
})
...
public class Standard {
  ...
  public static final String JSON_PROPERTY_FILTER_KEY = "filterKey";
  @jakarta.annotation.Nullable
  ...
  public Standard countBy(@jakarta.annotation.Nullable String countBy) {
  ...
  public Standard name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Standard filterKey(@jakarta.annotation.Nullable String filterKey) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_FILTER_KEY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_FILTER_KEY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilterKey(@jakarta.annotation.Nullable String filterKey) {
    this.filterKey = filterKey;
  }


  public Standard type(@jakarta.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  /**
   * Return true if this Standard object is equal to o.
   */
  @Override
