 ...
 */
@JsonPropertyOrder({
  FileMapping.JSON_PROPERTY_ID,
  FileMapping.JSON_PROPERTY_PATH
})
...
public class FileMapping {
  ...
  public FileMapping id(@jakarta.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public FileMapping path(@jakarta.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  /**
   * Return true if this FileMapping object is equal to o.
   */
  @Override
