...
/**
 * ProjectFilterSelectionsOneOf
 */
@JsonPropertyOrder({
  ProjectFilterSelectionsOneOf.JSON_PROPERTY_TREE
})
@JsonTypeName("ProjectFilterSelections_oneOf")
...
public class ProjectFilterSelectionsOneOf {
  public static final String JSON_PROPERTY_TREE = "tree";
  @jakarta.annotation.Nonnull
  private List<NamePath> tree = new ArrayList<>();

  public ProjectFilterSelectionsOneOf() { 
  }

  public ProjectFilterSelectionsOneOf tree(@jakarta.annotation.Nonnull List<NamePath> tree) {
    this.tree = tree;
    return this;
  }

  public ProjectFilterSelectionsOneOf addTreeItem(NamePath treeItem) {
    if (this.tree == null) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_TREE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<NamePath> getTree() {
    return tree;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TREE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTree(@jakarta.annotation.Nonnull List<NamePath> tree) {
    this.tree = tree;
  }


  /**
   * Return true if this ProjectFilterSelections_oneOf object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ProjectFilterSelectionsOneOf projectFilterSelectionsOneOf = (ProjectFilterSelectionsOneOf) o;
    return Objects.equals(this.tree, projectFilterSelectionsOneOf.tree);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectFilterSelectionsOneOf {\n");
